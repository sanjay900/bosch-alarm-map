...
class FireDetector(BaseModel):
    ...
    tested_sensors: Optional[List[FireDetectorTestedSensorsInner]] = Field(default=None, description="Array that contains one object for each sensor of this particular device.", alias="testedSensors")
    __properties: ClassVar[List[str]] = ["@type", "@self", "opState", "enabled", "incs", "testedSensors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in tested_sensors (list)
        _items = []
        if self.tested_sensors:
            for _item_tested_sensors in self.tested_sensors:
                if _item_tested_sensors:
                    _items.append(_item_tested_sensors.to_dict())
            _dict['testedSensors'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "incs": obj.get("incs"),
            "testedSensors": [FireDetectorTestedSensorsInner.from_dict(_item) for _item in obj["testedSensors"]] if obj.get("testedSensors") is not None else None
        })
        return _obj
