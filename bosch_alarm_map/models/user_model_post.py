...
class UserModelPost(BaseModel):
    ...
    id: StrictStr = Field(description="Unique numeric user identification (user ID).")
    ...
    __properties: ClassVar[List[str]] = ["@cmd", "id", "userType", "accessModel", "active", "activeFrom", "activeUntil", "smartkeyModelName", "isOiiUser", "isOiiUserKpUser", "language", "passcodeChngRqd", "firstName", "lastName", "passcode", "smartkeyAccessType", "smartkeyToken", "oiiUsername", "oiiPassword", "useExtendedDelay", "encryptedSecrets", "duressOffset", "userModelSyncID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserModelPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserModelPost from a dict"""
        if obj is None:
            return None
