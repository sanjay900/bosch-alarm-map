...
class UserModelListAllOfListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "userType", "accessModel", "active", "activeFrom", "activeUntil", "smartkeyModelName", "isOiiUser", "isOiiUserKpUser", "language", "passcodeChngRqd", "firstName", "lastName", "passcode", "smartkeyAccessType", "smartkeyToken", "oiiUsername", "oiiPassword", "useExtendedDelay", "encryptedSecrets", "duressOffset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserModelListAllOfListInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserModelListAllOfListInner from a dict"""
        if obj is None:
            return None
