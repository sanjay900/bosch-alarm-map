...
class StatisticsDbAllOfDatabasesPathToDatabase(BaseModel):
    """
    Database information
    """ # noqa: E501
    size_kb: Optional[StrictInt] = Field(default=None, description="Size of History Database in Kilobytes", alias="sizeKb")
    handles: Optional[StatisticsDbAllOfDatabasesPathToDatabaseHandles] = None
    counters: Optional[StatisticsDbAllOfDatabasesPathToDatabaseCounters] = None
    __properties: ClassVar[List[str]] = ["sizeKb", "handles", "counters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sizeKb": obj.get("sizeKb"),
            "handles": StatisticsDbAllOfDatabasesPathToDatabaseHandles.from_dict(obj["handles"]) if obj.get("handles") is not None else None,
            "counters": StatisticsDbAllOfDatabasesPathToDatabaseCounters.from_dict(obj["counters"]) if obj.get("counters") is not None else None
        })
        return _obj
