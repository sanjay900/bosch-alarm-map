...
class Area(BaseModel):
    ...
    armed: Optional[StrictBool] = Field(default=None, description="Indicates whether MAP panel is armed")
    ...
    ready_to_arm: Optional[StrictBool] = Field(default=None, description="If true, arming of the area is possible. Arming can either be done by a user using MAP system peripherals e.g. Keypad, Smartkey or via the REST-API, if area is “REST-API (OII) Armable”.", alias="readyToArm")
    ready_to_disarm: Optional[StrictBool] = Field(default=None, description="If true, disarming of the area is possible. Disarming can either be done by a user using MAP system peripherals e.g. Keypad, Smartkey or via the REST-API, if area is “REST-API (OII) Armable”.", alias="readyToDisarm")
    ...
    walktest: Optional[StrictStr] = Field(default=None, description="If empty, then no walktest is running for this area. Otherwise this field contains the link to the active walktest relative to the server based URL.")
    ...
    __properties: ClassVar[List[str]] = ["@type", "@self", "armed", "transitionalState", "oiiArmable", "readyToArm", "readyToDisarm", "numberOfBypassedDevices", "walktest", "motionDetectorTestActive", "chimeModeActive", "incs"]
