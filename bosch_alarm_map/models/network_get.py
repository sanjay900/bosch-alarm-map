...
class NetworkGet(BaseModel):
    ...
    ipv4_address: Optional[StrictStr] = Field(default=None, description="Current IP address of the device", alias="ipv4Address")
    ipv4_netmask: Optional[StrictStr] = Field(default=None, description="Current subnet mask used by the device", alias="ipv4Netmask")
    ipv4_gateway: Optional[StrictStr] = Field(default=None, description="Current default gateway used by the device", alias="ipv4Gateway")
    __properties: ClassVar[List[str]] = ["@type", "@self", "dhcp", "ipv4Address", "ipv4Netmask", "ipv4Gateway"]
