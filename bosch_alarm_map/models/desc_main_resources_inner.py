...
class DescMainResourcesInner(BaseModel):
    """
    DescMainResourcesInner
    """ # noqa: E501
    type: Optional[List[StrictStr]] = Field(default=None, description="Fixed type identifier", alias="@type")
    ref: Optional[StrictStr] = Field(default=None, description="Link for the main resources. The links are relative links. The absolute link can be created by prepending the baseURL to the given relative link of the resource.")
    __properties: ClassVar[List[str]] = ["@type", "ref"]
