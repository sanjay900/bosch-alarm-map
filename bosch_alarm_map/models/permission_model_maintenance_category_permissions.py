...
class PermissionModelMaintenanceCategoryPermissions(BaseModel):
    """
    PermissionModelMaintenanceCategoryPermissions
    """ # noqa: E501
    may_adjust_control_center_volume_backlight: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can adjust the Keypads volume and backlight settings.", alias="mayAdjustControlCenterVolume/Backlight")
    may_change_output_state: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can change the active/ inactive state of system outputs from the Keypad.", alias="mayChangeOutputState")
    may_set_date_time: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can change the system date and time.", alias="maySetDateTime")
    may_test_bell: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can perform a system belt test.", alias="mayTestBell")
    may_test_motion_detectors: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can perform a motion detector test.", alias="mayTestMotionDetectors")
    may_walk_test_automatic_points: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can perform a walk test on automatic points, e.g. detectors with integrated test transmitter.", alias="mayWalkTestAutomaticPoints")
    may_walk_test_points: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can perform a walk test on controlled points.", alias="mayWalkTestPoints")
    may_change_network_setting: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can change the network settings.", alias="mayChangeNetworkSetting")
    __properties: ClassVar[List[str]] = ["mayAdjustControlCenterVolume/Backlight", "mayChangeOutputState", "maySetDateTime", "mayTestBell", "mayTestMotionDetectors", "mayWalkTestAutomaticPoints", "mayWalkTestPoints", "mayChangeNetworkSetting"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mayAdjustControlCenterVolume/Backlight": obj.get("mayAdjustControlCenterVolume/Backlight"),
            "mayChangeOutputState": obj.get("mayChangeOutputState"),
            "maySetDateTime": obj.get("maySetDateTime"),
            "mayTestBell": obj.get("mayTestBell"),
            "mayTestMotionDetectors": obj.get("mayTestMotionDetectors"),
            "mayWalkTestAutomaticPoints": obj.get("mayWalkTestAutomaticPoints"),
            "mayWalkTestPoints": obj.get("mayWalkTestPoints"),
            "mayChangeNetworkSetting": obj.get("mayChangeNetworkSetting")
        })
        return _obj
