...
class SpecialDayModelList(BaseModel):
    """
    SpecialDayModelList
    """ # noqa: E501
    ...
    list: Optional[List[SpecialDayModelListAllOfListInner]] = Field(default=None, description="List of all special day models")
    __properties: ClassVar[List[str]] = ["specialDayModelSyncID", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [SpecialDayModelListAllOfListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
