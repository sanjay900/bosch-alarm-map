...
class FetchEvents(BaseModel):
    """
    FetchEvents
    """ # noqa: E501
    cmd: Optional[StrictStr] = Field(default=None, description="Fetch events from the buffer of this subscription", alias="@cmd")
    max_events: Optional[StrictInt] = Field(default=None, description="Optional. Default value is “unlimited”.", alias="maxEvents")
    min_events: Optional[StrictInt] = Field(default=None, description="Optional. If not specified or specified as 0, minEvents = maxEvents. If a request specifies minEvents bigger than maxEvents, minEvents will be set to maxEvents.", alias="minEvents")
    max_time: Optional[StrictInt] = Field(default=None, description="Optional. Maximum number of seconds the call will block. Maximum value is 100. Minimum is 0.", alias="maxTime")
    __properties: ClassVar[List[str]] = ["@cmd", "maxEvents", "minEvents", "maxTime"]
