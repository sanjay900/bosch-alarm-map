...
class StatisticsDbAllOfDatabasesPathToDatabaseCounters(BaseModel):
    """
    SQL database performance statistics
    """ # noqa: E501
    reads: Optional[StrictInt] = Field(default=None, description="Number of database reads")
    read_interval: Optional[StrictStr] = Field(default=None, description="Frequency of database reads", alias="readInterval")
    writes: Optional[StrictInt] = Field(default=None, description="Number of database writes")
    write_interval: Optional[StrictStr] = Field(default=None, description="Frequency of database writes", alias="writeInterval")
    __properties: ClassVar[List[str]] = ["reads", "readInterval", "writes", "writeInterval"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reads": obj.get("reads"),
            "readInterval": obj.get("readInterval"),
            "writes": obj.get("writes"),
            "writeInterval": obj.get("writeInterval")
        })
        return _obj
