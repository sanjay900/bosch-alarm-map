...
class TimeModelList(BaseModel):
    ...
    list: Optional[List[TimeModelListAllOfListInner]] = Field(default=None, description="List of all time models")
    __properties: ClassVar[List[str]] = ["timeModelSyncID", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [TimeModelListAllOfListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
