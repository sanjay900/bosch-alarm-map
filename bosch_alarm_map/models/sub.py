...
class Sub(BaseModel):
    ...
    lease_time: Optional[StrictInt] = Field(default=None, description="The actual lease time, in which the client has to renew its subscriptions to prevent the subscription and events to be deleted. <br> - Minimum = 10 - Maximum = 600", alias="leaseTime")
    buffer_size: Optional[StrictInt] = Field(default=None, description="Actual size of the allocated event ring buffer.", alias="bufferSize")
    ...
    __properties: ClassVar[List[str]] = ["@type", "@self", "leaseTime", "bufferSize", "subscriptions"]
