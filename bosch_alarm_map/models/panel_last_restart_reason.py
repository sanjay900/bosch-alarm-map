...
class PanelLastRestartReason(BaseModel):
    """
    Panel restart reason
    """ # noqa: E501
    value: Optional[StrictInt] = Field(default=None, description="Restart reason code")
    description: Optional[StrictStr] = Field(default=None, description="Restart reason description")
    time: Optional[StrictStr] = Field(default=None, description="Restart reason timestamp")
    __properties: ClassVar[List[str]] = ["value", "description", "time"]
