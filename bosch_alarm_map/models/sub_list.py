...
class SubList(BaseModel):
    ...
    list: Optional[List[Sub]] = Field(default=None, description="List of current subscriptions (respecting the access rights of the user)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@type": obj.get("@type"),
            "@self": obj.get("@self"),
            "list": [Sub.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
