...
class PermissionModelUserCategoryPermissions(BaseModel):
    """
    PermissionModelUserCategoryPermissions
    """ # noqa: E501
    may_add_user: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can add users to the system.", alias="mayAddUser")
    may_delete_user: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can delete other users from the system.", alias="mayDeleteUser")
    may_change_user_passcode: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can change another user's passcode", alias="mayChangeUserPasscode")
    __properties: ClassVar[List[str]] = ["mayAddUser", "mayDeleteUser", "mayChangeUserPasscode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mayAddUser": obj.get("mayAddUser"),
            "mayDeleteUser": obj.get("mayDeleteUser"),
            "mayChangeUserPasscode": obj.get("mayChangeUserPasscode")
        })
        return _obj
