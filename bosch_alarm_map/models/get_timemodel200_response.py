...
class GetTimemodel200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["timeModelID", "referenceDate", "ignoreSpecialDays", "periodInDays", "specialDays", "timeModelSyncID"]
