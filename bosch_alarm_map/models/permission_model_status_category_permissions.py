...
class PermissionModelStatusCategoryPermissions(BaseModel):
    """
    PermissionModelStatusCategoryPermissions
    """ # noqa: E501
    may_view_area_status: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can view an area\"s status.", alias="mayViewAreaStatus")
    may_view_device_status: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can view system device status.", alias="mayViewDeviceStatus")
    may_view_duress_alarm: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can view duress alarms.", alias="mayViewDuressAlarm")
    may_view_alarm_count: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can view the alarm counter.", alias="mayViewAlarmCount")
    may_view_event_memory: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can view the alarm memory.", alias="mayViewEventMemory")
    may_view_control_panel_history: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can view the control panel's history list.", alias="mayViewControlPanelHistory")
    may_print_control_panel_history: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can print the control panel's history events.", alias="mayPrintControlPanelHistory")
    may_view_control_panel_version: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can view the control panel's firmware version.", alias="mayViewControlPanelVersion")
    __properties: ClassVar[List[str]] = ["mayViewAreaStatus", "mayViewDeviceStatus", "mayViewDuressAlarm", "mayViewAlarmCount", "mayViewEventMemory", "mayViewControlPanelHistory", "mayPrintControlPanelHistory", "mayViewControlPanelVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mayViewAreaStatus": obj.get("mayViewAreaStatus"),
            "mayViewDeviceStatus": obj.get("mayViewDeviceStatus"),
            "mayViewDuressAlarm": obj.get("mayViewDuressAlarm"),
            "mayViewAlarmCount": obj.get("mayViewAlarmCount"),
            "mayViewEventMemory": obj.get("mayViewEventMemory"),
            "mayViewControlPanelHistory": obj.get("mayViewControlPanelHistory"),
            "mayPrintControlPanelHistory": obj.get("mayPrintControlPanelHistory"),
            "mayViewControlPanelVersion": obj.get("mayViewControlPanelVersion")
        })
        return _obj
