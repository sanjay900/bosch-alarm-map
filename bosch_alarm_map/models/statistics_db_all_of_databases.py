...
class StatisticsDbAllOfDatabases(BaseModel):
    """
    List of used databases
    """ # noqa: E501
    path_to_database: Optional[StatisticsDbAllOfDatabasesPathToDatabase] = Field(default=None, alias="path/to/database")
    __properties: ClassVar[List[str]] = ["path/to/database"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatisticsDbAllOfDatabases from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of path_to_database
        if self.path_to_database:
            _dict['path/to/database'] = self.path_to_database.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatisticsDbAllOfDatabases from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "path/to/database": StatisticsDbAllOfDatabasesPathToDatabase.from_dict(obj["path/to/database"]) if obj.get("path/to/database") is not None else None
        })
        return _obj
