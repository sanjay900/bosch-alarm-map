...
class Evts(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['CHANGED', 'CREATED', 'DELETED']):
            raise ValueError("must be one of enum values ('CHANGED', 'CREATED', 'DELETED')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of evt
        if self.evt:
            _dict['evt'] = self.evt.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "props": obj.get("props"),
            "evt": Evt.from_dict(obj["evt"]) if obj.get("evt") is not None else None
        })
        return _obj
