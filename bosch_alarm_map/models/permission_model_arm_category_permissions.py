...
class PermissionModelArmCategoryPermissions(BaseModel):
    """
    PermissionModelArmCategoryPermissions
    """ # noqa: E501
    may_arm_area: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can arm an area.", alias="mayArmArea")
    may_arm_with_active_tamper: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can arm the system if there is an active tamper condition.", alias="mayArmWithActiveTamper")
    may_disarm_area: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can disarm an area.", alias="mayDisarmArea")
    may_disarm_only_from_alarm: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can disarm the system only when there is an active alarm condition.", alias="mayDisarmOnlyFromAlarm")
    may_bypass_detector: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can bypass detectors.", alias="mayBypassDetector")
    may_force_bypass_detectors_in_area: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can bypass detectors while force the area.", alias="mayForceBypassDetectorsInArea")
    may_un_bypass_detector: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can return a detector from bypassed to active status.", alias="mayUnBypassDetector")
    may_un_bypassforciblybypassed_detectors_in_ar: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can return forcibly bypassed detectors in an area from bypassed to active status.", alias="mayUnBypassforciblybypassedDetectorsInAr")
    may_switch_internal_program_on_off: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can turn internal programs on or off.", alias="maySwitchInternalProgramOn/Off")
    __properties: ClassVar[List[str]] = ["mayArmArea", "mayArmWithActiveTamper", "mayDisarmArea", "mayDisarmOnlyFromAlarm", "mayBypassDetector", "mayForceBypassDetectorsInArea", "mayUnBypassDetector", "mayUnBypassforciblybypassedDetectorsInAr", "maySwitchInternalProgramOn/Off"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mayArmArea": obj.get("mayArmArea"),
            "mayArmWithActiveTamper": obj.get("mayArmWithActiveTamper"),
            "mayDisarmArea": obj.get("mayDisarmArea"),
            "mayDisarmOnlyFromAlarm": obj.get("mayDisarmOnlyFromAlarm"),
            "mayBypassDetector": obj.get("mayBypassDetector"),
            "mayForceBypassDetectorsInArea": obj.get("mayForceBypassDetectorsInArea"),
            "mayUnBypassDetector": obj.get("mayUnBypassDetector"),
            "mayUnBypassforciblybypassedDetectorsInAr": obj.get("mayUnBypassforciblybypassedDetectorsInAr"),
            "maySwitchInternalProgramOn/Off": obj.get("maySwitchInternalProgramOn/Off")
        })
        return _obj
