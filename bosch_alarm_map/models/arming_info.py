...
class ArmingInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["armed", "readyToArm", "readyToForceArm", "readyToDisarm", "whyNotReadyToArm", "whyNotReadyToForceArm", "whyNotReadyToDisarm"]
