...
class User(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "userType", "accessModel", "active", "activeFrom", "activeUntil", "smartkeyModelName", "isOiiUser", "isOiiUserKpUser", "language", "passcodeChngRqd", "@type", "@self", "name"]
