...
class NtpGetPublic(BaseModel):
    """
    NtpGetPublic
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Whether public servers are used for NTP")
    servers: Optional[List[StrictStr]] = Field(default=None, description="Array of the public servers that can be used for NTP, non-configurable fixed entries")
    __properties: ClassVar[List[str]] = ["enabled", "servers"]
