...
class PermissionModelEventCategoryPermissions(BaseModel):
    """
    PermissionModelEventCategoryPermissions
    """ # noqa: E501
    may_clear_internal_alarm: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can clear internal alarm (an alarm that does not report to the central station).", alias="mayClearInternalAlarm")
    may_clear_external_alarm: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can clear an antennal alarm (an alarm that triggers a siren and reports to the central station).", alias="mayClearExternalAlarm")
    may_clear_tamper: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can clear a tamper alert.", alias="mayClearTamper")
    may_clear_trouble: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can clear a trouble alert.", alias="mayClearTrouble")
    may_clear_battery_trouble: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can clear a battery trouble.", alias="mayClearBatteryTrouble")
    may_silence: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can silence events.", alias="maySilence")
    may_clear_main_power_failure: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can clear power failure alert.", alias="mayClearMainPowerFailure")
    may_clear_ats: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can clear ATS.", alias="mayClearATS")
    __properties: ClassVar[List[str]] = ["mayClearInternalAlarm", "mayClearExternalAlarm", "mayClearTamper", "mayClearTrouble", "mayClearBatteryTrouble", "maySilence", "mayClearMainPowerFailure", "mayClearATS"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mayClearInternalAlarm": obj.get("mayClearInternalAlarm"),
            "mayClearExternalAlarm": obj.get("mayClearExternalAlarm"),
            "mayClearTamper": obj.get("mayClearTamper"),
            "mayClearTrouble": obj.get("mayClearTrouble"),
            "mayClearBatteryTrouble": obj.get("mayClearBatteryTrouble"),
            "maySilence": obj.get("maySilence"),
            "mayClearMainPowerFailure": obj.get("mayClearMainPowerFailure"),
            "mayClearATS": obj.get("mayClearATS")
        })
        return _obj
