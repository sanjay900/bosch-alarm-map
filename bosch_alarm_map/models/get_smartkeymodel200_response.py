...
class GetSmartkeymodel200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["smartkeyModelID", "areaScopeList", "armAuthority", "disarmAuthority", "timeModelUsedForDisarming", "smartkeyModelSyncID"]
