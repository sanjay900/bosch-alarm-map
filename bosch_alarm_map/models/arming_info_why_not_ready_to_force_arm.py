...
class ArmingInfoWhyNotReadyToForceArm(BaseModel):
    """
    Nested objects providing reasons why the area cannot be armed by bypassing off normal devices
    """ # noqa: E501
    non_bypassable_faulted_devices: Optional[List[StrictStr]] = Field(default=None, description="List of off normal devices that cannot be bypassed", alias="nonBypassableFaultedDevices")
    too_many_faulted_devices: Optional[List[StrictStr]] = Field(default=None, description="List of all off normal devices, the count of which exceeds the number of devices that can be bypassed to arm the area", alias="tooManyFaultedDevices")
    too_many_bypassed_devices: Optional[StrictBool] = Field(default=None, description="Indicates that the area cannot be force armed because there are too many bypassed devices", alias="tooManyBypassedDevices")
    devices_bypassed_too_many_times: Optional[List[StrictStr]] = Field(default=None, description="List of all off normal devices which have been bypassed multiple times exceeded the number of times a device can be bypassed", alias="devicesBypassedTooManyTimes")
    system_wide_devices_faulted: Optional[List[StrictStr]] = Field(default=None, description="List of all off normal devices which are considered as system wide devices", alias="systemWideDevicesFaulted")
    related_areas_not_ready_to_arm: Optional[List[StrictStr]] = Field(default=None, description="List of related areas which are not ready to arm which make this area not ready to arm", alias="relatedAreasNotReadyToArm")
    related_areas_must_be_armed_first: Optional[List[StrictStr]] = Field(default=None, description="List of related areas which need to be armed first before this area can be armed", alias="relatedAreasMustBeArmedFirst")
    pending_incidents_in_area: Optional[StrictBool] = Field(default=None, description="Flag indicates whether there is an unhandled incident in the area", alias="pendingIncidentsInArea")
    area_in_walktest: Optional[StrictBool] = Field(default=None, description="Flag indicates whether the area is in walktest", alias="areaInWalktest")
    __properties: ClassVar[List[str]] = ["nonBypassableFaultedDevices", "tooManyFaultedDevices", "tooManyBypassedDevices", "devicesBypassedTooManyTimes", "systemWideDevicesFaulted", "relatedAreasNotReadyToArm", "relatedAreasMustBeArmedFirst", "pendingIncidentsInArea", "areaInWalktest"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nonBypassableFaultedDevices": obj.get("nonBypassableFaultedDevices"),
            "tooManyFaultedDevices": obj.get("tooManyFaultedDevices"),
            "tooManyBypassedDevices": obj.get("tooManyBypassedDevices"),
            "devicesBypassedTooManyTimes": obj.get("devicesBypassedTooManyTimes"),
            "systemWideDevicesFaulted": obj.get("systemWideDevicesFaulted"),
            "relatedAreasNotReadyToArm": obj.get("relatedAreasNotReadyToArm"),
            "relatedAreasMustBeArmedFirst": obj.get("relatedAreasMustBeArmedFirst"),
            "pendingIncidentsInArea": obj.get("pendingIncidentsInArea"),
            "areaInWalktest": obj.get("areaInWalktest")
        })
        return _obj
