...
class AreaAndTimeModel(BaseModel):
    """
    AreaAndTimeModel
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["alwaysAllowedPermissionSet", "restrictedByAreaPermissionSet", "restrictedByTimePermissionSet", "restrictedByAreaAndTimePermissionSet", "areaList", "timeModelID"]
