...
class AreaAndTimeModelListAllOfListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["areaAndTimeModelID", "alwaysAllowedPermissionSet", "restrictedByAreaPermissionSet", "restrictedByTimePermissionSet", "restrictedByAreaAndTimePermissionSet", "areaList", "timeModelID"]
