...
class TimeModelPeriodInDaysInner(BaseModel):
    """
    TimeModelPeriodInDaysInner
    """ # noqa: E501
    day_model_id: Optional[StrictStr] = Field(default=None, description="Name of an existing day model", alias="dayModelID")
    priority: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["dayModelID", "priority"]
