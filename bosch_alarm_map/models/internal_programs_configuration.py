...
class InternalProgramsConfiguration(BaseModel):
    """
    InternalProgramsConfiguration
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of internal program as configured in RPS for MAP.")
    siid: Optional[StrictStr] = Field(default=None, description="Auto generated unique Identifier. A, B, C and D are integer values.")
    device_list: Optional[List[StrictStr]] = Field(default=None, description="List of SIIDs of all devices configured for the internal program.", alias="deviceList")
    __properties: ClassVar[List[str]] = ["name", "siid", "deviceList"]
