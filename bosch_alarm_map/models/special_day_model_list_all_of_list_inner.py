...
class SpecialDayModelListAllOfListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["specialDayModelID", "dayModelID", "priority", "nextOccurrence", "repeatPolicy", "customRule", "easterOffset", "repeatUntil"]
