...
class StatisticsOiiAllOfClientsInner(BaseModel):
    """
    ...
    delay: Optional[StrictStr] = Field(default=None, description="Delay between clients requests, minimum, average, maximum")
    requests: Optional[StrictInt] = Field(default=None, description="Number of requests made by client")
    responses: Optional[StrictInt] = Field(default=None, description="Number of responses sent to client")
    positive: Optional[StrictInt] = Field(default=None, description="Number of positive responses sent to client")
    negative: Optional[StrictInt] = Field(default=None, description="Number of positive negative sent to client")
    __properties: ClassVar[List[str]] = ["start", "last", "duration", "interval", "delay", "requests", "responses", "positive", "negative"]
