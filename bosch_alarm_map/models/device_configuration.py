...
class DeviceConfiguration(BaseModel):
    ...
    DeviceConfiguration
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of device as configured in RPS for MAP.")
    siid: Optional[StrictStr] = Field(default=None, description="Auto generated unique Identifier. A, B, C and D are integer values.")
    type: Optional[StrictStr] = Field(default=None, description="<table>   <tr>     <td>----</td>     <td>----------</td>   </tr>   <tr>     <td>TYPE</td>     <td>SUBTYPE(S)</td>   </tr>   <tr>     <td>----</td>     <td>----------</td>   </tr>   <tr>     <td>POINT</td>     <td>ONBOARD,TAMPER, LSNEXPANDER, PIR, SEISMIC, GLASSBREAK, CONTACT, PANIC, UNIVERSAL, MCP, VIRTUAL</td>   </tr>   <tr>     <td>FIREDETECTOR</td>     <td>O, OT, OC, OTC, T</td>   </tr>   <tr>     <td>OUTPUT</td>     <td>CONTROL, LED, SIREN,STROBE, KPSPEAKER (Keypad Speaker), VIRTUAL</td>   </tr>   <tr>     <td>LSNBUS</td>     <td>LOOP,STUB</td>   </tr>   <tr>     <td>KEYSWITCH</td>     <td>STATIC,DYNAMIC, VIRTUALSTATIC, VIRTUALDYNAMIC</td>   </tr>   <tr>     <td>COMMUNICATOR</td>     <td>AT2000, AT3000</td>   </tr>   <tr>     <td>COUPLER</td>     <td>-</td>   </tr>   <tr>     <td>LSNAUX</td>     <td>-</td>   </tr>   <tr>     <td>GROUNDFAULT</td>     <td>-</td>   </tr>   <tr>     <td>BATTERYCHARGER</td>     <td>-</td>   </tr>   <tr>     <td>BATTERY</td>     <td>-</td>   </tr>   <tr>     <td>MAINS</td>     <td>-</td>   </tr>   <tr>     <td>PSCANOUTPUT</td>     <td>-</td>   </tr>   <tr>     <td>POWERDEVICE</td>     <td>-</td>   </tr>   <tr>     <td>PRINTER</td>     <td>-</td>   </tr>   <tr>     <td>BLOCKLOCK</td>     <td>-</td>   </tr>   <tr>     <td>SMARTKEY</td>     <td>-</td>   </tr>   <tr>     <td>DEMODULE</td>     <td>-</td>   </tr>   <tr>     <td>POWERSUPPLY</td>     <td>-</td>   </tr>   <tr>     <td>LSNGATEWAY</td>     <td>-</td>   </tr>   <tr>     <td>KEYPAD</td>     <td>-</td>   </tr>   <tr>     <td>OII</td>     <td>-</td>   </tr>   <tr>     <td>SUPERV</td>     <td>BIS,IPC,OII</td>   </tr> </table> ")
    part_of_walktest: Optional[StrictBool] = Field(default=None, description="Indicates whether this device is part of a walktest. If true, the resource will implement the walktest interface.", alias="partOfWalktest")
    bypassable: Optional[StrictBool] = Field(default=None, description="Indicates whether device can be bypassed. If true, the resource implements the bypass interface.")
    parent_siid: Optional[StrictStr] = Field(default=None, description="Parent Device SIID. This will be “<Empty>” if no parent Device. This would indicate where the device is configured. For such as On board, internal CAN etc A, B, C and D are integer values.", alias="parentSiid")
    __properties: ClassVar[List[str]] = ["name", "siid", "type", "partOfWalktest", "bypassable", "parentSiid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "siid": obj.get("siid"),
            "type": obj.get("type"),
            "partOfWalktest": obj.get("partOfWalktest"),
            "bypassable": obj.get("bypassable"),
            "parentSiid": obj.get("parentSiid")
        })
        return _obj
