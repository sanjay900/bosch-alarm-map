...
class Point(BaseModel):
    ...
    active: Optional[StrictBool] = Field(default=None, description="True if point is active")
    __properties: ClassVar[List[str]] = ["@type", "@self", "opState", "enabled", "walktest", "incs", "active"]
