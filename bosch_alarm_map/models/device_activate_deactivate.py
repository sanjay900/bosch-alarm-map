...
class DeviceActivateDeactivate(BaseModel):
    """
    DeviceActivateDeactivate
    """ # noqa: E501
    cmd: Optional[StrictStr] = Field(default=None, description="This operation initiates activating/deactivating the device", alias="@cmd")
