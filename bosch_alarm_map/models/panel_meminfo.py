...
class PanelMeminfo(BaseModel):
    """
    /proc/meminfo output, all values are in kilobytes. Please refer to Linux manual page for detailed explanation of the output
    """ # noqa: E501
    mem_total: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="MemTotal")
    mem_free: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="MemFree")
    buffers: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="Buffers")
    cached: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="Cached")
    active: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="Active")
    inactive: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="Inactive")
    swap_total: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="SwapTotal")
    swap_free: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="SwapFree")
    dirty: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="Dirty")
    writeback: Optional[StrictInt] = Field(default=None, description="Kilobytes", alias="Writeback")
    __properties: ClassVar[List[str]] = ["MemTotal", "MemFree", "Buffers", "Cached", "Active", "Inactive", "SwapTotal", "SwapFree", "Dirty", "Writeback"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SwapTotal": obj.get("SwapTotal"),
            "SwapFree": obj.get("SwapFree"),
            "Dirty": obj.get("Dirty"),
