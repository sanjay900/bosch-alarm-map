...
class Keyswitchlist(BaseModel):
    ...
    list: Optional[List[Keyswitch]] = Field(default=None, description="List of all keyswitches")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@type": obj.get("@type"),
            "@self": obj.get("@self"),
            "list": [Keyswitch.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
