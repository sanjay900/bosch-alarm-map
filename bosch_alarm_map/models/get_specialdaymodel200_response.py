...
class GetSpecialdaymodel200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["specialDayModelID", "dayModelID", "priority", "nextOccurrence", "repeatPolicy", "customRule", "easterOffset", "repeatUntil", "specialDayModelSyncID"]
