...
class BellTestStart(BaseModel):
    """
    This command is used to start the bell test.
    """ # noqa: E501
    ...
    def cmd_validate_enum(cls, value):
        ...
        if value not in set(['BELLTEST']):
            raise ValueError("must be one of enum values ('BELLTEST')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BellTestStart from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BellTestStart from a dict"""
        if obj is None:
            return None
