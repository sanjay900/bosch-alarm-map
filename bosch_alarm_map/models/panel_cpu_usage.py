...
class PanelCpuUsage(BaseModel):
    """
    CPU usage
    """ # noqa: E501
    current: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Current CPU usage percentage (5 seconds average)")
    averages: Optional[PanelCpuUsageAverages] = None
    __properties: ClassVar[List[str]] = ["current", "averages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "averages": PanelCpuUsageAverages.from_dict(obj["averages"]) if obj.get("averages") is not None else None
        })
        return _obj
