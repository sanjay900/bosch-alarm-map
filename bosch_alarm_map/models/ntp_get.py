...
class NtpGet(BaseModel):
    """
    NtpGet
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Timestamp and server of the last received NTP state otherwise empty")
    resync: Optional[StrictInt] = Field(default=None, description="Seconds until a next periodic NTP synchronization, value of 0 is shown in case of disabled NTP. Periodic synchronization is done once per 7 days")
    public: Optional[NtpGetPublic] = None
    custom: Optional[NtpGetCustom] = None
    __properties: ClassVar[List[str]] = ["status", "resync", "public", "custom"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "public": NtpGetPublic.from_dict(obj["public"]) if obj.get("public") is not None else None,
            "custom": NtpGetCustom.from_dict(obj["custom"]) if obj.get("custom") is not None else None
        })
        return _obj
