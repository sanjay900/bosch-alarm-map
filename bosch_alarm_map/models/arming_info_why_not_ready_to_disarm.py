...
class ArmingInfoWhyNotReadyToDisarm(BaseModel):
    """
    Nested objects providing reasons why the area is not ready to disarm
    """ # noqa: E501
    related_areas_not_ready_to_disarm: Optional[List[StrictStr]] = Field(default=None, description="List of related areas which are not ready to disarm which make this area not ready to disarm", alias="relatedAreasNotReadyToDisarm")
    related_areas_must_be_disarmed_first: Optional[List[StrictStr]] = Field(default=None, description="List of related areas which need to be disarmed before this area can be disarmed", alias="relatedAreasMustBeDisarmedFirst")
    virtual_outputs_off_prevents_disarming: Optional[List[StrictStr]] = Field(default=None, description="List of virtual outputs which are off preventing the area from disarming", alias="virtualOutputsOffPreventsDisarming")
    active_blocking_time_prevents_disarming: Optional[StrictBool] = Field(default=None, description="Flag indicates whether a blocking time is active which prevents the area from disarming", alias="activeBlockingTimePreventsDisarming")
    __properties: ClassVar[List[str]] = ["relatedAreasNotReadyToDisarm", "relatedAreasMustBeDisarmedFirst", "virtualOutputsOffPreventsDisarming", "activeBlockingTimePreventsDisarming"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "relatedAreasNotReadyToDisarm": obj.get("relatedAreasNotReadyToDisarm"),
            "relatedAreasMustBeDisarmedFirst": obj.get("relatedAreasMustBeDisarmedFirst"),
            "virtualOutputsOffPreventsDisarming": obj.get("virtualOutputsOffPreventsDisarming"),
            "activeBlockingTimePreventsDisarming": obj.get("activeBlockingTimePreventsDisarming")
        })
        return _obj
