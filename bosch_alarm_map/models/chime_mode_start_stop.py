...
class ChimeModeStartStop(BaseModel):
    """
    ...
    def cmd_validate_enum(cls, value):
        ...
        if value not in set(['STARTCHIMEMODE', 'STOPCHIMEMODE']):
            raise ValueError("must be one of enum values ('STARTCHIMEMODE', 'STOPCHIMEMODE')")
        return value
