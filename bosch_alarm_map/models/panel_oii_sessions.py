...
class PanelOIISessions(BaseModel):
    """
    ...
    """ # noqa: E501
    total_memory_usage: Optional[StrictInt] = Field(default=None, description="Total memory allocation for REST-API buffers", alias="totalMemoryUsage")
    per_session_usage: Optional[List[StrictInt]] = Field(default=None, description="Memory allocation per session", alias="perSessionUsage")
    __properties: ClassVar[List[str]] = ["totalMemoryUsage", "perSessionUsage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totalMemoryUsage": obj.get("totalMemoryUsage"),
            "perSessionUsage": obj.get("perSessionUsage")
        })
        return _obj
