...
class PostDayModelRequest(BaseModel):
    """
    PostDayModelRequest
    """ # noqa: E501
    cmd: StrictStr = Field(alias="@cmd")
    day_model_id: StrictStr = Field(description="Unique name of a DayModel. The name is used to identify the item on the MAP System. The following characters are forbidden in identifier name: \" @ ; ", alias="dayModelID")
    interval: Optional[List[StrictStr]] = Field(default=None, description="Define up to three timezones of the Daymodel.")
    ...
    __properties: ClassVar[List[str]] = ["@cmd", "dayModelID", "interval", "dayModelSyncID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostDayModelRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostDayModelRequest from a dict"""
        if obj is None:
            return None
