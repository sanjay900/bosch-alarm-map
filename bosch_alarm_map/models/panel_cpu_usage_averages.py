...
class PanelCpuUsageAverages(BaseModel):
    """
    Average CPU usage percentage over period (exponential moving average)
    """ # noqa: E501
    var_1min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average over 1 minute", alias="1min")
    var_5min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average over 5 minutes", alias="5min")
    var_30min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average over 30 minutes", alias="30min")
    __properties: ClassVar[List[str]] = ["1min", "5min", "30min"]
