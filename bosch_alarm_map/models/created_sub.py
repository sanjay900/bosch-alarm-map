...
class CreatedSub(BaseModel):
    """
    CreatedSub
    """ # noqa: E501
    subscription_url: Optional[StrictStr] = Field(default=None, description="A URL to the location of the newly created subscription.", alias="subscriptionURL")
    lease_time: Optional[StrictInt] = Field(default=None, description="Actual lease time", alias="leaseTime")
    buffer_size: Optional[StrictInt] = Field(default=None, description="Actual, allocated buffer size", alias="bufferSize")
    __properties: ClassVar[List[str]] = ["subscriptionURL", "leaseTime", "bufferSize"]
