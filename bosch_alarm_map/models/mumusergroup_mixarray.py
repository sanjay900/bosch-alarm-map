...
class MumusergroupMixarray(BaseModel):
    """
    ...
    user_ids: Optional[List[MumusergroupMixarrayAllOfUserIds]] = Field(default=None, alias="userIds")
    __properties: ClassVar[List[str]] = ["mumusergroupSyncID", "userIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userIds": [MumusergroupMixarrayAllOfUserIds.from_dict(_item) for _item in obj["userIds"]] if obj.get("userIds") is not None else None
        })
        return _obj
