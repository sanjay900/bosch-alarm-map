...
class PostAccessmodelRequest(BaseModel):
    """
    PostAccessmodelRequest
    """ # noqa: E501
    cmd: StrictStr = Field(alias="@cmd")
    access_model_id: StrictStr = Field(description="Unique name of an Access Model. The name is used to identify the item on the MAP System. The following characters are forbidden by the choose of the identifier name: \" @ ;", alias="accessModelID")
    access_profile_level: Optional[StrictInt] = Field(default=None, description="Numerical value that determines which users can be edited by users assigned to an Access Profile (4 = highest level, 998 = lowest level)", alias="accessProfileLevel")
    area_and_time_model_list: Optional[List[StrictStr]] = Field(default=None, description="List of Area and Time Model IDs that have beed assign to this access profile ", alias="areaAndTimeModelList")
    ...
    __properties: ClassVar[List[str]] = ["@cmd", "accessModelID", "accessProfileLevel", "areaAndTimeModelList", "accessModelSyncID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@cmd": obj.get("@cmd"),
            "accessModelID": obj.get("accessModelID"),
            "accessProfileLevel": obj.get("accessProfileLevel"),
            "areaAndTimeModelList": obj.get("areaAndTimeModelList"),
