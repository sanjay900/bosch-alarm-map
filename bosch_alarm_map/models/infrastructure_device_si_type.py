...
class InfrastructureDeviceSIType(str, Enum):
    """
    Security Identifier (SI) determines the type of device connected to the MAP.  The SI type can be one of the following values: 
    """
    ...
    MHAPI = 'MHAPI'
    AREA = 'Area'
    DETECTOR_ZONE = 'Detector Zone'
    CONTROL_PANEL_AREA = 'Control Panel Area'
    RESET_GROUP = 'Reset Group'
    COMMUNICATOR = 'Communicator'
    OUTPUT = 'Output'
    PERIPHERAL_BUS = 'Peripheral Bus'
    GATEWAY = 'Gateway'
    SYSTEM = 'System'
    USER_INTERFACE = 'User Interface'
    SYSTEM_KEYPAD = 'System Keypad'
    SIMULATOR = 'Simulator'
    ARMING_DEVICE = 'Arming Device'
    ...
    KEYSWITCH = 'Keyswitch'
    OII = 'OII'
    GENERIC_LOGICAL_DEVICE = 'Generic Logical Device'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of InfrastructureDeviceSIType from a JSON string"""
