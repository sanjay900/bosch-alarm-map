...
class ArmingInfoWhyNotReadyToArm(BaseModel):
    """
    Nested objects providing reasons why the area is not ready to arm
    """ # noqa: E501
    bypassable_faulted_devices: Optional[List[StrictStr]] = Field(default=None, description="List of off normal devices that can be bypassed while arming", alias="bypassableFaultedDevices")
    __properties: ClassVar[List[str]] = ["bypassableFaultedDevices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bypassableFaultedDevices": obj.get("bypassableFaultedDevices")
        })
        return _obj
