...
class UserBasicData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["userType", "accessModel", "active", "activeFrom", "activeUntil", "smartkeyModelName", "isOiiUser", "isOiiUserKpUser", "language", "passcodeChngRqd"]
