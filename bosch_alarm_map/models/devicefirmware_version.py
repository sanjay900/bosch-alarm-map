...
class DevicefirmwareVersion(BaseModel):
    ...
    """ # noqa: E501
    firmware_version: Optional[StrictStr] = Field(default=None, description="Firmware version of a DEModule, Keypad, Power Supply or LSNGateway in format MAJOR.MINOR.MICRO", alias="firmwareVersion")
    __properties: ClassVar[List[str]] = ["firmwareVersion"]
