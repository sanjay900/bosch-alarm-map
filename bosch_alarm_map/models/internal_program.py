...
class InternalProgram(BaseModel):
    """
    InternalProgram
    """ # noqa: E501
    ...
    active: Optional[StrictBool] = Field(default=None, description="True, if the internal program is active. False, otherwise.")
    __properties: ClassVar[List[str]] = ["@type", "@self", "active"]
