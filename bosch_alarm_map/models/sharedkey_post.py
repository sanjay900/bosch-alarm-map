...
class SharedkeyPost(BaseModel):
    """
    SharedkeyPost
    """ # noqa: E501
    cmd: StrictStr = Field(alias="@cmd")
    checksum: Optional[StrictStr] = Field(default=None, description="Shared Key checksum")
    encrypted: Optional[StrictStr] = Field(default=None, description="Encrypted Shared Key data")
    timestamp: Optional[StrictStr] = Field(default=None, description="Shared Key timestamp")
    __properties: ClassVar[List[str]] = ["@cmd", "checksum", "encrypted", "timestamp"]
