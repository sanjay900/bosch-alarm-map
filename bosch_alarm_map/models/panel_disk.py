...
class PanelDisk(BaseModel):
    """
    Disk (NAND flash) usage
    """ # noqa: E501
    total: Optional[StrictInt] = Field(default=None, description="Total disk capacity in kilobytes")
    free: Optional[StrictInt] = Field(default=None, description="Free disk capacity in kilobytes")
    usage: Optional[StrictInt] = Field(default=None, description="Used disk capacity in kilobytes")
    badblocks: Optional[StrictInt] = Field(default=None, description="Number of bad blocks of NAND flash")
    __properties: ClassVar[List[str]] = ["total", "free", "usage", "badblocks"]
