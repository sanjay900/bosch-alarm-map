...
class DiagnoseResponse(BaseModel):
    ...
    DiagnoseResponse
    """ # noqa: E501
    days_since_last_activity: Optional[StrictInt] = Field(default=None, description="Number of days since the last activity from the device", alias="daysSinceLastActivity")
    last_walktest_date: Optional[StrictStr] = Field(default=None, description="Time and date", alias="lastWalktestDate")
    walktest_recommended: Optional[StrictBool] = Field(default=None, description="True if a walktest is recommended for the device", alias="walktestRecommended")
    __properties: ClassVar[List[str]] = ["daysSinceLastActivity", "lastWalktestDate", "walktestRecommended"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "daysSinceLastActivity": obj.get("daysSinceLastActivity"),
            "lastWalktestDate": obj.get("lastWalktestDate"),
            "walktestRecommended": obj.get("walktestRecommended")
        })
        return _obj
