...
class PanelPanel(BaseModel):
    """
    Information about MAP Panel application itself
    """ # noqa: E501
    vm_size: Optional[StrictInt] = Field(default=None, description="Virtual RAM usage in kilobytes", alias="VmSize")
    vm_rss: Optional[StrictInt] = Field(default=None, description="Physical RAM usage in kilobytes", alias="VmRSS")
    threads: Optional[StrictInt] = Field(default=None, description="Number of threads used", alias="Threads")
    __properties: ClassVar[List[str]] = ["VmSize", "VmRSS", "Threads"]
