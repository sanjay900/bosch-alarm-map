...
class SupervisedConnsApi:
    ...
    def get_supervised_conns(
        ...
        _param = self._get_supervised_conns_serialize(
    ...
    @validate_call
    def get_supervised_conns_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SupervisedConnsList]:
        """List of Connections to other systems.
    ...
    @validate_call
    def get_supervised_conns_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_supervised_conns_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
