...
class DescApi:
    ...
    def getdesc(
        ...
        The description of the MAP panel is provided under “/desc”. The field mainResources will contain the links to the resources listed in the example. 
        ...
        _param = self._getdesc_serialize(
    ...
    @validate_call
    def getdesc_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
