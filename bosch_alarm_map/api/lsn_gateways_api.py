...
class LsnGatewaysApi:
    ...
    def getlsn_gateways(
        ...
        _param = self._getlsn_gateways_serialize(
    ...
    @validate_call
    def getlsn_gateways_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def getlsn_gateways_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _getlsn_gateways_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def postlsn_gateways(
        ...
        """Enable/Disable, Activate/Deactivate all lsnGateways
        ...
        _param = self._postlsn_gateways_serialize(
    ...
    @validate_call
    def postlsn_gateways_with_http_info(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def postlsn_gateways_without_preload_content(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    def _postlsn_gateways_serialize(
        self,
