...
class PointsApi:
    ...
    def get_points(
        ...
        _param = self._get_points_serialize(
    ...
    @validate_call
    def get_points_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_points(
        ...
        _param = self._post_points_serialize(
    ...
    @validate_call
    def post_points_with_http_info(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_points_without_preload_content(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
