...
class SharedkeyApi:
    ...
    def getsharedkey(
        ...
        _param = self._getsharedkey_serialize(
    ...
    @validate_call
    def getsharedkey_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def getsharedkey_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def postsharedkey(
        self,
        sharedkey_post: Optional[SharedkeyPost] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Shared Key can be created, modified, deleted. Shared Key is only available as an encrypted text. Shared Key can only be decrypted by MAP panels that share the same master key. Shared Key is used to encrypt sensitive user attributes, such as: passcode, oiiPassword, smartKeyToken. For modification, the checksum of the new key is required. For deletion, checksum of stored (current) key is required. 

        :param sharedkey_post:
        :type sharedkey_post: SharedkeyPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._postsharedkey_serialize(
            sharedkey_post=sharedkey_post,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def postsharedkey_with_http_info(
        self,
        sharedkey_post: Optional[SharedkeyPost] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def postsharedkey_without_preload_content(
        self,
        sharedkey_post: Optional[SharedkeyPost] = None,
        _request_timeout: Union[
            None,
    ...
    def _postsharedkey_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if sharedkey_post is not None:
            _body_params = sharedkey_post
