...
class CouplerSIIDApi:
    ...
    @validate_call
    def get_coupler_siid(
        self,
        coupler_siid: Annotated[StrictStr, Field(description="Unique coupler SIID. You can get all existing couplers SIIDs with the command GET /couplers")],
        ...
        The type coupler_SIID lists the couplers and provides the same interface as device type. It can be disabled. It cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 

        :param coupler_siid: Unique coupler SIID. You can get all existing couplers SIIDs with the command GET /couplers (required)
        :type coupler_siid: str
        ...
        _param = self._get_coupler_siid_serialize(
            coupler_siid=coupler_siid,
    ...
    @validate_call
    def get_coupler_siid_with_http_info(
        self,
        coupler_siid: Annotated[StrictStr, Field(description="Unique coupler SIID. You can get all existing couplers SIIDs with the command GET /couplers")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_coupler_siid_without_preload_content(
        self,
        coupler_siid: Annotated[StrictStr, Field(description="Unique coupler SIID. You can get all existing couplers SIIDs with the command GET /couplers")],
        _request_timeout: Union[
            None,
    ...
    def _get_coupler_siid_serialize(
        self,
        coupler_siid,
        _request_auth,
        _content_type,
        ...
        if coupler_siid is not None:
            _path_params['coupler_SIID'] = coupler_siid
    ...
    def post_coupler_siid(
        ...
        _param = self._post_coupler_siid_serialize(
            coupler_siid=coupler_siid,
    ...
    @validate_call
    def post_coupler_siid_with_http_info(
        self,
        coupler_siid: Annotated[StrictStr, Field(description="Unique coupler SIID. You can get all existing couplers SIIDs with the command GET /couplers")],
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    @validate_call
    def post_coupler_siid_without_preload_content(
        self,
        coupler_siid: Annotated[StrictStr, Field(description="Unique coupler SIID. You can get all existing couplers SIIDs with the command GET /couplers")],
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    def _post_coupler_siid_serialize(
        self,
        coupler_siid,
