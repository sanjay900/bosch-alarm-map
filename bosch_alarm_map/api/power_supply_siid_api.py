...
class PowerSupplySIIDApi:
    ...
    @validate_call
    def get_posersupply_siid(
        self,
        power_supply_siid: Annotated[StrictStr, Field(description="Unique power supply SIID. You can get all power supplies IDs with the command GET /powerSupplies")],
        ...
        :param power_supply_siid: Unique power supply SIID. You can get all power supplies IDs with the command GET /powerSupplies (required)
        :type power_supply_siid: str
        ...
        _param = self._get_posersupply_siid_serialize(
            power_supply_siid=power_supply_siid,
    ...
    @validate_call
    def get_posersupply_siid_with_http_info(
        self,
        power_supply_siid: Annotated[StrictStr, Field(description="Unique power supply SIID. You can get all power supplies IDs with the command GET /powerSupplies")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_posersupply_siid_without_preload_content(
        self,
        power_supply_siid: Annotated[StrictStr, Field(description="Unique power supply SIID. You can get all power supplies IDs with the command GET /powerSupplies")],
        _request_timeout: Union[
            None,
    ...
    def _get_posersupply_siid_serialize(
        self,
        power_supply_siid,
        _request_auth,
        _content_type,
        ...
        if power_supply_siid is not None:
            _path_params['powerSupply_SIID'] = power_supply_siid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{powerSupply_SIID}',
    ...
    @validate_call
    def post_powersupply_siid(
        self,
        power_supply_siid: StrictStr,
        ...
        :param power_supply_siid: (required)
        :type power_supply_siid: str
        ...
        _param = self._post_powersupply_siid_serialize(
            power_supply_siid=power_supply_siid,
    ...
    @validate_call
    def post_powersupply_siid_with_http_info(
        self,
        power_supply_siid: StrictStr,
        postlsn_gateway_siid_request: PostlsnGatewaySIIDRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_powersupply_siid_without_preload_content(
        self,
        power_supply_siid: StrictStr,
        postlsn_gateway_siid_request: PostlsnGatewaySIIDRequest,
        _request_timeout: Union[
    ...
    def _post_powersupply_siid_serialize(
        self,
        power_supply_siid,
