...
class LsnauxsApi:
    ...
    def get_lsnauxs(
        ...
        _param = self._get_lsnauxs_serialize(
    ...
    @validate_call
    def get_lsnauxs_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_lsnauxs_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_lsnauxs(
        ...
        _param = self._post_lsnauxs_serialize(
    ...
    @validate_call
    def post_lsnauxs_with_http_info(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_lsnauxs_without_preload_content(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
