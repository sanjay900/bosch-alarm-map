...
class AreaandtimemodelApi:
    ...
    @validate_call
    def get_areaandtimemodel(
        self,
        area_and_time_model_id: Annotated[StrictStr, Field(description="Unique area and time model name")],
        ...
        :param area_and_time_model_id: Unique area and time model name (required)
        :type area_and_time_model_id: str
        ...
        _param = self._get_areaandtimemodel_serialize(
            area_and_time_model_id=area_and_time_model_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAreaandtimemodel200Response",
            '401': None,
            '403': None,
            '404': None,
            '500': None,
    ...
    @validate_call
    def get_areaandtimemodel_with_http_info(
        self,
        area_and_time_model_id: Annotated[StrictStr, Field(description="Unique area and time model name")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAreaandtimemodel200Response]:
        """Get a specific area and time model from the MAP system
    ...
    @validate_call
    def get_areaandtimemodel_without_preload_content(
        self,
        area_and_time_model_id: Annotated[StrictStr, Field(description="Unique area and time model name")],
        _request_timeout: Union[
            None,
    ...
    def _get_areaandtimemodel_serialize(
        self,
        area_and_time_model_id,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if area_and_time_model_id is not None:
            _path_params['AreaAndTimeModelID'] = area_and_time_model_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/areaandtimemodel/{AreaAndTimeModelID}',
    ...
    @validate_call
    def post_areaandtimemodel(
        self,
        post_areaandtimemodel_request: PostAreaandtimemodelRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This function is used to create, modify or delete an AreaAndTime Model on a MAP system from the REST-API interface. It has the same functionalities like the RPS for MAP. This URL is designed to be used from a system, that controls remotely the user and system parameters of several MAP systems. <br> To use the functions, every POST request needs a valid areaAndTimeModelSyncID. The initial areaAndTimeModelSyncID can be get from the commands GET /syncstatus or GET /areaandtimemodellist. After a successful operation, you get a new valid areaAndTimeModelSyncID back. It is recommended to use this ID, if you want to create, modify or delete several AreaAndTime models.<br> A AreaAndTime Model can be assigned to access models. Do not delete the used AreaAndTime Model, if it has a dependency to an access model.  ### Create AreaAndTime Model  To create a new AreaAndTime model on a MAP system, the client must ensure that the key value *areaAndTimeModelID* is not already used on the system. Further a valid areaAndTimeModelSyncID is required. The example **createAreaAndTimeModel** shows how to create an AreaAndTime Model.  ### Modify AreaAndTime Model  To modify an existing AreaAndTime model on a MAP system, the client needs a valid *areaAndTimeModelSyncID*. The example *modifyAreaAndTimeModel* shows how to modify an AreaAndTime Model.   ### Delete AreaAndTime Model  To delete an existing AreaAndTime model on a MAP system, the client needs also a valid *areaAndTimeModelSyncID*. The example *deleteAreaAndTimeModel* shows how to delete an AreaAndTime Model. 

        :param post_areaandtimemodel_request: (required)
        :type post_areaandtimemodel_request: PostAreaandtimemodelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_areaandtimemodel_serialize(
            post_areaandtimemodel_request=post_areaandtimemodel_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_areaandtimemodel_with_http_info(
        self,
        post_areaandtimemodel_request: PostAreaandtimemodelRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AreaAndTimeModelSyncID]:
        """Create, modify or delete an area and time model on the MAP system
    ...
    @validate_call
    def post_areaandtimemodel_without_preload_content(
        self,
        post_areaandtimemodel_request: PostAreaandtimemodelRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_areaandtimemodel_serialize(
        self,
        post_areaandtimemodel_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_areaandtimemodel_request is not None:
            _body_params = post_areaandtimemodel_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/areaandtimemodel',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
