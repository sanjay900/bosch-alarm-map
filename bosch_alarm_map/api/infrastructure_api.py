...
class InfrastructureApi:
    ...
    def getinfrastructure(
        ...
        _param = self._getinfrastructure_serialize(
    ...
    @validate_call
    def getinfrastructure_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def getinfrastructure_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _getinfrastructure_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def getinfrastructurebysiid(
        self,
        device_siid: Annotated[StrictStr, Field(description="SIID of a device")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Returns a connected devices tree starting from requested SIID.  It is also possible to limit hierarchy depth by specifying depth parameter: - /infrastructure/{DeviceSIID}?depth={Value} 

        :param device_siid: SIID of a device (required)
        ...
        _param = self._getinfrastructurebysiid_serialize(
    ...
    @validate_call
    def getinfrastructurebysiid_with_http_info(
        self,
        device_siid: Annotated[StrictStr, Field(description="SIID of a device")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InfrastructureDevice]:
        """Get MAP device infrastructure starting from SIID
    ...
    @validate_call
    def getinfrastructurebysiid_without_preload_content(
        self,
        device_siid: Annotated[StrictStr, Field(description="SIID of a device")],
        _request_timeout: Union[
            None,
    ...
    def _getinfrastructurebysiid_serialize(
        self,
        device_siid,
        _request_auth,
        _content_type,
        ...
        if device_siid is not None:
            _path_params['DeviceSIID'] = device_siid
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/infrastructure/{DeviceSIID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
