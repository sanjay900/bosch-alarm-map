...
class SmartkeySIIDApi:
    ...
    @validate_call
    def get_smartkey_siid(
        self,
        smartkey_siid: StrictStr,
        ...
        :param smartkey_siid: (required)
        :type smartkey_siid: str
        ...
        _param = self._get_smartkey_siid_serialize(
            smartkey_siid=smartkey_siid,
    ...
    @validate_call
    def get_smartkey_siid_with_http_info(
        self,
        smartkey_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_smartkey_siid_without_preload_content(
        self,
        smartkey_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_smartkey_siid_serialize(
        self,
        smartkey_siid,
        _request_auth,
        _content_type,
        ...
        if smartkey_siid is not None:
            _path_params['smartkey_SIID'] = smartkey_siid
    ...
    def post_smartkey_siid(
        ...
        _param = self._post_smartkey_siid_serialize(
            smartkey_siid=smartkey_siid,
    ...
    @validate_call
    def post_smartkey_siid_with_http_info(
        self,
        smartkey_siid: StrictStr,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_smartkey_siid_without_preload_content(
        self,
        smartkey_siid: StrictStr,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    def _post_smartkey_siid_serialize(
        self,
        smartkey_siid,
