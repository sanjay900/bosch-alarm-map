...
class PsCanOpListApi:
    ...
    def get_ps_can_op_list(
        ...
        _param = self._get_ps_can_op_list_serialize(
    ...
    @validate_call
    def get_ps_can_op_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_ps_can_op_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_ps_can_op_list_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
