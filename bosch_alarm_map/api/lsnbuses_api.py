...
class LsnbusesApi:
    ...
    def get_lsnbuses(
        ...
        The resource type lsnBuses lists the LSN loop and LSN Stub on the LSN Gateway. It provides the same interface as the resource type device. The resource structure will contain attributes of device and disable. 
        ...
        _param = self._get_lsnbuses_serialize(
    ...
    @validate_call
    def get_lsnbuses_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_lsnbuses_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_lsnbuses(
        ...
        The resource type lsnBus models the LSN loop and LSN Stub on the LSN Gateway. It provides the same interface as the resource type device. This resource type can be disabled. This resource type cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 
        ...
        _param = self._post_lsnbuses_serialize(
    ...
    @validate_call
    def post_lsnbuses_with_http_info(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_lsnbuses_without_preload_content(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
