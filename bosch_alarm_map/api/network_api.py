...
class NetworkApi:
    ...
    def post_network(
        ...
        This resource allows modifying of the IP network settings of the MAP panel. The new network configuration is only active after a system restart.  See also the examples: - Activate DHCP - Set static IP address 

        :param network_post: (required)
        :type network_post: NetworkPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_network_serialize(
    ...
    @validate_call
    def post_network_with_http_info(
        self,
        network_post: NetworkPost,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_network_without_preload_content(
        self,
        network_post: NetworkPost,
        _request_timeout: Union[
            None,
    ...
    def _post_network_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if network_post is not None:
            _body_params = network_post
