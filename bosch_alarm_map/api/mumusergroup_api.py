...
class MumusergroupApi:
    ...
    def getmumusergroup(
        ...
        _param = self._getmumusergroup_serialize(
    ...
    @validate_call
    def getmumusergroup_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MumusergroupMixarray]:
        """Get MUM property for all User IDs
    ...
    @validate_call
    def getmumusergroup_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _getmumusergroup_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def postmumusergroup(
        self,
        mumusergroup_mixarray: Optional[MumusergroupMixarray] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        From this URL it is possible to reserve a set of UserIDs on a MAP system. The reserved IDs are managed and controlled by a user management system like the MUM application. If the mumusergroup flag is set to a User ID, the IDs defined in the mumusergroup are not anymore controllable and shown on the MAP Keypads, which are connected to the MAP system.<br>  ### Define user group  To assign users to the group, either individual IDs or ID ranges can be defined. The examples under the content type *setsingleIds* shows examples, how a set single user IDs into the MUM user group. The following examples show, how to create a mum group with a single userid or with 3 userids:   - setsingleUserID   - setsingleUserIDs  To remove the group, send an empty array. See example:   - deletegroup  The examples under the content type *setmixedgroup* demonstrate, how to create a group via a userID range. The example:   - setfullrange  demonstrates the way how to create a group, where all users on a MAP system are managed by the MUM application.  In the example:   - setmixUserIdgroup  only the users with IDs { 4, 5, 70,71,72,...,89,90, 100, 200,201, ...,299,300 } are managed by the user application. 

        :param mumusergroup_mixarray:
        :type mumusergroup_mixarray: MumusergroupMixarray
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._postmumusergroup_serialize(
            mumusergroup_mixarray=mumusergroup_mixarray,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def postmumusergroup_with_http_info(
        self,
        mumusergroup_mixarray: Optional[MumusergroupMixarray] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def postmumusergroup_without_preload_content(
        self,
        mumusergroup_mixarray: Optional[MumusergroupMixarray] = None,
        _request_timeout: Union[
            None,
    ...
    def _postmumusergroup_serialize(
        self,
        mumusergroup_mixarray,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if mumusergroup_mixarray is not None:
            _body_params = mumusergroup_mixarray
