...
class PermissionmodelApi:
    ...
    @validate_call
    def get_permissionmodel(
        self,
        permission_model_id: Annotated[StrictStr, Field(description="Unique permission model name")],
        ...
        :param permission_model_id: Unique permission model name (required)
        :type permission_model_id: str
        ...
        _param = self._get_permissionmodel_serialize(
            permission_model_id=permission_model_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetPermissionmodel200Response",
            '401': None,
            '404': None,
            '500': None,
            '503': None,
    ...
    @validate_call
    def get_permissionmodel_with_http_info(
        self,
        permission_model_id: Annotated[StrictStr, Field(description="Unique permission model name")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPermissionmodel200Response]:
        """Get a specific permission model from the MAP system
    ...
    @validate_call
    def get_permissionmodel_without_preload_content(
        self,
        permission_model_id: Annotated[StrictStr, Field(description="Unique permission model name")],
        _request_timeout: Union[
            None,
    ...
    def _get_permissionmodel_serialize(
        self,
        permission_model_id,
        _request_auth,
        _content_type,
        ...
        if permission_model_id is not None:
            _path_params['PermissionModelID'] = permission_model_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/permissionmodel/{PermissionModelID}',
    ...
    @validate_call
    def post_permisionmodel(
        self,
        post_permisionmodel_request: PostPermisionmodelRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This function is used to create, modify or delete a permission model on a MAP system from the REST-API interface. It has the same functionalities like the RPS for MAP. This URL is designed to be used from a system, that controls remotely the user and system parameters of several MAP systems. <br> To use the functions, every POST request needs a valid permissionModelSyncID. The initial permissionModelSyncID can be get from the commands GET /syncstatus or GET /permissionmodellist. After a successful operation, you get a new valid permissionModelSyncID back. It is recommended to use this ID, if you want to create, modify or delete several AreaAndTime models.<br> A permission model can be assigned to Area and Time Model. Do not delete the used permission model, if it has a dependency to a Area and Time Model.  ### Create permission model  To create a new permission model on a MAP system, the client must ensure that the key value *permissionModelSyncID* is not already used on the system. Further a valid accesspermissionModelSyncID is required. The example *createPermissionModel* shows how to create a permission model:  ### Modify permission model  To modify an existing permission model on a MAP system, the client needs a valid *permissionModelSyncID*. The example *modifyPermissionModel** shows how to modify a permission model:  ### Delete permission model  To delete an existing access model on a MAP system, the client needs also a valid *permissionModelSyncID*. The example *deletePermissionModel* shows how to delete a permission model: 

        :param post_permisionmodel_request: (required)
        :type post_permisionmodel_request: PostPermisionmodelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_permisionmodel_serialize(
            post_permisionmodel_request=post_permisionmodel_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_permisionmodel_with_http_info(
        self,
        post_permisionmodel_request: PostPermisionmodelRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PermissionModelSyncID]:
        """Create a new permission model on the MAP system
    ...
    @validate_call
    def post_permisionmodel_without_preload_content(
        self,
        post_permisionmodel_request: PostPermisionmodelRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_permisionmodel_serialize(
        self,
        post_permisionmodel_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_permisionmodel_request is not None:
            _body_params = post_permisionmodel_request
