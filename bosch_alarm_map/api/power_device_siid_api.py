...
class PowerDeviceSIIDApi:
    ...
    @validate_call
    def getpower_device_siid(
        self,
        power_device_siid: Annotated[StrictStr, Field(description="Unique powerDevice SIID. You can get all existing powerDevices IDs with the command GET /powerDevices")],
        ...
        The type powerdevice lists power devices configured on couplers on the LSN. It provides the same interface as device type. It can be disabled. It cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 

        :param power_device_siid: Unique powerDevice SIID. You can get all existing powerDevices IDs with the command GET /powerDevices (required)
        :type power_device_siid: str
        ...
        _param = self._getpower_device_siid_serialize(
            power_device_siid=power_device_siid,
    ...
    @validate_call
    def getpower_device_siid_with_http_info(
        self,
        power_device_siid: Annotated[StrictStr, Field(description="Unique powerDevice SIID. You can get all existing powerDevices IDs with the command GET /powerDevices")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def getpower_device_siid_without_preload_content(
        self,
        power_device_siid: Annotated[StrictStr, Field(description="Unique powerDevice SIID. You can get all existing powerDevices IDs with the command GET /powerDevices")],
        _request_timeout: Union[
            None,
    ...
    def _getpower_device_siid_serialize(
        self,
        power_device_siid,
        _request_auth,
        _content_type,
        ...
        if power_device_siid is not None:
            _path_params['powerDevice_SIID'] = power_device_siid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{powerDevice_SIID}',
