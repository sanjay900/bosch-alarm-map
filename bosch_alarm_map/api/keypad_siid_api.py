...
class KeypadSIIDApi:
    ...
    def get_keypad_siid(
        self,
        keypad_siid: Annotated[StrictStr, Field(description="Unique Keypad SIID. You can get all existing Keypads IDs with the command GET /keypads")],
        ...
        This lists the system Keypad of the MAP system. It extends device resource type with additional statuses and commands specific to the Keypad. It supports a firmware version command to retrieve the firmware version running on the Keypad. It can be disabled. This resource type cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. Note: In addition to the behaviour of a disabled device, disabling a Keypad results in the Keypad being locked. The LEDs do not change their state. The screen is not turned off but no user can log in. A logged in user will be logged out. 

        :param keypad_siid: Unique Keypad SIID. You can get all existing Keypads IDs with the command GET /keypads (required)
        :type keypad_siid: str
        ...
        _param = self._get_keypad_siid_serialize(
            keypad_siid=keypad_siid,
    ...
    @validate_call
    def get_keypad_siid_with_http_info(
        self,
        keypad_siid: Annotated[StrictStr, Field(description="Unique Keypad SIID. You can get all existing Keypads IDs with the command GET /keypads")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_keypad_siid_without_preload_content(
        self,
        keypad_siid: Annotated[StrictStr, Field(description="Unique Keypad SIID. You can get all existing Keypads IDs with the command GET /keypads")],
        _request_timeout: Union[
            None,
    ...
    def _get_keypad_siid_serialize(
        self,
        keypad_siid,
        _request_auth,
        _content_type,
        ...
        if keypad_siid is not None:
            _path_params['keypad_SIID'] = keypad_siid
    ...
    @validate_call
    def post_keypad_siid(
        self,
        keypad_siid: StrictStr,
        post_keypad_siid_request: PostKeypadSIIDRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param keypad_siid: (required)
        :type keypad_siid: str
        :param post_keypad_siid_request: (required)
        :type post_keypad_siid_request: PostKeypadSIIDRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_keypad_siid_serialize(
            keypad_siid=keypad_siid,
            post_keypad_siid_request=post_keypad_siid_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_keypad_siid_with_http_info(
        self,
        keypad_siid: StrictStr,
        post_keypad_siid_request: PostKeypadSIIDRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DevicefirmwareVersion]:
        """Enable/Disable, Activate/Deactivate, get firmware Version of a Keypad
    ...
    @validate_call
    def post_keypad_siid_without_preload_content(
        self,
        keypad_siid: StrictStr,
        post_keypad_siid_request: PostKeypadSIIDRequest,
        _request_timeout: Union[
    ...
    def _post_keypad_siid_serialize(
        self,
        keypad_siid,
        post_keypad_siid_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_keypad_siid_request is not None:
            _body_params = post_keypad_siid_request
