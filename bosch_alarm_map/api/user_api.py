...
class UserApi:
    ...
    def get_user_id(
        self,
        user_id: Annotated[StrictStr, Field(description="Unique user ID of each MAP panel user. User ID range is 004 - 999.")],
        ...
        :param user_id: Unique user ID of each MAP panel user. User ID range is 004 - 999. (required)
        :type user_id: str
    ...
    def post_user_id(
        self,
        user_id: Annotated[StrictStr, Field(description="Unique user ID of each MAP system user. User ID range is 004 - 999.")],
        ...
        :param user_id: Unique user ID of each MAP system user. User ID range is 004 - 999. (required)
        :type user_id: str
        :param user_activate: (required)
        :type user_activate: UserActivate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_user_id_serialize(
            user_id=user_id,
    ...
    @validate_call
    def post_user_id_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="Unique user ID of each MAP system user. User ID range is 004 - 999.")],
        user_activate: UserActivate,
        _request_timeout: Union[
    ...
    @validate_call
    def post_user_id_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="Unique user ID of each MAP system user. User ID range is 004 - 999.")],
        user_activate: UserActivate,
        _request_timeout: Union[
    ...
    def _post_user_id_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if user_activate is not None:
            _body_params = user_activate
