...
class PrinterSIIDApi:
    ...
    @validate_call
    def get_printer_siid(
        self,
        printer_siid: StrictStr,
        ...
        The resource printer extends the device type with additional parameters such as cover open and paper low. It models the printer device. It can be disabled and implements the disable interface. It cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 

        :param printer_siid: (required)
        :type printer_siid: str
        ...
        _param = self._get_printer_siid_serialize(
            printer_siid=printer_siid,
    ...
    @validate_call
    def get_printer_siid_with_http_info(
        self,
        printer_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_printer_siid_without_preload_content(
        self,
        printer_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_printer_siid_serialize(
        self,
        printer_siid,
        _request_auth,
        _content_type,
        ...
        if printer_siid is not None:
            _path_params['printer_SIID'] = printer_siid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/printer_SIID/{printer_SIID}',
    ...
    def post_printer_siid(
        ...
        _param = self._post_printer_siid_serialize(
            printer_siid=printer_siid,
    ...
    @validate_call
    def post_printer_siid_with_http_info(
        self,
        printer_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    @validate_call
    def post_printer_siid_without_preload_content(
        self,
        printer_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    def _post_printer_siid_serialize(
        self,
        printer_siid,
