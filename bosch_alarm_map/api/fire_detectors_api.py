...
class FireDetectorsApi:
    ...
    def getfire_detectors(
        ...
        _param = self._getfire_detectors_serialize(
    ...
    @validate_call
    def getfire_detectors_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def getfire_detectors_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _getfire_detectors_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def postfire_detectors(
        ...
        _param = self._postfire_detectors_serialize(
    ...
    @validate_call
    def postfire_detectors_with_http_info(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def postfire_detectors_without_preload_content(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    def _postfire_detectors_serialize(
        self,
