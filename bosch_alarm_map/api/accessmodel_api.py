...
class AccessmodelApi:
    ...
    def get_accessmodel(
        self,
        access_model_id: Annotated[StrictStr, Field(description="Unique accessmodel name")],
        ...
        :param access_model_id: Unique accessmodel name (required)
        :type access_model_id: str
        ...
        _param = self._get_accessmodel_serialize(
            access_model_id=access_model_id,
    ...
    @validate_call
    def get_accessmodel_with_http_info(
        self,
        access_model_id: Annotated[StrictStr, Field(description="Unique accessmodel name")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAccessmodel200Response]:
        """Get a specific accessmodel from the MAP system
    ...
    @validate_call
    def get_accessmodel_without_preload_content(
        self,
        access_model_id: Annotated[StrictStr, Field(description="Unique accessmodel name")],
        _request_timeout: Union[
            None,
    ...
    def _get_accessmodel_serialize(
        self,
        access_model_id,
        _request_auth,
        _content_type,
        ...
        if access_model_id is not None:
            _path_params['AccessModelID'] = access_model_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accessmodel/{AccessModelID}',
    ...
    @validate_call
    def post_accessmodel(
        self,
        post_accessmodel_request: PostAccessmodelRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This function is used to create, modify or delete an access model on a MAP system from the REST-API interface. It has the same functionalities like the RPS for MAP. This URL is designed to be used from a system, that controls remotely the user and system parameters of several MAP systems. <br> To use the functions, every POST request needs a valid accessModelSyncID. The initial areaAndTimeModelSyncID can be get from the commands GET /syncstatus or GET /accesmodellist. After a successful operation, you get a new valid accessModelSyncID back. It is recommended to use this ID, if you want to create, modify or delete several AreaAndTime models.<br> An access model can be assigned to users. Do not delete the used access model, if it has a dependency to a user.  ### Create Access Model  To create a new access model on a MAP system, the client must ensure that the key value *accessModelID* is not already used on the system. Further a valid accessModelSyncID is required. The example *createAccessModel* shows how to create an access model.  ### Modify Access Model  To modify an existing access model on a MAP system, the client needs a valid *areaAndTimeModelSyncID*. The example *modifyAccessModel* shows how to modify an access model.   ### Delete Access Model  To delete an existing access model on a MAP system, the client needs also a valid *accessModelSyncID*. The example *deleteAccessModel** shows how to delete an access model: 

        :param post_accessmodel_request: (required)
        :type post_accessmodel_request: PostAccessmodelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_accessmodel_serialize(
            post_accessmodel_request=post_accessmodel_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_accessmodel_with_http_info(
        self,
        post_accessmodel_request: PostAccessmodelRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_accessmodel_without_preload_content(
        self,
        post_accessmodel_request: PostAccessmodelRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_accessmodel_serialize(
        self,
        post_accessmodel_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_accessmodel_request is not None:
            _body_params = post_accessmodel_request
