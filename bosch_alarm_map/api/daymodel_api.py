...
class DaymodelApi:
    ...
    def get_daymodel(
        self,
        day_model_id: Annotated[StrictStr, Field(description="Unique name of a DayModel item. The name is used to identify the item on the MAP system")],
        ...
        :param day_model_id: Unique name of a DayModel item. The name is used to identify the item on the MAP system (required)
        :type day_model_id: str
        ...
        _param = self._get_daymodel_serialize(
    ...
    @validate_call
    def get_daymodel_with_http_info(
        self,
        day_model_id: Annotated[StrictStr, Field(description="Unique name of a DayModel item. The name is used to identify the item on the MAP system")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDaymodel200Response]:
        """Get a specific daymodel item from the MAP system
    ...
    @validate_call
    def get_daymodel_without_preload_content(
        self,
        day_model_id: Annotated[StrictStr, Field(description="Unique name of a DayModel item. The name is used to identify the item on the MAP system")],
        _request_timeout: Union[
            None,
    ...
    def _get_daymodel_serialize(
        ...
        if day_model_id is not None:
            _path_params['dayModelID'] = day_model_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/daymodel/{dayModelID}',
    ...
    def post_day_model(
        self,
        post_day_model_request: PostDayModelRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This function is used to create, modify or delete day model on a MAP system from the REST-API interface. It has the same functionalities like the RPS for MAP. This URL is designed to be used from a system, that controls remotely the user and system parameters of several MAP systems. <br> To use the functions, every POST request needs a valid dayModelSyncID. The initial dayModelSyncID can be get from the command GET /syncstatus or GET /daymodellist. After a successful operation, you get a new valid dayModelSyncID back. It is recommended to use this ID, if you want to create, modify or delete several day models.<br> By the creation or modification of the *interval* array, the client must ensure that the previous interval value is set. The client must also ensure that the intervals are not overlapped and that the start time is earlier than the end time. A day model can be used from a time model and/or a specialday model. Do not delete the used daymodel, if it has a dependency to a time model or specialday model.  ### Create day model  To create a new daymodel on a MAP system, the client must ensure that the key value *dayModelID* is not already used on the system. Further a valid dayModelSyncID is required. The example *createDayModel* shows how to create a daymodel:  ### Modify day model  To modify a existing day model on a MAP system, the client needs a valid dayModelSyncID. The example *modifyDayModel* shows how to modify a day model:  ### Delete day model  To delete a existing day model on a MAP system, the client needs also a valid dayModelSyncID. The example *deleteDayModel* shows how to delete a day model: 

        :param post_day_model_request: (required)
        :type post_day_model_request: PostDayModelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_day_model_serialize(
            post_day_model_request=post_day_model_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_day_model_with_http_info(
        self,
        post_day_model_request: PostDayModelRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_day_model_without_preload_content(
        self,
        post_day_model_request: PostDayModelRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_day_model_serialize(
        self,
        post_day_model_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_day_model_request is not None:
            _body_params = post_day_model_request
