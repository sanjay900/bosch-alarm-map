...
class SupervisedConnsSIIDApi:
    ...
    @validate_call
    def get_supervised_conns_siid(
        self,
        supervised_conns_siid: StrictStr,
        ...
        :param supervised_conns_siid: (required)
        :type supervised_conns_siid: str
        ...
        _param = self._get_supervised_conns_siid_serialize(
            supervised_conns_siid=supervised_conns_siid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSupervisedConnsSIID200Response",
            '401': None,
            '403': None,
            '414': None,
            '500': None,
    ...
    @validate_call
    def get_supervised_conns_siid_with_http_info(
        self,
        supervised_conns_siid: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSupervisedConnsSIID200Response]:
        """Individual supervised connection
    ...
    @validate_call
    def get_supervised_conns_siid_without_preload_content(
        self,
        supervised_conns_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_supervised_conns_siid_serialize(
        self,
        supervised_conns_siid,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if supervised_conns_siid is not None:
            _path_params['supervisedConns_SIID'] = supervised_conns_siid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{supervisedConns_SIID}',
    ...
    @validate_call
    def post_supervised_conns(
        self,
        supervised_conns_siid: StrictStr,
        device_enable_disable: Optional[DeviceEnableDisable] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Enable or disable a supervised connection to other systems like BIS, IPC, or REST-API. Please note that the REST-API interface can only be deactivated. The activation is done via the RPS for MAP software. This resource type cannot be bypassed. 

        :param supervised_conns_siid: (required)
        :type supervised_conns_siid: str
        :param device_enable_disable:
        ...
        _param = self._post_supervised_conns_serialize(
            supervised_conns_siid=supervised_conns_siid,
    ...
    @validate_call
    def post_supervised_conns_with_http_info(
        self,
        supervised_conns_siid: StrictStr,
        device_enable_disable: Optional[DeviceEnableDisable] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_supervised_conns_without_preload_content(
        self,
        supervised_conns_siid: StrictStr,
        device_enable_disable: Optional[DeviceEnableDisable] = None,
        _request_timeout: Union[
    ...
    def _post_supervised_conns_serialize(
        self,
        supervised_conns_siid,
