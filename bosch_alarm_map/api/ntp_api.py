...
class NtpApi:
    ...
    def get_ntp(
        ...
        The Network Time Protocol (NTP) resource provides insight into current NTP state.  Configured NTP synchronization is done upon a panel reboot and repeated once per 7 days. 
        ...
        _param = self._get_ntp_serialize(
    ...
    @validate_call
    def get_ntp_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_ntp(
        ...
        :param ntp_post: (required)
        :type ntp_post: NtpPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_ntp_serialize(
            ntp_post=ntp_post,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_ntp_without_preload_content(
        self,
        ntp_post: NtpPost,
        _request_timeout: Union[
            None,
    ...
    def _post_ntp_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ntp_post is not None:
            _body_params = ntp_post
