...
class BatteriesApi:
    ...
    def get_batteries(
        ...
        The resource type battery list all connected batteries at the power supply. It provides the same interface as devices, it can be disabled and bypassed. This resource type cannot be walktested. 
        ...
        _param = self._get_batteries_serialize(
    ...
    @validate_call
    def get_batteries_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_batteries_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_batteries(
        ...
        The resource type batteries, list the battery connected of the power supply. It provides the same interface as the resource type device. It can be disabled and bypassed. This resource type cannot be walktested. 
        ...
        _param = self._post_batteries_serialize(
    ...
    @validate_call
    def post_batteries_with_http_info(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_batteries_without_preload_content(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
