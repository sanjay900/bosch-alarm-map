...
class InternalprogramSIIDApi:
    ...
    @validate_call
    def get_internalprogram_siid(
        self,
        internalprogram_siid: Annotated[StrictStr, Field(description="Unique internal program SIID (1-14). You can get all existing internal program IDs with the command GET /internalprograms")],
        ...
        The internal program resource allows investigating the status of internal programs configured in the MAP system and allows activating or deactivating the internal program. In case an alarm occurs, the alarm will be referenced by the area in which it occurred not at the internal program. Similarly, the incident will not indicate the internal program but the area that detected the alarm. 

        :param internalprogram_siid: Unique internal program SIID (1-14). You can get all existing internal program IDs with the command GET /internalprograms (required)
        :type internalprogram_siid: str
        ...
        _param = self._get_internalprogram_siid_serialize(
            internalprogram_siid=internalprogram_siid,
    ...
    @validate_call
    def get_internalprogram_siid_with_http_info(
        self,
        internalprogram_siid: Annotated[StrictStr, Field(description="Unique internal program SIID (1-14). You can get all existing internal program IDs with the command GET /internalprograms")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_internalprogram_siid_without_preload_content(
        self,
        internalprogram_siid: Annotated[StrictStr, Field(description="Unique internal program SIID (1-14). You can get all existing internal program IDs with the command GET /internalprograms")],
        _request_timeout: Union[
            None,
    ...
    def _get_internalprogram_siid_serialize(
        self,
        internalprogram_siid,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if internalprogram_siid is not None:
            _path_params['internalprogram_SIID'] = internalprogram_siid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{internalprogram_SIID}',
    ...
    @validate_call
    def post_interprogram_siid(
        self,
        internalprogram_siid: Annotated[StrictStr, Field(description="Unique internal program ID (1-14). You can get all existing internal program IDs with the command GET /internalprograms")],
        post_interprogram_siid_request: PostInterprogramSIIDRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param internalprogram_siid: Unique internal program ID (1-14). You can get all existing internal program IDs with the command GET /internalprograms (required)
        :type internalprogram_siid: str
        :param post_interprogram_siid_request: (required)
        :type post_interprogram_siid_request: PostInterprogramSIIDRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_interprogram_siid_serialize(
            internalprogram_siid=internalprogram_siid,
            post_interprogram_siid_request=post_interprogram_siid_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_interprogram_siid_with_http_info(
        self,
        internalprogram_siid: Annotated[StrictStr, Field(description="Unique internal program ID (1-14). You can get all existing internal program IDs with the command GET /internalprograms")],
        post_interprogram_siid_request: PostInterprogramSIIDRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_interprogram_siid_without_preload_content(
        self,
        internalprogram_siid: Annotated[StrictStr, Field(description="Unique internal program ID (1-14). You can get all existing internal program IDs with the command GET /internalprograms")],
        post_interprogram_siid_request: PostInterprogramSIIDRequest,
        _request_timeout: Union[
    ...
    def _post_interprogram_siid_serialize(
        self,
        internalprogram_siid,
        post_interprogram_siid_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_interprogram_siid_request is not None:
            _body_params = post_interprogram_siid_request
