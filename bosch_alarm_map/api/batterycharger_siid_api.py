...
class BatterychargerSIIDApi:
    ...
    @validate_call
    def get_batterycharger_siid(
        self,
        batterycharger_siid: Annotated[StrictStr, Field(description="Unique battery charger SIID. You can get all existing battery chargers SIIDs with the command GET /batterychargers")],
        ...
        The resource type batterycharger_SIID lists the battery charger of the power supply. It  provides the same interface as the resource type device. It can be disabled and bypassed.  This resource type cannot be walktested. The resource structure will contain attributes of  device, disable and device. 

        :param batterycharger_siid: Unique battery charger SIID. You can get all existing battery chargers SIIDs with the command GET /batterychargers (required)
        :type batterycharger_siid: str
        ...
        _param = self._get_batterycharger_siid_serialize(
            batterycharger_siid=batterycharger_siid,
    ...
    @validate_call
    def get_batterycharger_siid_with_http_info(
        self,
        batterycharger_siid: Annotated[StrictStr, Field(description="Unique battery charger SIID. You can get all existing battery chargers SIIDs with the command GET /batterychargers")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_batterycharger_siid_without_preload_content(
        self,
        batterycharger_siid: Annotated[StrictStr, Field(description="Unique battery charger SIID. You can get all existing battery chargers SIIDs with the command GET /batterychargers")],
        _request_timeout: Union[
            None,
    ...
    def _get_batterycharger_siid_serialize(
        self,
        batterycharger_siid,
        _request_auth,
        _content_type,
        ...
        if batterycharger_siid is not None:
            _path_params['batterycharger_SIID'] = batterycharger_siid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{batterycharger_SIID}',
    ...
    def post_batterycharger_siid(
        ...
        """Enable/Disable a batterycharger
        ...
        _param = self._post_batterycharger_siid_serialize(
            batterycharger_siid=batterycharger_siid,
    ...
    @validate_call
    def post_batterycharger_siid_with_http_info(
        self,
        batterycharger_siid: Annotated[StrictStr, Field(description="Unique battery charger SIID. You can get all existing battery chargers SIIDs with the command GET /batterychargers")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_batterycharger_siid_without_preload_content(
        self,
        batterycharger_siid: Annotated[StrictStr, Field(description="Unique battery charger SIID. You can get all existing battery chargers SIIDs with the command GET /batterychargers")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    def _post_batterycharger_siid_serialize(
        self,
        batterycharger_siid,
