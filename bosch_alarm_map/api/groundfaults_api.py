...
class GroundfaultsApi:
    ...
    def get_groundfaults(
        ...
        _param = self._get_groundfaults_serialize(
    ...
    @validate_call
    def get_groundfaults_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_groundfaults_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_groundfaults_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def post_groundfaults(
        ...
        _param = self._post_groundfaults_serialize(
    ...
    @validate_call
    def post_groundfaults_with_http_info(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_groundfaults_without_preload_content(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_groundfaults_serialize(
        self,
