...
class SupportfileApi:
    ...
    def getsupportfile(
        ...
        _param = self._getsupportfile_serialize(
    ...
    @validate_call
    def getsupportfile_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def getsupportfile_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
