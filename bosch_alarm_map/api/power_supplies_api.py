...
class PowerSuppliesApi:
    ...
    def get_powersupplies(
        ...
        _param = self._get_powersupplies_serialize(
    ...
    @validate_call
    def get_powersupplies_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_powersupplies_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_powersupplies_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def post_powersupplies(
        ...
        _param = self._post_powersupplies_serialize(
    ...
    @validate_call
    def post_powersupplies_with_http_info(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_powersupplies_without_preload_content(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    def _post_powersupplies_serialize(
        self,
