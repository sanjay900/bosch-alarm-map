...
class LsnauxSIIDApi:
    ...
    def get_lsnaux_siid(
        self,
        lsnaux_siid: Annotated[StrictStr, Field(description="Unique lsnaux SIID. You can get all existing lsnauxs IDs with the command GET /lsnauxs")],
        ...
        The resource type lsnAux lists the LSN Aux power on the LSN Gateway. It extends device resource type. This resource type can be disabled. This resource type cannot be bypassed or walktested. The resource structure will contain attributes of disable. 

        :param lsnaux_siid: Unique lsnaux SIID. You can get all existing lsnauxs IDs with the command GET /lsnauxs (required)
        :type lsnaux_siid: str
        ...
        _param = self._get_lsnaux_siid_serialize(
            lsnaux_siid=lsnaux_siid,
    ...
    @validate_call
    def get_lsnaux_siid_with_http_info(
        self,
        lsnaux_siid: Annotated[StrictStr, Field(description="Unique lsnaux SIID. You can get all existing lsnauxs IDs with the command GET /lsnauxs")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_lsnaux_siid_without_preload_content(
        self,
        lsnaux_siid: Annotated[StrictStr, Field(description="Unique lsnaux SIID. You can get all existing lsnauxs IDs with the command GET /lsnauxs")],
        _request_timeout: Union[
            None,
    ...
    def _get_lsnaux_siid_serialize(
        self,
        lsnaux_siid,
        _request_auth,
        _content_type,
        ...
        if lsnaux_siid is not None:
            _path_params['lsnaux_SIID'] = lsnaux_siid
    ...
    @validate_call
    def post_lsnaus_siid(
        self,
        lsnaux_siid: StrictStr,
        ...
        _param = self._post_lsnaus_siid_serialize(
            lsnaux_siid=lsnaux_siid,
    ...
    @validate_call
    def post_lsnaus_siid_with_http_info(
        self,
        lsnaux_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    @validate_call
    def post_lsnaus_siid_without_preload_content(
        self,
        lsnaux_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    def _post_lsnaus_siid_serialize(
        self,
        lsnaux_siid,
