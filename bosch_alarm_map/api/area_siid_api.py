...
class AreaSIIDApi:
    ...
    def get_area_siid(
        self,
        area_siid: Annotated[StrictStr, Field(description="Unique area SIID. You can get all existing area SIIDs with the command GET /areas ")],
        ...
        The area resource represents an individual area that is configured with the MAP system. Clients that are not aware of the available areas can use the AreaList resource /areas , to inspect the areas that are configured with MAP system. In the current version of the specification each area is accessible at a location corresponding to its SIID. For example, an area with the SIID 1.1.Area.2.5 is accessible under /1.1.Area.2.5. The area resource itself provides information about the current area state including whether it can be armed or disarmed. Further, arming and disarming of an area is supported, as well as control over test modes and the chime mode. <br> 

        :param area_siid: Unique area SIID. You can get all existing area SIIDs with the command GET /areas  (required)
        :type area_siid: str
        ...
        _param = self._get_area_siid_serialize(
            area_siid=area_siid,
    ...
    @validate_call
    def get_area_siid_with_http_info(
        self,
        area_siid: Annotated[StrictStr, Field(description="Unique area SIID. You can get all existing area SIIDs with the command GET /areas ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_area_siid_without_preload_content(
        self,
        area_siid: Annotated[StrictStr, Field(description="Unique area SIID. You can get all existing area SIIDs with the command GET /areas ")],
        _request_timeout: Union[
            None,
    ...
    def _get_area_siid_serialize(
        ...
        if area_siid is not None:
            _path_params['area_SIID'] = area_siid
    ...
    def post_area_siid(
        self,
        area_siid: Annotated[StrictStr, Field(description="Unique area SIID.")],
        post_area_siid_request: PostAreaSIIDRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        The area resource represents an individual area that is configured with the MAP system. Clients that are not aware of the available areas can use the AreaList resource /areas, to inspect the areas that are configured with MAP panel. In the current version of the specification each area is accessible at a location corresponding to its SIID. For example, an area with the SIID 1.1.Area.2.5 is accessible under /1.1.Area.2.5. The area resource itself provides information about the current area state including whether it can be armed or disarmed. Further, arming and disarming of an area is supported, as well as control over test modes and the chime mode. For the following area functions an example with explanation is attached: <br>  - Arm area - Disarm area - Start Walktest - Stop Walktest - start motion detector test - Stop Motion Detector Test - Start Chime Mode - Stop Chime Mode - Start Bell Test - ArmingInfo 

        :param area_siid: Unique area SIID. (required)
        :type area_siid: str
        :param post_area_siid_request: (required)
        :type post_area_siid_request: PostAreaSIIDRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_area_siid_serialize(
            area_siid=area_siid,
            post_area_siid_request=post_area_siid_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_area_siid_with_http_info(
        self,
        area_siid: Annotated[StrictStr, Field(description="Unique area SIID.")],
        post_area_siid_request: PostAreaSIIDRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_area_siid_without_preload_content(
        self,
        area_siid: Annotated[StrictStr, Field(description="Unique area SIID.")],
        post_area_siid_request: PostAreaSIIDRequest,
        _request_timeout: Union[
    ...
    def _post_area_siid_serialize(
        self,
        area_siid,
        post_area_siid_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_area_siid_request is not None:
            _body_params = post_area_siid_request
