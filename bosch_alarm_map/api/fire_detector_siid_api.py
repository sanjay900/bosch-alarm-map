...
class FireDetectorSIIDApi:
    ...
    @validate_call
    def firedetector_siid(
        self,
        fire_detector_siid: StrictStr,
        ...
        Fire detector is an extension to the point type and is used to model fire detectors in the MAP system. It adds details on the triggered sensor in the scope of a walktest. This resource type can be disabled. Similar as a point, a fire detector may be configured to be walktestable or bypassable. Thus, the walktest and bypass interface may be supported by an individual resource depending on the panel configuration. The resource structure will contain attributes of device, disable and point in addition to the attributes mentioned below. If configured to be bypassed and walktested, it will also contain attributes of bypass and walktest respectively. 

        :param fire_detector_siid: (required)
        :type fire_detector_siid: str
        ...
        _param = self._firedetector_siid_serialize(
            fire_detector_siid=fire_detector_siid,
    ...
    @validate_call
    def firedetector_siid_with_http_info(
        self,
        fire_detector_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    @validate_call
    def firedetector_siid_without_preload_content(
        self,
        fire_detector_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    def _firedetector_siid_serialize(
        self,
        fire_detector_siid,
        ...
        if fire_detector_siid is not None:
            _path_params['fireDetector_SIID'] = fire_detector_siid
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{fireDetector_SIID}',
    ...
    def get_firedetector(
        ...
        _param = self._get_firedetector_serialize(
            fire_detector_siid=fire_detector_siid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_firedetector_with_http_info(
        self,
        fire_detector_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_firedetector_without_preload_content(
        self,
        fire_detector_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_firedetector_serialize(
        self,
        fire_detector_siid,
        _request_auth,
        _content_type,
