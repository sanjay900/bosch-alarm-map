...
class SpecialdaymodelApi:
    ...
    @validate_call
    def get_specialdaymodel(
        self,
        special_day_model_id: Annotated[StrictStr, Field(description="unique name of a Special day model")],
        ...
        :param special_day_model_id: unique name of a Special day model (required)
        :type special_day_model_id: str
        ...
        _param = self._get_specialdaymodel_serialize(
            special_day_model_id=special_day_model_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSpecialdaymodel200Response",
            '401': None,
            '403': None,
            '404': None,
            '500': None,
    ...
    @validate_call
    def get_specialdaymodel_with_http_info(
        self,
        special_day_model_id: Annotated[StrictStr, Field(description="unique name of a Special day model")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSpecialdaymodel200Response]:
        """Get a special day model from the MAP system
    ...
    @validate_call
    def get_specialdaymodel_without_preload_content(
        self,
        special_day_model_id: Annotated[StrictStr, Field(description="unique name of a Special day model")],
        _request_timeout: Union[
            None,
    ...
    def _get_specialdaymodel_serialize(
        self,
        special_day_model_id,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if special_day_model_id is not None:
            _path_params['SpecialDayModelID'] = special_day_model_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/specialdaymodel/{SpecialDayModelID}',
    ...
    @validate_call
    def post_specialdaymodel(
        self,
        post_specialdaymodel_request: PostSpecialdaymodelRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This function is used to create, modify or delete a specialday model on a MAP system from the REST-API interface. It has the same functionalities like the RPS for MAP. This URL is designed to be used from a system, that controls remotely the user and system parameters of several MAP systems. <br> To use the functions, every POST request needs a valid specialDayModelSyncID. The initial specialDayModelSyncID can be get from the commands GET /syncstatus or GET /specialdaymodellist. After a successful operation, you get a new valid specialDayModelSyncID back. It is recommended to use this ID, if you want to create, modify or delete several specialday models.<br> The specialday model is used to define customized specific holidays. <br> A specialday model is created as a one time event or as a cyclically occurring holiday. A specialday model can be used from an area and time model. Do not delete the specialday model if it has a dependency to an area and time model.  ### Create time model  To create a new specialday model on a MAP system, the client must ensure that the key value *specialDayModelID* is not already used on the system. Further a valid specialDayModelSyncID is required. The following examples show how to create a specialday models:   - createSpecialDayModelMonthlyRepeat   - createSpecialDayModelNoRepeat   - createSpecialDayModelEasterBased   - createSpecialDayModelRepeatUntil   - createSpecialDayModelCostum  ### Modify time model  To modify an existing specialday model on a MAP system, the client needs a valid specialDayModelSyncID. The example *modifyTimeModel* shows how to modify a time model.  ### Delete time model  To delete an existing specialday model on a MAP system, the client needs also a valid specialDayModelSyncID. The example *deleteTimeModel* shows how to delete a time model:. 

        :param post_specialdaymodel_request: (required)
        :type post_specialdaymodel_request: PostSpecialdaymodelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_specialdaymodel_serialize(
            post_specialdaymodel_request=post_specialdaymodel_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_specialdaymodel_with_http_info(
        self,
        post_specialdaymodel_request: PostSpecialdaymodelRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SpecialDayModelSyncID]:
        """Create modify or delete a special day Model on the MAP system
    ...
    @validate_call
    def post_specialdaymodel_without_preload_content(
        self,
        post_specialdaymodel_request: PostSpecialdaymodelRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_specialdaymodel_serialize(
        self,
        post_specialdaymodel_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_specialdaymodel_request is not None:
            _body_params = post_specialdaymodel_request
