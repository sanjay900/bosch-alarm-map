...
class OutputSIIDApi:
    ...
    def get_output_siid(
        self,
        output_siid: Annotated[StrictStr, Field(description="Unique output SIID. You can get all existing outputs IDs with the command GET /outputs")],
        ...
        :param output_siid: Unique output SIID. You can get all existing outputs IDs with the command GET /outputs (required)
        :type output_siid: str
        ...
        _param = self._get_output_siid_serialize(
            output_siid=output_siid,
    ...
    @validate_call
    def get_output_siid_with_http_info(
        self,
        output_siid: Annotated[StrictStr, Field(description="Unique output SIID. You can get all existing outputs IDs with the command GET /outputs")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_output_siid_without_preload_content(
        self,
        output_siid: Annotated[StrictStr, Field(description="Unique output SIID. You can get all existing outputs IDs with the command GET /outputs")],
        _request_timeout: Union[
            None,
    ...
    def _get_output_siid_serialize(
        self,
        output_siid,
        _request_auth,
        _content_type,
        ...
        if output_siid is not None:
            _path_params['output_SIID'] = output_siid
    ...
    @validate_call
    def post_output_siid(
        self,
        output_siid: StrictStr,
        post_outputs_request: PostOutputsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        The resource type output can be disabled. This resource type cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 

        :param output_siid: (required)
        :type output_siid: str
        :param post_outputs_request: (required)
        :type post_outputs_request: PostOutputsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_output_siid_serialize(
            output_siid=output_siid,
            post_outputs_request=post_outputs_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_output_siid_with_http_info(
        self,
        output_siid: StrictStr,
        post_outputs_request: PostOutputsRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_output_siid_without_preload_content(
        self,
        output_siid: StrictStr,
        post_outputs_request: PostOutputsRequest,
        _request_timeout: Union[
    ...
    def _post_output_siid_serialize(
        self,
        output_siid,
        ...
        # process the form parameters
        # process the body parameter
        if post_outputs_request is not None:
            _body_params = post_outputs_request
