...
class StatisticsApi:
    ...
    def getstatistics(
        ...
        MAP statistics are available for REST-API (OII) and Database (DB).  Get all statistic modules: - /statistics  It is possible to partially get statistics for a specific module: - /statistics/oii - /statistics/db 
        ...
        _param = self._getstatistics_serialize(
    ...
    @validate_call
    def getstatistics_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def getstatistics_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
