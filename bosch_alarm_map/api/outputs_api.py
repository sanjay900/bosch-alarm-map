...
class OutputsApi:
    ...
    def get_outputs(
        ...
        List of outputs configured with the system including digital outputs, sirens, etc.
        ...
        _param = self._get_outputs_serialize(
    ...
    @validate_call
    def get_outputs_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_outputs_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_outputs(
        ...
        List operation for all system outputs
        ...
        _param = self._post_outputs_serialize(
    ...
    @validate_call
    def post_outputs_with_http_info(
        self,
        post_outputs_request: PostOutputsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_outputs_without_preload_content(
        self,
        post_outputs_request: PostOutputsRequest,
        _request_timeout: Union[
            None,
