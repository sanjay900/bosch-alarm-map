...
class BlocklockSIIDApi:
    ...
    @validate_call
    def get_blocklock_siid(
        self,
        blocklock_siid: Annotated[StrictStr, Field(description="Unique blocklock SIID. You can get all existing blocklocks SIIDs with the command GET /blocklocks")],
        ...
        The type blocklocks is an additional resource type which provides the same interface as the armingDevice type and models the blocklock on MAP system. It can be disabled and bypassed. This resource type cannot be walktested. The resource structure will contain attributes of device, disable, bypassed and armingDevice. 

        :param blocklock_siid: Unique blocklock SIID. You can get all existing blocklocks SIIDs with the command GET /blocklocks (required)
        :type blocklock_siid: str
        ...
        _param = self._get_blocklock_siid_serialize(
            blocklock_siid=blocklock_siid,
    ...
    @validate_call
    def get_blocklock_siid_with_http_info(
        self,
        blocklock_siid: Annotated[StrictStr, Field(description="Unique blocklock SIID. You can get all existing blocklocks SIIDs with the command GET /blocklocks")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_blocklock_siid_without_preload_content(
        self,
        blocklock_siid: Annotated[StrictStr, Field(description="Unique blocklock SIID. You can get all existing blocklocks SIIDs with the command GET /blocklocks")],
        _request_timeout: Union[
            None,
    ...
    def _get_blocklock_siid_serialize(
        self,
        blocklock_siid,
        _request_auth,
        _content_type,
        ...
        if blocklock_siid is not None:
            _path_params['blocklock_SIID'] = blocklock_siid
    ...
    def post_blocklock_siid(
        ...
        The type blocklock_SIID is an additional resource type which provides the same interface as the armingDevice type and models the blocklock on MAP system. It can be disabled and bypassed. This resource type cannot be walktested. The resource structure will contain attributes of device, disable, bypassed and armingDevice. 
        ...
        _param = self._post_blocklock_siid_serialize(
            blocklock_siid=blocklock_siid,
    ...
    @validate_call
    def post_blocklock_siid_with_http_info(
        self,
        blocklock_siid: Annotated[StrictStr, Field(description="Unique blocklock SIID. You can get all existing blocklocks SIIDs with the command GET /blocklocks")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_blocklock_siid_without_preload_content(
        self,
        blocklock_siid: Annotated[StrictStr, Field(description="Unique blocklock SIID. You can get all existing blocklocks SIIDs with the command GET /blocklocks")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    def _post_blocklock_siid_serialize(
        self,
        blocklock_siid,
