...
class DeviceSIIDApi:
    ...
    def get_device_siid(
        self,
        device_siid: Annotated[StrictStr, Field(description="Unique device SIID. You can get all existing device SIIDs with the command GET /devices")],
        ...
        This resource exists basically for all devices (except for a few specific devices) that can be connected to the MAP system. It thus includes the commonly available properties and commands for devices in the MAP system. 

        :param device_siid: Unique device SIID. You can get all existing device SIIDs with the command GET /devices (required)
        :type device_siid: str
        ...
        _param = self._get_device_siid_serialize(
            device_siid=device_siid,
    ...
    @validate_call
    def get_device_siid_with_http_info(
        self,
        device_siid: Annotated[StrictStr, Field(description="Unique device SIID. You can get all existing device SIIDs with the command GET /devices")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_device_siid_without_preload_content(
        self,
        device_siid: Annotated[StrictStr, Field(description="Unique device SIID. You can get all existing device SIIDs with the command GET /devices")],
        _request_timeout: Union[
            None,
    ...
    def _get_device_siid_serialize(
        self,
        device_siid,
        _request_auth,
        _content_type,
        ...
        if device_siid is not None:
            _path_params['device_SIID'] = device_siid
    ...
    def postdevice_siid(
        self,
        device_siid: Annotated[StrictStr, Field(description="Unique Keypad SIID. You can get all existing device SIIDs with the command GET /device")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Most MAP system devices resource type (except for a few specific devices) offers two basic functions.  Firstly, the devices can be enabled & disabled. On the other hand, the devices can be bypassed. 

        :param device_siid: Unique Keypad SIID. You can get all existing device SIIDs with the command GET /device (required)
        :type device_siid: str
        :param post_batteries_request: (required)
        :type post_batteries_request: PostBatteriesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._postdevice_siid_serialize(
            device_siid=device_siid,
            post_batteries_request=post_batteries_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def postdevice_siid_with_http_info(
        self,
        device_siid: Annotated[StrictStr, Field(description="Unique Keypad SIID. You can get all existing device SIIDs with the command GET /device")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def postdevice_siid_without_preload_content(
        self,
        device_siid: Annotated[StrictStr, Field(description="Unique Keypad SIID. You can get all existing device SIIDs with the command GET /device")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    def _postdevice_siid_serialize(
        self,
        device_siid,
        post_batteries_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_batteries_request is not None:
            _body_params = post_batteries_request
