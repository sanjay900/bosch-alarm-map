...
class KeyswitchSIIDApi:
    ...
    @validate_call
    def getkeyswitch_siid(
        self,
        keyswitch_siid: Annotated[StrictStr, Field(description="Unique keyswitch SIID. You can get all existing keyswitchs IDs with the command GET /keyswitches")],
        ...
        The keyswitch resource type extends the device type with additional property of active. It can be disabled. Keyswitches are not bypassable. Walktest of keyswitches is currently not supported by MAP system. The resource structure will contain attributes of device and disable. 

        :param keyswitch_siid: Unique keyswitch SIID. You can get all existing keyswitchs IDs with the command GET /keyswitches (required)
        :type keyswitch_siid: str
        ...
        _param = self._getkeyswitch_siid_serialize(
            keyswitch_siid=keyswitch_siid,
    ...
    @validate_call
    def getkeyswitch_siid_with_http_info(
        self,
        keyswitch_siid: Annotated[StrictStr, Field(description="Unique keyswitch SIID. You can get all existing keyswitchs IDs with the command GET /keyswitches")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def getkeyswitch_siid_without_preload_content(
        self,
        keyswitch_siid: Annotated[StrictStr, Field(description="Unique keyswitch SIID. You can get all existing keyswitchs IDs with the command GET /keyswitches")],
        _request_timeout: Union[
            None,
    ...
    def _getkeyswitch_siid_serialize(
        self,
        keyswitch_siid,
        _request_auth,
        _content_type,
        ...
        if keyswitch_siid is not None:
            _path_params['keyswitch_SIID'] = keyswitch_siid
    ...
    @validate_call
    def post_keyswitch_siid(
        self,
        keyswitch_siid: Annotated[StrictStr, Field(description="Unique keyswitch SIID. You can get all existing keyswitchs IDs with the command GET /keyswitches")],
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        The keyswitch extends the basic device type with the additional property of active. A keyswitch can be disabled. Keyswitches are not bypassable and the walktest function of keyswitches is currently not supported 

        :param keyswitch_siid: Unique keyswitch SIID. You can get all existing keyswitchs IDs with the command GET /keyswitches (required)
        :type keyswitch_siid: str
        :param device_enable_disable: (required)
        :type device_enable_disable: DeviceEnableDisable
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_keyswitch_siid_serialize(
            keyswitch_siid=keyswitch_siid,
            device_enable_disable=device_enable_disable,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_keyswitch_siid_with_http_info(
        self,
        keyswitch_siid: Annotated[StrictStr, Field(description="Unique keyswitch SIID. You can get all existing keyswitchs IDs with the command GET /keyswitches")],
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    @validate_call
    def post_keyswitch_siid_without_preload_content(
        self,
        keyswitch_siid: Annotated[StrictStr, Field(description="Unique keyswitch SIID. You can get all existing keyswitchs IDs with the command GET /keyswitches")],
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    def _post_keyswitch_siid_serialize(
        self,
        keyswitch_siid,
        ...
        # process the form parameters
        # process the body parameter
        if device_enable_disable is not None:
            _body_params = device_enable_disable
