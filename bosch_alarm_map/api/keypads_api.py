...
class KeypadsApi:
    ...
    def get_keypads(
        ...
        _param = self._get_keypads_serialize(
    ...
    @validate_call
    def get_keypads_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_keypads_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_keypads(
        self,
        post_keypads_request: PostKeypadsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param post_keypads_request: (required)
        :type post_keypads_request: PostKeypadsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_keypads_serialize(
            post_keypads_request=post_keypads_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_keypads_with_http_info(
        self,
        post_keypads_request: PostKeypadsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_keypads_without_preload_content(
        self,
        post_keypads_request: PostKeypadsRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_keypads_serialize(
        self,
        post_keypads_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_keypads_request is not None:
            _body_params = post_keypads_request
