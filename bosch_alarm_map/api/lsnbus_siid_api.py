...
class LsnbusSIIDApi:
    ...
    def get_lsnbus_siid(
        self,
        lsnbus_siid: Annotated[StrictStr, Field(description="Unique lsnbus SIID. You can get all existing lsnbuses IDs with the command GET /lsnbuses")],
        ...
        The resource type lsnBus lists the LSN loop and LSN Stub on the LSN Gateway. It provides the same interface as the resource type device. The resource structure will contain attributes of device and disable. 

        :param lsnbus_siid: Unique lsnbus SIID. You can get all existing lsnbuses IDs with the command GET /lsnbuses (required)
        :type lsnbus_siid: str
        ...
        _param = self._get_lsnbus_siid_serialize(
            lsnbus_siid=lsnbus_siid,
    ...
    @validate_call
    def get_lsnbus_siid_with_http_info(
        self,
        lsnbus_siid: Annotated[StrictStr, Field(description="Unique lsnbus SIID. You can get all existing lsnbuses IDs with the command GET /lsnbuses")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_lsnbus_siid_without_preload_content(
        self,
        lsnbus_siid: Annotated[StrictStr, Field(description="Unique lsnbus SIID. You can get all existing lsnbuses IDs with the command GET /lsnbuses")],
        _request_timeout: Union[
            None,
    ...
    def _get_lsnbus_siid_serialize(
        self,
        lsnbus_siid,
        _request_auth,
        _content_type,
        ...
        if lsnbus_siid is not None:
            _path_params['lsnbus_SIID'] = lsnbus_siid
    ...
    @validate_call
    def post_lsnbus_siid(
        self,
        lsnbus_siid: StrictStr,
        ...
        The resource type lsnBus lists the LSN loop and LSN Stub on the LSN Gateway. It provides the same interface as the resource type device. This resource type can be disabled. This resource type cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 

        :param lsnbus_siid: (required)
        :type lsnbus_siid: str
        ...
        _param = self._post_lsnbus_siid_serialize(
            lsnbus_siid=lsnbus_siid,
    ...
    @validate_call
    def post_lsnbus_siid_with_http_info(
        self,
        lsnbus_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    @validate_call
    def post_lsnbus_siid_without_preload_content(
        self,
        lsnbus_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    def _post_lsnbus_siid_serialize(
        self,
        lsnbus_siid,
