...
class DeviceEnableDisable(BaseModel):
    """
    DeviceEnableDisable
    """ # noqa: E501
    cmd: Optional[StrictStr] = Field(default=None, description="This operation initiates enabling/disabling the device", alias="@cmd")
