...
from bosch_alarm_map.configuration import Configuration
from bosch_alarm_map.api_response import ApiResponse, T as ApiResponseT
import bosch_alarm_map.models
from bosch_alarm_map import rest
from bosch_alarm_map.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bosch_alarm_map.models, klass)
