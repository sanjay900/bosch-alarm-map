# openapi_client.GroundfaultsApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_groundfaults**](GroundfaultsApi.md#get_groundfaults) | **GET** /groundfaults | List of resources representing the ground faults of a power supply in the MAP system
[**post_groundfaults**](GroundfaultsApi.md#post_groundfaults) | **POST** /groundfaults | Enable/Disable all groundfaults


# **get_groundfaults**
> GroundfaultList get_groundfaults()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.GroundfaultsApi(api_client)

    try:
        # List of resources representing the ground faults of a power supply in the MAP system
        api_response = api_instance.get_groundfaults()
        print("The response of GroundfaultsApi->get_groundfaults:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GroundfaultsApi->get_groundfaults: %s\n" % e)
```
...
[**GroundfaultList**](GroundfaultList.md)
...
# **post_groundfaults**
> post_groundfaults(post_batteries_request)

Enable/Disable all groundfaults
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable/Disable all groundfaults
        api_instance.post_groundfaults(post_batteries_request)
    except Exception as e:
        print("Exception when calling GroundfaultsApi->post_groundfaults: %s\n" % e)
```
