...
post_specialdaymodel_request_instance = PostSpecialdaymodelRequest.from_json(json)
# print the JSON string representation of the object
print(PostSpecialdaymodelRequest.to_json())

# convert the object into a dict
post_specialdaymodel_request_dict = post_specialdaymodel_request_instance.to_dict()
# create an instance of PostSpecialdaymodelRequest from a dict
post_specialdaymodel_request_from_dict = PostSpecialdaymodelRequest.from_dict(post_specialdaymodel_request_dict)
```
