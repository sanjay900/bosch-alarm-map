# bosch-alarm-map.CouplersApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_couplers**](CouplersApi.md#get_couplers) | **GET** /couplers | List of couplers in the MAP system
[**post_couplers**](CouplersApi.md#post_couplers) | **POST** /couplers | Enable/Disable all couplers


# **get_couplers**
> CouplerList get_couplers()

List of couplers in the MAP system

The type couplers lists the couplers and provides the same interface as device type.
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch-alarm-map.CouplersApi(api_client)

    try:
        # List of couplers in the MAP system
        api_response = api_instance.get_couplers()
        print("The response of CouplersApi->get_couplers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CouplersApi->get_couplers: %s\n" % e)
```
...
# **post_couplers**
> post_couplers(device_enable_disable)
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable/Disable all couplers
        api_instance.post_couplers(device_enable_disable)
    except Exception as e:
        print("Exception when calling CouplersApi->post_couplers: %s\n" % e)
```
