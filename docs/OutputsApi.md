...
------------- | ------------- | -------------
[**get_outputs**](OutputsApi.md#get_outputs) | **GET** /outputs | List of all outputs
[**post_outputs**](OutputsApi.md#post_outputs) | **POST** /outputs | Enable/Disable all outputs
...
with bosch_alarm_map.ApiClient(configuration) as api_client:
    ...
    try:
        # List of all outputs
        api_response = api_instance.get_outputs()
        print("The response of OutputsApi->get_outputs:\n")
        pprint(api_response)
...
# **post_outputs**
> post_outputs(post_outputs_request)
...
with bosch_alarm_map.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable/Disable all outputs
        api_instance.post_outputs(post_outputs_request)
    except Exception as e:
        print("Exception when calling OutputsApi->post_outputs: %s\n" % e)
```
