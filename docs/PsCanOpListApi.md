# bosch-alarm-map.PsCanOpListApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_ps_can_op_list**](PsCanOpListApi.md#get_ps_can_op_list) | **GET** /psCanOpList | List of power supply CAN outputs


# **get_ps_can_op_list**
> PsCanOpList get_ps_can_op_list()

List of power supply CAN outputs

List of resources representing the power supply CAN outputs in the system
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch-alarm-map.PsCanOpListApi(api_client)

    try:
        # List of power supply CAN outputs
        api_response = api_instance.get_ps_can_op_list()
        print("The response of PsCanOpListApi->get_ps_can_op_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PsCanOpListApi->get_ps_can_op_list: %s\n" % e)
```
