# bosch_alarm_map.BatterychargersApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_batterychargers**](BatterychargersApi.md#get_batterychargers) | **GET** /batterychargers | List of battery chargers in the MAP system
[**post_batterychargers**](BatterychargersApi.md#post_batterychargers) | **POST** /batterychargers | Enable/Disable all battery chargers


# **get_batterychargers**
> BatterychargerList get_batterychargers()

List of battery chargers in the MAP system

The resource type batterychargers lists the battery charger of the power supply. It
...
with bosch_alarm_map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch_alarm_map.BatterychargersApi(api_client)

    try:
        # List of battery chargers in the MAP system
        api_response = api_instance.get_batterychargers()
        print("The response of BatterychargersApi->get_batterychargers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BatterychargersApi->get_batterychargers: %s\n" % e)
```
...
[**BatterychargerList**](BatterychargerList.md)
...
# **post_batterychargers**
> post_batterychargers(post_batteries_request)

Enable/Disable all battery chargers
...
with bosch_alarm_map.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable/Disable all battery chargers
        api_instance.post_batterychargers(post_batteries_request)
    except Exception as e:
        print("Exception when calling BatterychargersApi->post_batterychargers: %s\n" % e)
```
