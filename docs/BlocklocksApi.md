# bosch-alarm-map.BlocklocksApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_blocklocks**](BlocklocksApi.md#get_blocklocks) | **GET** /blocklocks | List of blocklocks
[**post_blocklocks**](BlocklocksApi.md#post_blocklocks) | **POST** /blocklocks | Enable/Disable all blocklocks


# **get_blocklocks**
> BlocklockList get_blocklocks()
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch-alarm-map.BlocklocksApi(api_client)

    try:
        # List of blocklocks
        api_response = api_instance.get_blocklocks()
        print("The response of BlocklocksApi->get_blocklocks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BlocklocksApi->get_blocklocks: %s\n" % e)
```
...
[**BlocklockList**](BlocklockList.md)
...
# **post_blocklocks**
> post_blocklocks(post_batteries_request)
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable/Disable all blocklocks
        api_instance.post_blocklocks(post_batteries_request)
    except Exception as e:
        print("Exception when calling BlocklocksApi->post_blocklocks: %s\n" % e)
```
