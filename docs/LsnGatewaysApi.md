# openapi_client.LsnGatewaysApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getlsn_gateways**](LsnGatewaysApi.md#getlsn_gateways) | **GET** /lsnGateways | List of LSN gateways in the MAP system
[**postlsn_gateways**](LsnGatewaysApi.md#postlsn_gateways) | **POST** /lsnGateways | Enable/Disable, Activate/Deactivate all lsnGateways


# **getlsn_gateways**
> LsnGatewayList getlsn_gateways()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LsnGatewaysApi(api_client)

    try:
        # List of LSN gateways in the MAP system
        api_response = api_instance.getlsn_gateways()
        print("The response of LsnGatewaysApi->getlsn_gateways:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LsnGatewaysApi->getlsn_gateways: %s\n" % e)
```
...
[**LsnGatewayList**](LsnGatewayList.md)
...
# **postlsn_gateways**
> postlsn_gateways(device_enable_disable)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable/Disable, Activate/Deactivate all lsnGateways
        api_instance.postlsn_gateways(device_enable_disable)
    except Exception as e:
        print("Exception when calling LsnGatewaysApi->postlsn_gateways: %s\n" % e)
```
