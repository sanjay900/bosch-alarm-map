...
json = "{}"
# create an instance of LSNStdIntr51Configuration from a JSON string
lsn_std_intr51_configuration_instance = LSNStdIntr51Configuration.from_json(json)
# print the JSON string representation of the object
print(LSNStdIntr51Configuration.to_json())

# convert the object into a dict
lsn_std_intr51_configuration_dict = lsn_std_intr51_configuration_instance.to_dict()
# create an instance of LSNStdIntr51Configuration from a dict
lsn_std_intr51_configuration_from_dict = LSNStdIntr51Configuration.from_dict(lsn_std_intr51_configuration_dict)
```
