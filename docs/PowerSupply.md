...
power_supply_instance = PowerSupply.from_json(json)
# print the JSON string representation of the object
print(PowerSupply.to_json())

# convert the object into a dict
power_supply_dict = power_supply_instance.to_dict()
# create an instance of PowerSupply from a dict
power_supply_from_dict = PowerSupply.from_dict(power_supply_dict)
```
