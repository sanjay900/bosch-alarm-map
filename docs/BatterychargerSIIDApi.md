# bosch_alarm_map.BatterychargerSIIDApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_batterycharger_siid**](BatterychargerSIIDApi.md#get_batterycharger_siid) | **GET** /{batterycharger_SIID} | Individual battery charger
[**post_batterycharger_siid**](BatterychargerSIIDApi.md#post_batterycharger_siid) | **POST** /{batterycharger_SIID} | Enable/Disable a batterycharger


# **get_batterycharger_siid**
> Batterycharger get_batterycharger_siid(batterycharger_siid)

Individual battery charger

The resource type batterycharger_SIID lists the battery charger of the power supply. It
 provides the same interface as the resource type device. It can be disabled and bypassed.
 This resource type cannot be walktested. The resource structure will contain attributes of
 device, disable and device.
...
with bosch_alarm_map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch_alarm_map.BatterychargerSIIDApi(api_client)
    ...
    try:
        # Individual battery charger
        api_response = api_instance.get_batterycharger_siid(batterycharger_siid)
        print("The response of BatterychargerSIIDApi->get_batterycharger_siid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BatterychargerSIIDApi->get_batterycharger_siid: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **batterycharger_siid** | **str**| Unique battery charger SIID. You can get all existing battery chargers SIIDs with the command GET /batterychargers | 

### Return type

[**Batterycharger**](Batterycharger.md)
...
# **post_batterycharger_siid**
> post_batterycharger_siid(batterycharger_siid, post_batteries_request)
...
with bosch_alarm_map.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable/Disable a batterycharger
        api_instance.post_batterycharger_siid(batterycharger_siid, post_batteries_request)
    except Exception as e:
        print("Exception when calling BatterychargerSIIDApi->post_batterycharger_siid: %s\n" % e)
```
