# bosch-alarm-map.GroundfaultSIIDApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_groundfault_siid**](GroundfaultSIIDApi.md#get_groundfault_siid) | **GET** /{groundfault_SIID} | Individual ground fault resource
[**post_groundfault_siid**](GroundfaultSIIDApi.md#post_groundfault_siid) | **POST** /{groundfault_SIID} | Enable/Disable a groundfault


# **get_groundfault_siid**
> Groundfault get_groundfault_siid(groundfault_siid)

Individual ground fault resource

The resource type groundFault lists the ground fault input of the power supply. It provides
the same interface as the resource type device. It can be disabled and bypassed. This resource type cannot
be walktested. The resource structure contains attributes of device, disable and bypass.
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch-alarm-map.GroundfaultSIIDApi(api_client)
    groundfault_siid = '/1.1.PowerSupply.13001.10' # str | Unique groundfault SIID. You can get all existing groundfaults SIIDs with the command GET /groundfaults

    try:
        # Individual ground fault resource
        api_response = api_instance.get_groundfault_siid(groundfault_siid)
        print("The response of GroundfaultSIIDApi->get_groundfault_siid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GroundfaultSIIDApi->get_groundfault_siid: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **groundfault_siid** | **str**| Unique groundfault SIID. You can get all existing groundfaults SIIDs with the command GET /groundfaults | 

### Return type

[**Groundfault**](Groundfault.md)
...
# **post_groundfault_siid**
> post_groundfault_siid(groundfault_siid, post_batteries_request)
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable/Disable a groundfault
        api_instance.post_groundfault_siid(groundfault_siid, post_batteries_request)
    except Exception as e:
        print("Exception when calling GroundfaultSIIDApi->post_groundfault_siid: %s\n" % e)
```
