# bosch-alarm-map.KeyswitchesApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_keyswitches**](KeyswitchesApi.md#get_keyswitches) | **GET** /keyswitches | List of keyswitches in the MAP system


# **get_keyswitches**
> Keyswitchlist get_keyswitches()
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch-alarm-map.KeyswitchesApi(api_client)

    try:
        # List of keyswitches in the MAP system
        api_response = api_instance.get_keyswitches()
        print("The response of KeyswitchesApi->get_keyswitches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyswitchesApi->get_keyswitches: %s\n" % e)
```
...
[**Keyswitchlist**](Keyswitchlist.md)
