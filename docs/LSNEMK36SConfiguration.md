...
lsnemk36_s_configuration_instance = LSNEMK36SConfiguration.from_json(json)
# print the JSON string representation of the object
print(LSNEMK36SConfiguration.to_json())

# convert the object into a dict
lsnemk36_s_configuration_dict = lsnemk36_s_configuration_instance.to_dict()
# create an instance of LSNEMK36SConfiguration from a dict
lsnemk36_s_configuration_from_dict = LSNEMK36SConfiguration.from_dict(lsnemk36_s_configuration_dict)
```
