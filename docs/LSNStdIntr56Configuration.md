...
json = "{}"
# create an instance of LSNStdIntr56Configuration from a JSON string
lsn_std_intr56_configuration_instance = LSNStdIntr56Configuration.from_json(json)
# print the JSON string representation of the object
print(LSNStdIntr56Configuration.to_json())

# convert the object into a dict
lsn_std_intr56_configuration_dict = lsn_std_intr56_configuration_instance.to_dict()
# create an instance of LSNStdIntr56Configuration from a dict
lsn_std_intr56_configuration_from_dict = LSNStdIntr56Configuration.from_dict(lsn_std_intr56_configuration_dict)
```
