...
user_model_post_instance = UserModelPost.from_json(json)
# print the JSON string representation of the object
print(UserModelPost.to_json())

# convert the object into a dict
user_model_post_dict = user_model_post_instance.to_dict()
# create an instance of UserModelPost from a dict
user_model_post_from_dict = UserModelPost.from_dict(user_model_post_dict)
```
