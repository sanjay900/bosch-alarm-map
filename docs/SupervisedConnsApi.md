# bosch_alarm_map.SupervisedConnsApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_supervised_conns**](SupervisedConnsApi.md#get_supervised_conns) | **GET** /supervisedConns | List of Connections to other systems.


# **get_supervised_conns**
> SupervisedConnsList get_supervised_conns()

List of Connections to other systems.

Get a list of all connections to other systems like BIS, IPC or REST-API
...
with bosch_alarm_map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch_alarm_map.SupervisedConnsApi(api_client)

    try:
        # List of Connections to other systems.
        api_response = api_instance.get_supervised_conns()
        print("The response of SupervisedConnsApi->get_supervised_conns:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SupervisedConnsApi->get_supervised_conns: %s\n" % e)
```
...
[**SupervisedConnsList**](SupervisedConnsList.md)
