# bosch-alarm-map.PowerDevicesApi

All URIs are relative to *https://169.254.10.10*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_power_devices**](PowerDevicesApi.md#get_power_devices) | **GET** /powerDevices | List of all non BDB power supplies


# **get_power_devices**
> get_power_devices()

List of all non BDB power supplies

List of non BDB(Bosch Data Bus) power supplies in the system like NEV300.
The NEV 300 is an additional power supply, that is installed in a LSN ring. The power supply is a separate LSN element and it
is parameterized from the MAP panel.
...
with bosch-alarm-map.ApiClient(configuration) as api_client:
    ...
    api_instance = bosch-alarm-map.PowerDevicesApi(api_client)

    try:
        # List of all non BDB power supplies
        api_instance.get_power_devices()
    except Exception as e:
        print("Exception when calling PowerDevicesApi->get_power_devices: %s\n" % e)
```
