...
class WalktestSIIDApi:
    ...
    @validate_call
    def delete_walktest_siid(
        self,
        walktest_siid: Annotated[StrictStr, Field(description="Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests ")],
        ...
        :param walktest_siid: Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests  (required)
        :type walktest_siid: str
        ...
        _param = self._delete_walktest_siid_serialize(
            walktest_siid=walktest_siid,
    ...
    @validate_call
    def delete_walktest_siid_with_http_info(
        self,
        walktest_siid: Annotated[StrictStr, Field(description="Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_walktest_siid_without_preload_content(
        self,
        walktest_siid: Annotated[StrictStr, Field(description="Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests ")],
        _request_timeout: Union[
            None,
    ...
    def _delete_walktest_siid_serialize(
        self,
        walktest_siid,
        _request_auth,
        _content_type,
        ...
        if walktest_siid is not None:
            _path_params['walktest_SIID'] = walktest_siid
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/walktest/{walktest_SIID}',
    ...
    def get_walktest_siid(
        ...
        The walktest resource represents a walktest that contains one or multiple areas. A walktest resource is created during runtime when a client or a user starts a walktest. The walktest contains information which areas should participate in the walktest and if the walktest has already stared in that area. Additionally, it allows stopping the walktest. Walktests are started via the area or area list resource. Each walktest is referenced by a walktest list. 
        ...
        _param = self._get_walktest_siid_serialize(
            walktest_siid=walktest_siid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_walktest_siid_with_http_info(
        self,
        walktest_siid: Annotated[StrictStr, Field(description="Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_walktest_siid_without_preload_content(
        self,
        walktest_siid: Annotated[StrictStr, Field(description="Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests ")],
        _request_timeout: Union[
            None,
    ...
    def _get_walktest_siid_serialize(
        self,
        walktest_siid,
        _request_auth,
        _content_type,
    ...
    def post_walktest_siid(
        ...
        :param walktest_siid: Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests  (required)
        :type walktest_siid: str
        :param diagnose: (required)
        :type diagnose: Diagnose
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_walktest_siid_serialize(
            walktest_siid=walktest_siid,
            diagnose=diagnose,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def post_walktest_siid_with_http_info(
        self,
        walktest_siid: Annotated[StrictStr, Field(description="Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests ")],
        diagnose: Diagnose,
        _request_timeout: Union[
    ...
    @validate_call
    def post_walktest_siid_without_preload_content(
        self,
        walktest_siid: Annotated[StrictStr, Field(description="Unique walktest SIID. You can get all existing walktest SIIDs with the command GET /walktests ")],
        diagnose: Diagnose,
        _request_timeout: Union[
    ...
    def _post_walktest_siid_serialize(
        self,
        walktest_siid,
        diagnose,
        _request_auth,
