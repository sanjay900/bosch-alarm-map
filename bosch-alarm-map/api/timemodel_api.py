...
class TimemodelApi:
    ...
    def get_timemodel(
        self,
        time_model_id: Annotated[StrictStr, Field(description="Unique name of a time model")],
        ...
        :param time_model_id: Unique name of a time model (required)
        :type time_model_id: str
        ...
        _param = self._get_timemodel_serialize(
    ...
    @validate_call
    def get_timemodel_with_http_info(
        self,
        time_model_id: Annotated[StrictStr, Field(description="Unique name of a time model")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTimemodel200Response]:
        """Get a specific timemodel item from the MAP system.
    ...
    @validate_call
    def get_timemodel_without_preload_content(
        self,
        time_model_id: Annotated[StrictStr, Field(description="Unique name of a time model")],
        _request_timeout: Union[
            None,
    ...
    def _get_timemodel_serialize(
        ...
        if time_model_id is not None:
            _path_params['timeModelID'] = time_model_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/timemodel/{timeModelID}',
    ...
    def post_timemodel(
        self,
        post_timemodel_request: PostTimemodelRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This function is used to create, modify or delete a time model on a MAP system from the REST-API interface. It has the same functionalities like the RPS for MAP. This URL is designed to be used from a MAP system, that controls remotely the user and system parameters of several MAP systems. <br> To use the functions, every POST request needs a valid timeModelSyncID. The initial timeModelSyncID can be get from the commands GET /syncstatus or GET timemodellist. After a successful operation, you get a new valid dayModelSyncID back. It is recommended to use this ID, if you want to create, modify or delete several day models.<br> A time model can be used from an area and time model or a Smartkey model. Do not delete the time model, if it has a dependency to an area and time model or a Smartkey model.  ### Create time model  To create a new time model on a MAP system, the client must ensure that the key value *timeModelID* is not already used on the system. Further a valid timeModelSyncID is required. The example *createTimeModel* shows how to create a time model:  ### Modify time model  To modify an existing day model on a MAP system, the client needs a valid dayModelSyncID. The example *modifyTimeModel* shows how to modify a time model:  ### Delete time model  To delete an existing day model on a MAP system, the client needs also a valid dayModelSyncID. The example  *deleteTimeModel* shows how to delete a time model: 

        :param post_timemodel_request: (required)
        :type post_timemodel_request: PostTimemodelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_timemodel_serialize(
            post_timemodel_request=post_timemodel_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_timemodel_with_http_info(
        self,
        post_timemodel_request: PostTimemodelRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_timemodel_without_preload_content(
        self,
        post_timemodel_request: PostTimemodelRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_timemodel_serialize(
        self,
        post_timemodel_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_timemodel_request is not None:
            _body_params = post_timemodel_request
