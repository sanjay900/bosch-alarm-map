...
class PointSIIDApi:
    ...
    def get_point_siid(
        self,
        point_siid: Annotated[StrictStr, Field(description="Unique point SIID. You can get all existing points IDs with the command GET /points")],
        ...
        :param point_siid: Unique point SIID. You can get all existing points IDs with the command GET /points (required)
        :type point_siid: str
        ...
        _param = self._get_point_siid_serialize(
            point_siid=point_siid,
    ...
    @validate_call
    def get_point_siid_with_http_info(
        self,
        point_siid: Annotated[StrictStr, Field(description="Unique point SIID. You can get all existing points IDs with the command GET /points")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_point_siid_without_preload_content(
        self,
        point_siid: Annotated[StrictStr, Field(description="Unique point SIID. You can get all existing points IDs with the command GET /points")],
        _request_timeout: Union[
            None,
    ...
    def _get_point_siid_serialize(
        ...
        if point_siid is not None:
            _path_params['point_SIID'] = point_siid
    ...
    def post_point_siid(
        ...
        _param = self._post_point_siid_serialize(
            point_siid=point_siid,
    ...
    @validate_call
    def post_point_siid_with_http_info(
        self,
        point_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    @validate_call
    def post_point_siid_without_preload_content(
        self,
        point_siid: StrictStr,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
    ...
    def _post_point_siid_serialize(
        self,
        point_siid,
