...
class BlocklocksApi:
    ...
    def get_blocklocks(
        ...
        _param = self._get_blocklocks_serialize(
    ...
    @validate_call
    def get_blocklocks_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_blocklocks_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_blocklocks(
        ...
        _param = self._post_blocklocks_serialize(
    ...
    @validate_call
    def post_blocklocks_with_http_info(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_blocklocks_without_preload_content(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_blocklocks_serialize(
        self,
