...
class KeyswitchesApi:
    ...
    def get_keyswitches(
        ...
        """List of keyswitches in the MAP system
        ...
        _param = self._get_keyswitches_serialize(
    ...
    @validate_call
    def get_keyswitches_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_keyswitches_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_keyswitches_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
