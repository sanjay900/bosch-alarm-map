...
class WalktestsApi:
    ...
    def delete_walktests(
        ...
        _param = self._delete_walktests_serialize(
    ...
    @validate_call
    def delete_walktests_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def delete_walktests_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _delete_walktests_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_walktests(
        ...
        _param = self._get_walktests_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_walktests_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_walktests_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
