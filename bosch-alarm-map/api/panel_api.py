...
class PanelApi:
    ...
    def get_panel(
        ...
        The MAP panel resource provides information on the current status of the MAP panel; for example: <br> - MAP panel is in failsafe - MAP panel is in installer mode - last configuration update date & time - last user database update date & time - time The resource will allow an authorized client to restart the panel. 
        ...
        _param = self._get_panel_serialize(
    ...
    @validate_call
    def get_panel_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_panel(
        ...
        The panel resource provides information on the current status of the panel, for example, panel being in failsafe, in installer mode, last configuration update date time and last database update date and time. The resource will allow an authorized client to restart the panel. 

        :param panel_post: (required)
        :type panel_post: PanelPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_panel_serialize(
    ...
    @validate_call
    def post_panel_without_preload_content(
        self,
        panel_post: PanelPost,
        _request_timeout: Union[
            None,
