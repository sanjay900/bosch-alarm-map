...
class CommunicatorSIIDApi:
    ...
    @validate_call
    def getcommunicator_siid(
        self,
        communicator_siid: Annotated[StrictStr, Field(description="Unique communicator SIID.")],
        ...
        """Get information from a unique Communicator

        The type communicator lists the communicator (AT2000, AT3000 or AT4000) and provides the same interface as device type. It can be disabled. It cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 

        :param communicator_siid: Unique communicator SIID. (required)
        :type communicator_siid: str
        ...
        _param = self._getcommunicator_siid_serialize(
            communicator_siid=communicator_siid,
    ...
    @validate_call
    def getcommunicator_siid_with_http_info(
        self,
        communicator_siid: Annotated[StrictStr, Field(description="Unique communicator SIID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def getcommunicator_siid_without_preload_content(
        self,
        communicator_siid: Annotated[StrictStr, Field(description="Unique communicator SIID.")],
        _request_timeout: Union[
            None,
    ...
    def _getcommunicator_siid_serialize(
        self,
        communicator_siid,
        _request_auth,
        _content_type,
        ...
        if communicator_siid is not None:
            _path_params['communicator_SIID'] = communicator_siid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{communicator_SIID}',
