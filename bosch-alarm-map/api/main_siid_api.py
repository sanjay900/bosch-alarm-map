...
class MainSIIDApi:
    ...
    def get_main_siid(
        self,
        main_siid: Annotated[StrictStr, Field(description="Unique main SIID. You can get all existing mains IDs with the command GET /mains")],
        ...
        The resource type mains lists the alternating current (short: ac ) input of the power supply. It provides the same interface as the resource type device. 

        :param main_siid: Unique main SIID. You can get all existing mains IDs with the command GET /mains (required)
        :type main_siid: str
        ...
        _param = self._get_main_siid_serialize(
            main_siid=main_siid,
    ...
    @validate_call
    def get_main_siid_with_http_info(
        self,
        main_siid: Annotated[StrictStr, Field(description="Unique main SIID. You can get all existing mains IDs with the command GET /mains")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_main_siid_without_preload_content(
        self,
        main_siid: Annotated[StrictStr, Field(description="Unique main SIID. You can get all existing mains IDs with the command GET /mains")],
        _request_timeout: Union[
            None,
    ...
    def _get_main_siid_serialize(
        ...
        if main_siid is not None:
            _path_params['main_SIID'] = main_siid
    ...
    def post_main_siid(
        ...
        _param = self._post_main_siid_serialize(
            main_siid=main_siid,
    ...
    @validate_call
    def post_main_siid_with_http_info(
        self,
        main_siid: StrictStr,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_main_siid_without_preload_content(
        self,
        main_siid: StrictStr,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
