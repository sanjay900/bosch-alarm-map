...
class SmartkeymodelApi:
    ...
    @validate_call
    def get_smartkeymodel(
        self,
        smartkey_model_id: Annotated[StrictStr, Field(description="Unique Smartkey model name")],
        ...
        :param smartkey_model_id: Unique Smartkey model name (required)
        :type smartkey_model_id: str
        ...
        _param = self._get_smartkeymodel_serialize(
            smartkey_model_id=smartkey_model_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSmartkeymodel200Response",
            '401': None,
            '403': None,
            '404': None,
            '500': None,
    ...
    @validate_call
    def get_smartkeymodel_with_http_info(
        self,
        smartkey_model_id: Annotated[StrictStr, Field(description="Unique Smartkey model name")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSmartkeymodel200Response]:
        """Get a specific Smartkey model from the MAP system
    ...
    @validate_call
    def get_smartkeymodel_without_preload_content(
        self,
        smartkey_model_id: Annotated[StrictStr, Field(description="Unique Smartkey model name")],
        _request_timeout: Union[
            None,
    ...
    def _get_smartkeymodel_serialize(
        self,
        smartkey_model_id,
        _request_auth,
        _content_type,
        ...
        if smartkey_model_id is not None:
            _path_params['SmartkeyModelID'] = smartkey_model_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/smartkeymodel/{SmartkeyModelID}',
    ...
    @validate_call
    def post_smartkeymodel(
        self,
        post_smartkeymodel_request: PostSmartkeymodelRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This function is used to create, modify or deletes Smartkey models on a MAP system from the REST-API interface. It has the same functionalities like the RPS for MAP. This URL is designed to be used from a system, that controls remotely the user and system parameters of several MAP system. <br> To use the functions, every POST request needs a valid smartkeyModelSyncID. The initial smartkeyModelSyncID can be get from the commands GET /syncstatus or GET /smartkeymodellist. After a successful operation, you get a new valid areaAndTimeModelSyncID back. It is recommended to use this ID, if you want to create, modify or delete several smartkey models.<br> A Smartkey model can be assigned to one or several users. Do not delete the used Smartkey model, if it has a dependency to a user.  ### Create smartkey model  To create a new Smartkey model on a MAP system, the client must ensure that the key value *smartkeyModelID* is not already used on the system. Further a valid smartkeyModelSyncID is required. The example *createSmartkeyModel* shows an example how to create a Smartkey model.  ### Modify smartkey smartkeyModelSyncID  To modify an existing Smartkey model on a MAP system, the client needs a valid *smartkeyModelSyncID*. The example *modifySmartkeyModel* shows an example how to modify a Smartkey model.  ### Delete smartkey model  To delete an existing Smartkey model on a MAP system, the client needs also a valid *smartkeyModelSyncID*. The example *deleteSmartkeyModel* shows an example how to delete a Smartkey model. 

        :param post_smartkeymodel_request: (required)
        :type post_smartkeymodel_request: PostSmartkeymodelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_smartkeymodel_serialize(
            post_smartkeymodel_request=post_smartkeymodel_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_smartkeymodel_with_http_info(
        self,
        post_smartkeymodel_request: PostSmartkeymodelRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SmartkeyModelSyncID]:
        """Create a new Smartkey model on the MAP System
    ...
    @validate_call
    def post_smartkeymodel_without_preload_content(
        self,
        post_smartkeymodel_request: PostSmartkeymodelRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_smartkeymodel_serialize(
        self,
        post_smartkeymodel_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_smartkeymodel_request is not None:
            _body_params = post_smartkeymodel_request
