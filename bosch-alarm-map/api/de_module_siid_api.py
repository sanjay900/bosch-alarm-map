...
class DEModuleSIIDApi:
    ...
    @validate_call
    def get_de_module_siid(
        self,
        de_module_siid: Annotated[StrictStr, Field(description="Unique DEModule SIID")],
        ...
        The resource type deModule extends the device resource type with an additional command of firmware version. It list the DE-Module. It can be disabled. The resource structure will contain the attributes of device and disable. It cannot be bypassed or walktested. 

        :param de_module_siid: Unique DEModule SIID (required)
        :type de_module_siid: str
        ...
        _param = self._get_de_module_siid_serialize(
            de_module_siid=de_module_siid,
    ...
    @validate_call
    def get_de_module_siid_with_http_info(
        self,
        de_module_siid: Annotated[StrictStr, Field(description="Unique DEModule SIID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_de_module_siid_without_preload_content(
        self,
        de_module_siid: Annotated[StrictStr, Field(description="Unique DEModule SIID")],
        _request_timeout: Union[
            None,
    ...
    def _get_de_module_siid_serialize(
        self,
        de_module_siid,
        _request_auth,
        _content_type,
        ...
        if de_module_siid is not None:
            _path_params['DEModule_SIID'] = de_module_siid
    ...
    @validate_call
    def post_de_module_siid(
        self,
        de_module_siid: StrictStr,
        ...
        _param = self._post_de_module_siid_serialize(
            de_module_siid=de_module_siid,
    ...
    @validate_call
    def post_de_module_siid_with_http_info(
        self,
        de_module_siid: StrictStr,
        postlsn_gateway_siid_request: PostlsnGatewaySIIDRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_de_module_siid_without_preload_content(
        self,
        de_module_siid: StrictStr,
        postlsn_gateway_siid_request: PostlsnGatewaySIIDRequest,
        _request_timeout: Union[
    ...
    def _post_de_module_siid_serialize(
        self,
        de_module_siid,
