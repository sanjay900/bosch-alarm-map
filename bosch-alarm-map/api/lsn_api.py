...
class LsnApi:
    ...
    def get_lsngw_config(
        ...
        _param = self._get_lsngw_config_serialize(
    ...
    @validate_call
    def get_lsngw_config_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_lsngw_config_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_lsngw_config_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def post_lsngw_config(
        self,
        post_lsngw_config_request: Optional[PostLSNGWConfigRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This function is used to create, modify or delete LSN GW configuraion.  Each device has a minimal number of required parameters. Other parameters, if not set, will be defaulted to the values from the RPS.  Reporting number parameter will not be respected unless the Panel has Event Reporing configured.  Any successful POST request will automatically reboot the Panel to apply the configuration. The Panel will reboot within 30 seconds after the request is processed. 

        :param post_lsngw_config_request:
        :type post_lsngw_config_request: PostLSNGWConfigRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_lsngw_config_serialize(
            post_lsngw_config_request=post_lsngw_config_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_lsngw_config_with_http_info(
        self,
        post_lsngw_config_request: Optional[PostLSNGWConfigRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_lsngw_config_without_preload_content(
        self,
        post_lsngw_config_request: Optional[PostLSNGWConfigRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_lsngw_config_serialize(
        self,
        post_lsngw_config_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_lsngw_config_request is not None:
            _body_params = post_lsngw_config_request
