...
class PowerDevicesApi:
    ...
    def get_power_devices(
        ...
        List of non BDB(Bosch Data Bus) power supplies in the system like NEV300. The NEV 300 is an additional power supply, that is installed in a LSN ring. The power supply is a separate LSN element and it is parameterized from the MAP panel. 
        ...
        _param = self._get_power_devices_serialize(
    ...
    @validate_call
    def get_power_devices_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_power_devices_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_power_devices_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
