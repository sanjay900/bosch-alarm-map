...
class DevicesApi:
    ...
    def getdevices(
        ...
        The /devices resource provides a list of all configured devices of the MAP system together with the individual resource types of all supported devices. This resource type is the basic resource type for all MAP system devices (except for a few specific devices). It thus includes the commonly available properties and commands for devices in the MAP system. To allow batch operations on devices of the same type, MAP panel supports list resources for each of the of the defined device types. 
        ...
        _param = self._getdevices_serialize(
    ...
    @validate_call
    def getdevices_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
