...
class InternalprogramsApi:
    ...
    def get_internalprograms(
        ...
        _param = self._get_internalprograms_serialize(
    ...
    @validate_call
    def get_internalprograms_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InternalProgramList]:
        """List all internal programs configured. 
    ...
    @validate_call
    def get_internalprograms_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_internalprograms_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/internalprograms',
    ...
    @validate_call
    def post_internalprograms(
        self,
        device_activate_deactivate: DeviceActivateDeactivate,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param device_activate_deactivate: (required)
        :type device_activate_deactivate: DeviceActivateDeactivate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_internalprograms_serialize(
            device_activate_deactivate=device_activate_deactivate,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_internalprograms_with_http_info(
        self,
        device_activate_deactivate: DeviceActivateDeactivate,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_internalprograms_without_preload_content(
        self,
        device_activate_deactivate: DeviceActivateDeactivate,
        _request_timeout: Union[
            None,
    ...
    def _post_internalprograms_serialize(
        self,
        device_activate_deactivate,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if device_activate_deactivate is not None:
            _body_params = device_activate_deactivate
