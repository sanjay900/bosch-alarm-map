...
class BatterychargersApi:
    ...
    def get_batterychargers(
        ...
        The resource type batterychargers lists the battery charger of the power supply. It provides the same interface as the resource type device. It can be disabled and bypassed. This resource type cannot be walktested. The resource structure will contain attributes of device, disable and device. 
        ...
        _param = self._get_batterychargers_serialize(
    ...
    @validate_call
    def get_batterychargers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BatterychargerList]:
        """List of battery chargers in the MAP system
    ...
    @validate_call
    def get_batterychargers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_batterychargers_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def post_batterychargers(
        ...
        _param = self._post_batterychargers_serialize(
    ...
    @validate_call
    def post_batterychargers_with_http_info(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_batterychargers_without_preload_content(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_batterychargers_serialize(
        self,
