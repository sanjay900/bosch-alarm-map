...
class PsCanOpSIIDApi:
    ...
    @validate_call
    def get_ps_can_op_siid(
        self,
        ps_can_op_siid: Annotated[StrictStr, Field(description="Unique psCanOp SIID. You can get all psCanOps IDs with the command GET /psCanOpList")],
        ...
        :param ps_can_op_siid: Unique psCanOp SIID. You can get all psCanOps IDs with the command GET /psCanOpList (required)
        :type ps_can_op_siid: str
        ...
        _param = self._get_ps_can_op_siid_serialize(
            ps_can_op_siid=ps_can_op_siid,
    ...
    @validate_call
    def get_ps_can_op_siid_with_http_info(
        self,
        ps_can_op_siid: Annotated[StrictStr, Field(description="Unique psCanOp SIID. You can get all psCanOps IDs with the command GET /psCanOpList")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_ps_can_op_siid_without_preload_content(
        self,
        ps_can_op_siid: Annotated[StrictStr, Field(description="Unique psCanOp SIID. You can get all psCanOps IDs with the command GET /psCanOpList")],
        _request_timeout: Union[
            None,
    ...
    def _get_ps_can_op_siid_serialize(
        self,
        ps_can_op_siid,
        _request_auth,
        _content_type,
        ...
        if ps_can_op_siid is not None:
            _path_params['psCanOp_SIID'] = ps_can_op_siid
