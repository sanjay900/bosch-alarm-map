...
class GroundfaultSIIDApi:
    ...
    @validate_call
    def get_groundfault_siid(
        self,
        groundfault_siid: Annotated[StrictStr, Field(description="Unique groundfault SIID. You can get all existing groundfaults SIIDs with the command GET /groundfaults")],
        ...
        """Individual ground fault resource

        The resource type groundFault lists the ground fault input of the power supply. It provides the same interface as the resource type device. It can be disabled and bypassed. This resource type cannot be walktested. The resource structure contains attributes of device, disable and bypass. 

        :param groundfault_siid: Unique groundfault SIID. You can get all existing groundfaults SIIDs with the command GET /groundfaults (required)
        :type groundfault_siid: str
        ...
        _param = self._get_groundfault_siid_serialize(
            groundfault_siid=groundfault_siid,
    ...
    @validate_call
    def get_groundfault_siid_with_http_info(
        self,
        groundfault_siid: Annotated[StrictStr, Field(description="Unique groundfault SIID. You can get all existing groundfaults SIIDs with the command GET /groundfaults")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_groundfault_siid_without_preload_content(
        self,
        groundfault_siid: Annotated[StrictStr, Field(description="Unique groundfault SIID. You can get all existing groundfaults SIIDs with the command GET /groundfaults")],
        _request_timeout: Union[
            None,
    ...
    def _get_groundfault_siid_serialize(
        self,
        groundfault_siid,
        _request_auth,
        _content_type,
        ...
        if groundfault_siid is not None:
            _path_params['groundfault_SIID'] = groundfault_siid
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{groundfault_SIID}',
    ...
    def post_groundfault_siid(
        ...
        _param = self._post_groundfault_siid_serialize(
            groundfault_siid=groundfault_siid,
    ...
    @validate_call
    def post_groundfault_siid_with_http_info(
        self,
        groundfault_siid: Annotated[StrictStr, Field(description="Unique groundfault SIID. You can get all existing groundfaults SIIDs with the command GET /groundfaults")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_groundfault_siid_without_preload_content(
        self,
        groundfault_siid: Annotated[StrictStr, Field(description="Unique groundfault SIID. You can get all existing groundfaults SIIDs with the command GET /groundfaults")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    def _post_groundfault_siid_serialize(
        self,
        groundfault_siid,
