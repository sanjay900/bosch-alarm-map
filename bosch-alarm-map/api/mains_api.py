...
class MainsApi:
    ...
    def get_mains(
        ...
        _param = self._get_mains_serialize(
    ...
    @validate_call
    def get_mains_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_mains(
        ...
        The resource type mains lists the ac input of the power supply. It can be disabled and bypassed. The resource structure will contain attributes of device, disable and bypass. This resource type cannot be walktested. 
        ...
        _param = self._post_mains_serialize(
    ...
    @validate_call
    def post_mains_without_preload_content(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
