...
class AreasApi:
    ...
    def get_areas(
        ...
        The AreaList resource wraps a list of areas, to provide status of and access to multiple areas at the same time. The area list allows retrieval of status information of multiple areas. The areas that are to be fetched are selected using query parameters (url). If no parameters are specified, the status of all areas is provided. 
        ...
        _param = self._get_areas_serialize(
    ...
    @validate_call
    def get_areas_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_areas(
        self,
        post_areas_request: PostAreasRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        The AreaList resource wraps a list of areas, to provide status of and access to multiple areas at the same time. The area list allows retrieval of status information of multiple areas. The areas that are to be fetched are selected using query parameters (url). If no parameters are specified, the status of all areas is provided. For the following area functions an example with explanation is attached: - Arm areas - Disarm areas - Start walktests - Stop walktests - Start motion detector tests - Stop motion detector tests - Start chime mode - Stop chime mode - Start bell test 

        :param post_areas_request: (required)
        :type post_areas_request: PostAreasRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_areas_serialize(
            post_areas_request=post_areas_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_areas_without_preload_content(
        self,
        post_areas_request: PostAreasRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_areas_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if post_areas_request is not None:
            _body_params = post_areas_request
