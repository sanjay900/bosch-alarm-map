...
class SmartkeysApi:
    ...
    def get_smartkeys(
        ...
        _param = self._get_smartkeys_serialize(
    ...
    @validate_call
    def get_smartkeys_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_smartkeys_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_smartkeys(
        ...
        _param = self._post_smartkeys_serialize(
    ...
    @validate_call
    def post_smartkeys_with_http_info(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_smartkeys_without_preload_content(
        self,
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
            None,
