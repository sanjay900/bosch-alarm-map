...
class LsnGatewaySIIDApi:
    ...
    @validate_call
    def get_lsn_gateway_siid(
        self,
        lsn_gateway_siid: Annotated[StrictStr, Field(description="Unique lsnGateway SIID. You can get all existing lsnGateways IDs with the command GET /lsnGateways")],
        ...
        The resource type lsnGateways extends the device resource type with an additional firmware version command. It lists all LSN Gateways. It can be disabled. This resource type cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 

        :param lsn_gateway_siid: Unique lsnGateway SIID. You can get all existing lsnGateways IDs with the command GET /lsnGateways (required)
        :type lsn_gateway_siid: str
        ...
        _param = self._get_lsn_gateway_siid_serialize(
            lsn_gateway_siid=lsn_gateway_siid,
    ...
    @validate_call
    def get_lsn_gateway_siid_with_http_info(
        self,
        lsn_gateway_siid: Annotated[StrictStr, Field(description="Unique lsnGateway SIID. You can get all existing lsnGateways IDs with the command GET /lsnGateways")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_lsn_gateway_siid_without_preload_content(
        self,
        lsn_gateway_siid: Annotated[StrictStr, Field(description="Unique lsnGateway SIID. You can get all existing lsnGateways IDs with the command GET /lsnGateways")],
        _request_timeout: Union[
            None,
    ...
    def _get_lsn_gateway_siid_serialize(
        self,
        lsn_gateway_siid,
        _request_auth,
        _content_type,
        ...
        if lsn_gateway_siid is not None:
            _path_params['lsnGateway_SIID'] = lsn_gateway_siid
    ...
    @validate_call
    def postlsn_gateway_siid(
        self,
        lsn_gateway_siid: StrictStr,
        postlsn_gateway_siid_request: PostlsnGatewaySIIDRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param lsn_gateway_siid: (required)
        :type lsn_gateway_siid: str
        :param postlsn_gateway_siid_request: (required)
        :type postlsn_gateway_siid_request: PostlsnGatewaySIIDRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._postlsn_gateway_siid_serialize(
            lsn_gateway_siid=lsn_gateway_siid,
            postlsn_gateway_siid_request=postlsn_gateway_siid_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def postlsn_gateway_siid_with_http_info(
        self,
        lsn_gateway_siid: StrictStr,
        postlsn_gateway_siid_request: PostlsnGatewaySIIDRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def postlsn_gateway_siid_without_preload_content(
        self,
        lsn_gateway_siid: StrictStr,
        postlsn_gateway_siid_request: PostlsnGatewaySIIDRequest,
        _request_timeout: Union[
    ...
    def _postlsn_gateway_siid_serialize(
        self,
        lsn_gateway_siid,
        postlsn_gateway_siid_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if postlsn_gateway_siid_request is not None:
            _body_params = postlsn_gateway_siid_request
