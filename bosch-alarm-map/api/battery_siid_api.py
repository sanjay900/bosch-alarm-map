...
class BatterySIIDApi:
    ...
    @validate_call
    def get_battery_siid(
        self,
        battery_siid: StrictStr,
        ...
        The resource type battery lists the connected battery input of the power supply. It provides the same interface as the resource type device. It can be disabled and bypassed. This resource type cannot be walktested. 

        :param battery_siid: (required)
        :type battery_siid: str
        ...
        _param = self._get_battery_siid_serialize(
            battery_siid=battery_siid,
    ...
    @validate_call
    def get_battery_siid_with_http_info(
        self,
        battery_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_battery_siid_without_preload_content(
        self,
        battery_siid: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_battery_siid_serialize(
        self,
        battery_siid,
        _request_auth,
        _content_type,
        ...
        if battery_siid is not None:
            _path_params['battery_SIID'] = battery_siid
    ...
    @validate_call
    def post_battery_siid(
        self,
        battery_siid: Annotated[StrictStr, Field(description="Unique battery SIID. You can get all existing batteries SIIDs with the command GET /batteries")],
        ...
        :param battery_siid: Unique battery SIID. You can get all existing batteries SIIDs with the command GET /batteries (required)
        :type battery_siid: str
        ...
        _param = self._post_battery_siid_serialize(
            battery_siid=battery_siid,
    ...
    @validate_call
    def post_battery_siid_with_http_info(
        self,
        battery_siid: Annotated[StrictStr, Field(description="Unique battery SIID. You can get all existing batteries SIIDs with the command GET /batteries")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_battery_siid_without_preload_content(
        self,
        battery_siid: Annotated[StrictStr, Field(description="Unique battery SIID. You can get all existing batteries SIIDs with the command GET /batteries")],
        post_batteries_request: PostBatteriesRequest,
        _request_timeout: Union[
    ...
    def _post_battery_siid_serialize(
        self,
        battery_siid,
