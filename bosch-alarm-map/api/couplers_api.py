...
class CouplersApi:
    ...
    def get_couplers(
        ...
        """List of couplers in the MAP system

        The type couplers lists the couplers and provides the same interface as device type. It can be disabled. It cannot be bypassed or walktested. The resource structure will contain attributes of device and disable. 
        ...
        _param = self._get_couplers_serialize(
    ...
    @validate_call
    def get_couplers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_couplers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def post_couplers(
        ...
        _param = self._post_couplers_serialize(
    ...
    @validate_call
    def post_couplers_with_http_info(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_couplers_without_preload_content(
        self,
        device_enable_disable: DeviceEnableDisable,
        _request_timeout: Union[
            None,
