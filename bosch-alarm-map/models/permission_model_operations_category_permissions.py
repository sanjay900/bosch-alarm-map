...
class PermissionModelOperationsCategoryPermissions(BaseModel):
    """
    PermissionModelOperationsCategoryPermissions
    """ # noqa: E501
    may_disable_device: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can block system devices.", alias="mayDisableDevice")
    may_enable_device: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can return a system device from disabled to enabled status.", alias="mayEnableDevice")
    may_turn_chime_on_off: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can turn Chime Mode on or off.", alias="mayTurnChimeOn/Off")
    may_change_schedule: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can change the date/time of scheduled events from the Keypad.", alias="mayChangeSchedule")
    may_edit_blocking_time: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can edit blocking time for disarming of areas.", alias="mayEditBlockingTime")
    __properties: ClassVar[List[str]] = ["mayDisableDevice", "mayEnableDevice", "mayTurnChimeOn/Off", "mayChangeSchedule", "mayEditBlockingTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mayDisableDevice": obj.get("mayDisableDevice"),
            "mayEnableDevice": obj.get("mayEnableDevice"),
            "mayTurnChimeOn/Off": obj.get("mayTurnChimeOn/Off"),
            "mayChangeSchedule": obj.get("mayChangeSchedule"),
            "mayEditBlockingTime": obj.get("mayEditBlockingTime")
        })
        return _obj
