...
class IpArmingInfo(BaseModel):
    """
    IpArmingInfo
    """ # noqa: E501
    device_list: Optional[List[StrictStr]] = Field(default=None, description="The list of devices urls that prevent the internal program from being activated", alias="deviceList")
    activated: Optional[StrictBool] = Field(default=None, description="Indicates whether internal program is activated")
    can_be_activated: Optional[StrictBool] = Field(default=None, description="Indicates whether internal program can be activated. If it is already activated, then this flag will be false", alias="canBeActivated")
    __properties: ClassVar[List[str]] = ["deviceList", "activated", "canBeActivated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canBeActivated": obj.get("canBeActivated")
        })
        return _obj
