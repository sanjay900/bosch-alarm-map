...
class LSNLoopNonBypassableIntrusionPointPost(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "area", "pointType", "supportsDelayedReporting", "walktestCategory", "chimeModeCapable", "delayForAlarmDetection", "entryPoint", "exitPoint", "walktestTriggerFrequency"]
