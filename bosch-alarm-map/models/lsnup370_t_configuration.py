...
LSNUP370TCONFIGURATION_ANY_OF_SCHEMAS = ["LSNLoopBypassable24HourIntrusionPointPost", "LSNLoopBypassableIntrusionPointPost", "LSNLoopNonBypassable24HourIntrusionPointPost", "LSNLoopNonBypassableIntrusionPointPost", "LSNUP370TConfigurationAnyOf"]

class LSNUP370TConfiguration(BaseModel):
    """
    ...
    # data type: LSNUP370TConfigurationAnyOf
    anyof_schema_5_validator: Optional[LSNUP370TConfigurationAnyOf] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNUP370TConfigurationAnyOf]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "LSNLoopBypassable24HourIntrusionPointPost", "LSNLoopBypassableIntrusionPointPost", "LSNLoopNonBypassable24HourIntrusionPointPost", "LSNLoopNonBypassableIntrusionPointPost", "LSNUP370TConfigurationAnyOf" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = LSNUP370TConfiguration.model_construct()
        error_messages = []
        ...
        # validate data type: LSNUP370TConfigurationAnyOf
        if not isinstance(v, LSNUP370TConfigurationAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNUP370TConfigurationAnyOf`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in LSNUP370TConfiguration with anyOf schemas: LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNUP370TConfigurationAnyOf. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_5_validator: Optional[LSNUP370TConfigurationAnyOf] = None
        try:
            instance.actual_instance = LSNUP370TConfigurationAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into LSNUP370TConfiguration with anyOf schemas: LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNUP370TConfigurationAnyOf. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNUP370TConfigurationAnyOf]]:
