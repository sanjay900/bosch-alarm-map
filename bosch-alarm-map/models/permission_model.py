...
class PermissionModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["armCategoryPermissions", "eventCategoryPermissions", "maintenanceCategoryPermissions", "operationsCategoryPermissions", "remoteServiceCategoryPermissions", "statusCategoryPermissions", "userCategoryPermissions"]
