...
class Config(BaseModel):
    ...
    area_configuration: Optional[AreaConfiguration] = Field(default=None, description="An array of area configuration objects.", alias="areaConfiguration")
    internal_programs_configuration: Optional[InternalProgramsConfiguration] = Field(default=None, description="An array of internal program configuration objects.", alias="internalProgramsConfiguration")
    device_configuration: Optional[DeviceConfiguration] = Field(default=None, description="An array of device configuration objects.", alias="deviceConfiguration")
    __properties: ClassVar[List[str]] = ["@type", "@self", "areaConfiguration", "internalProgramsConfiguration", "deviceConfiguration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of area_configuration
        if self.area_configuration:
            _dict['areaConfiguration'] = self.area_configuration.to_dict()
        # override the default output from pydantic by calling `to_dict()` of internal_programs_configuration
        if self.internal_programs_configuration:
            _dict['internalProgramsConfiguration'] = self.internal_programs_configuration.to_dict()
        # override the default output from pydantic by calling `to_dict()` of device_configuration
        if self.device_configuration:
            _dict['deviceConfiguration'] = self.device_configuration.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@type": obj.get("@type"),
            "@self": obj.get("@self"),
            "areaConfiguration": AreaConfiguration.from_dict(obj["areaConfiguration"]) if obj.get("areaConfiguration") is not None else None,
            "internalProgramsConfiguration": InternalProgramsConfiguration.from_dict(obj["internalProgramsConfiguration"]) if obj.get("internalProgramsConfiguration") is not None else None,
            "deviceConfiguration": DeviceConfiguration.from_dict(obj["deviceConfiguration"]) if obj.get("deviceConfiguration") is not None else None
        })
        return _obj
