...
POSTKEYPADSIIDREQUEST_ONE_OF_SCHEMAS = ["DeviceActivateDeactivate", "DeviceEnableDisable", "DeviceFwVersion"]

class PostKeypadSIIDRequest(BaseModel):
    """
    PostKeypadSIIDRequest
    """
    # data type: DeviceActivateDeactivate
    oneof_schema_1_validator: Optional[DeviceActivateDeactivate] = None
    # data type: DeviceEnableDisable
    oneof_schema_2_validator: Optional[DeviceEnableDisable] = None
    # data type: DeviceFwVersion
    oneof_schema_3_validator: Optional[DeviceFwVersion] = None
    actual_instance: Optional[Union[DeviceActivateDeactivate, DeviceEnableDisable, DeviceFwVersion]] = None
    one_of_schemas: Set[str] = { "DeviceActivateDeactivate", "DeviceEnableDisable", "DeviceFwVersion" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = PostKeypadSIIDRequest.model_construct()
        error_messages = []
        match = 0
        # validate data type: DeviceActivateDeactivate
        if not isinstance(v, DeviceActivateDeactivate):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DeviceActivateDeactivate`")
        else:
            match += 1
        # validate data type: DeviceEnableDisable
        if not isinstance(v, DeviceEnableDisable):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DeviceEnableDisable`")
        else:
            match += 1
        # validate data type: DeviceFwVersion
        if not isinstance(v, DeviceFwVersion):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DeviceFwVersion`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in PostKeypadSIIDRequest with oneOf schemas: DeviceActivateDeactivate, DeviceEnableDisable, DeviceFwVersion. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in PostKeypadSIIDRequest with oneOf schemas: DeviceActivateDeactivate, DeviceEnableDisable, DeviceFwVersion. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into DeviceActivateDeactivate
        try:
            instance.actual_instance = DeviceActivateDeactivate.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into DeviceEnableDisable
        try:
            instance.actual_instance = DeviceEnableDisable.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into DeviceFwVersion
        try:
            instance.actual_instance = DeviceFwVersion.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into PostKeypadSIIDRequest with oneOf schemas: DeviceActivateDeactivate, DeviceEnableDisable, DeviceFwVersion. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PostKeypadSIIDRequest with oneOf schemas: DeviceActivateDeactivate, DeviceEnableDisable, DeviceFwVersion. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], DeviceActivateDeactivate, DeviceEnableDisable, DeviceFwVersion]]:
