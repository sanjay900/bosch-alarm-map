...
class LSNLoopRetriggerableBypassableTechnicalPointPost(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "area", "pointType", "supportsDelayedReporting", "walktestCategory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LSNLoopRetriggerableBypassableTechnicalPointPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LSNLoopRetriggerableBypassableTechnicalPointPost from a dict"""
        if obj is None:
            return None
