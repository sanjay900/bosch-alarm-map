...
class IncidentResource(BaseModel):
    ...
    IncidentResource
    """ # noqa: E501
    cmd: Optional[StrictStr] = Field(default=None, description="* HANDLE This operation initiates handling the incident * SILENCE This operation initiates silencing the incident ", alias="@cmd")
    ...
    def cmd_validate_enum(cls, value):
        ...
        if value not in set(['HANDLE', 'SILENCE']):
            raise ValueError("must be one of enum values ('HANDLE', 'SILENCE')")
        return value
