...
class LSNStdIntr55ConfigurationAnyOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "area", "loopCurrentIndex", "reportingNumber", "antimaskSensitivity", "sensitivity"]
