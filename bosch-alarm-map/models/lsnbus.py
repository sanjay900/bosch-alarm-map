...
class Lsnbus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@type", "@self", "opState", "enabled", "incs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Lsnbus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Lsnbus from a dict"""
        if obj is None:
            return None
