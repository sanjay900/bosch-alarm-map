...
class AreaAndTimeModelList(BaseModel):
    """
    ...
    list: Optional[List[AreaAndTimeModelListAllOfListInner]] = Field(default=None, description="List of all area and time models")
    __properties: ClassVar[List[str]] = ["areaAndTimeModelSyncID", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [AreaAndTimeModelListAllOfListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
