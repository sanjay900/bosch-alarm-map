...
class PermissionModelList(BaseModel):
    """
    PermissionModelList
    """ # noqa: E501
    ...
    list: Optional[List[PermissionModelListAllOfListInner]] = Field(default=None, description="List of all permission models")
    __properties: ClassVar[List[str]] = ["permissionModelSyncID", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [PermissionModelListAllOfListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
