...
class DayModelList(BaseModel):
    ...
    list: Optional[List[DayModelListAllOfListInner]] = Field(default=None, description="List of daymodels")
    __properties: ClassVar[List[str]] = ["dayModelSyncID", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [DayModelListAllOfListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
