...
class UserModelList(BaseModel):
    ...
    list: Optional[List[UserModelListAllOfListInner]] = Field(default=None, description="List of users")
    __properties: ClassVar[List[str]] = ["userModelSyncID", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [UserModelListAllOfListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
