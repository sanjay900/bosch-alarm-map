...
class PermissionModelListAllOfListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["permissionModelID", "armCategoryPermissions", "eventCategoryPermissions", "maintenanceCategoryPermissions", "operationsCategoryPermissions", "remoteServiceCategoryPermissions", "statusCategoryPermissions", "userCategoryPermissions"]
