...
class Printer(BaseModel):
    ...
    cover_open: Optional[StrictBool] = Field(default=None, description="True if printer cover is open, otherwise false", alias="coverOpen")
    paper_low: Optional[StrictBool] = Field(default=None, description="True if printer is low on paper", alias="paperLow")
    __properties: ClassVar[List[str]] = ["@type", "@self", "opState", "enabled", "coverOpen", "paperLow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "coverOpen": obj.get("coverOpen"),
            "paperLow": obj.get("paperLow")
        })
        return _obj
