...
class LSNGWConfiguration(BaseModel):
    """
    LSNGWConfiguration
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["connection", "name", "area", "serialNumber", "reportingNumber", "busMode", "supportsDelayedReporting", "considerDeviceMissingAsAlarm", "considerLoopFailureAsTamperInArmedCondition", "considerLoopFailureAsTamperInDisarmedCondition", "loopFailureIndication", "aux", "loop"]
