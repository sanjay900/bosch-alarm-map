...
class SmartkeyModelList(BaseModel):
    """
    SmartkeyModelList
    """ # noqa: E501
    ...
    list: Optional[List[SmartkeyModelListAllOfListInner]] = Field(default=None, description="List of all smartkey models")
    __properties: ClassVar[List[str]] = ["smartkeyModelSyncID", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [SmartkeyModelListAllOfListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
