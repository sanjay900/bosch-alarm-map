...
class PostPermisionmodelRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["@cmd", "permissionModelID", "armCategoryPermissions", "eventCategoryPermissions", "maintenanceCategoryPermissions", "operationsCategoryPermissions", "remoteServiceCategoryPermissions", "statusCategoryPermissions", "userCategoryPermissions"]
