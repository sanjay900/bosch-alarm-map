...
class AreaDisarm(BaseModel):
    """
    This command is used to disarm an area.
    """ # noqa: E501
    ...
    def cmd_validate_enum(cls, value):
        ...
        if value not in set(['DISARM']):
            raise ValueError("must be one of enum values ('DISARM')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AreaDisarm from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AreaDisarm from a dict"""
        if obj is None:
            return None
