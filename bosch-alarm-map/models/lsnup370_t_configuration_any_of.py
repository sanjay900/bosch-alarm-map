...
class LSNUP370TConfigurationAnyOf(BaseModel):
    """
    ...
    sensitivity_detection_range: Optional[LSNAntimaskSensitivityDetectionRangeProperty] = Field(default=LSNAntimaskSensitivityDetectionRangeProperty.MEDIUM_MINUS__10_METER, alias="sensitivityDetectionRange")
    __properties: ClassVar[List[str]] = ["name", "area", "reportingNumber", "antimaskLatched", "antimaskSensitivity", "sensitivityDetectionRange"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sensitivityDetectionRange": obj.get("sensitivityDetectionRange") if obj.get("sensitivityDetectionRange") is not None else LSNAntimaskSensitivityDetectionRangeProperty.MEDIUM_MINUS__10_METER
        })
        return _obj
