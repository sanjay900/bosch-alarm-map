...
class LSNStdIntr51ConfigurationAnyOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "area", "loopCurrentIndex", "reportingNumber", "antimaskDetection", "antimaskLatched", "antimaskSensitivity", "sensitivity"]
