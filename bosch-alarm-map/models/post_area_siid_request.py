...
POSTAREASIIDREQUEST_ONE_OF_SCHEMAS = ["AreaArm", "AreaDisarm", "BellTestStart", "ChimeModeStartStop", "GetarmingInfo", "MotionDetectorTestStartStop", "WalktestStart", "WalktestStop"]

class PostAreaSIIDRequest(BaseModel):
    """
    PostAreaSIIDRequest
    """
    # data type: AreaArm
    ...
    # data type: GetarmingInfo
    oneof_schema_8_validator: Optional[GetarmingInfo] = None
    actual_instance: Optional[Union[AreaArm, AreaDisarm, BellTestStart, ChimeModeStartStop, GetarmingInfo, MotionDetectorTestStartStop, WalktestStart, WalktestStop]] = None
    one_of_schemas: Set[str] = { "AreaArm", "AreaDisarm", "BellTestStart", "ChimeModeStartStop", "GetarmingInfo", "MotionDetectorTestStartStop", "WalktestStart", "WalktestStop" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = PostAreaSIIDRequest.model_construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, BellTestStart):
            ...
            match += 1
        # validate data type: GetarmingInfo
        if not isinstance(v, GetarmingInfo):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GetarmingInfo`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in PostAreaSIIDRequest with oneOf schemas: AreaArm, AreaDisarm, BellTestStart, ChimeModeStartStop, GetarmingInfo, MotionDetectorTestStartStop, WalktestStart, WalktestStop. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in PostAreaSIIDRequest with oneOf schemas: AreaArm, AreaDisarm, BellTestStart, ChimeModeStartStop, GetarmingInfo, MotionDetectorTestStartStop, WalktestStart, WalktestStop. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into GetarmingInfo
        try:
            instance.actual_instance = GetarmingInfo.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into PostAreaSIIDRequest with oneOf schemas: AreaArm, AreaDisarm, BellTestStart, ChimeModeStartStop, GetarmingInfo, MotionDetectorTestStartStop, WalktestStart, WalktestStop. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PostAreaSIIDRequest with oneOf schemas: AreaArm, AreaDisarm, BellTestStart, ChimeModeStartStop, GetarmingInfo, MotionDetectorTestStartStop, WalktestStart, WalktestStop. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AreaArm, AreaDisarm, BellTestStart, ChimeModeStartStop, GetarmingInfo, MotionDetectorTestStartStop, WalktestStart, WalktestStop]]:
