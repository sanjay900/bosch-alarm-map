...
class StatisticsDb(BaseModel):
    ...
    databases: Optional[StatisticsDbAllOfDatabases] = None
    __properties: ClassVar[List[str]] = ["start", "last", "duration", "interval", "counter", "databases"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "databases": StatisticsDbAllOfDatabases.from_dict(obj["databases"]) if obj.get("databases") is not None else None
        })
        return _obj
