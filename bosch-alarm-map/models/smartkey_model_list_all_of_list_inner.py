...
class SmartkeyModelListAllOfListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["smartkeyModelID", "areaScopeList", "armAuthority", "disarmAuthority", "timeModelUsedForDisarming"]
