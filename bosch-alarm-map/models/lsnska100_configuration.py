...
LSNSKA100CONFIGURATION_ANY_OF_SCHEMAS = ["LSNLoopBypassable24HourIntrusionPointPost", "LSNLoopBypassableBoltContactPointPost", "LSNLoopBypassableIntrusionPointPost", "LSNLoopNonBypassable24HourIntrusionPointPost", "LSNLoopNonBypassableBoltContactPointPost", "LSNLoopNonBypassableIntrusionPointPost", "LSNSKA100ConfigurationAnyOf"]

class LSNSKA100Configuration(BaseModel):
    """
    ...
    anyof_schema_3_validator: Optional[LSNLoopBypassableIntrusionPointPost] = None
    # data type: LSNLoopNonBypassableIntrusionPointPost
    anyof_schema_4_validator: Optional[LSNLoopNonBypassableIntrusionPointPost] = None
    # data type: LSNLoopBypassable24HourIntrusionPointPost
    anyof_schema_5_validator: Optional[LSNLoopBypassable24HourIntrusionPointPost] = None
    # data type: LSNLoopNonBypassable24HourIntrusionPointPost
    anyof_schema_6_validator: Optional[LSNLoopNonBypassable24HourIntrusionPointPost] = None
    # data type: LSNSKA100ConfigurationAnyOf
    anyof_schema_7_validator: Optional[LSNSKA100ConfigurationAnyOf] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableBoltContactPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableBoltContactPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNSKA100ConfigurationAnyOf]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "LSNLoopBypassable24HourIntrusionPointPost", "LSNLoopBypassableBoltContactPointPost", "LSNLoopBypassableIntrusionPointPost", "LSNLoopNonBypassable24HourIntrusionPointPost", "LSNLoopNonBypassableBoltContactPointPost", "LSNLoopNonBypassableIntrusionPointPost", "LSNSKA100ConfigurationAnyOf" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = LSNSKA100Configuration.model_construct()
        error_messages = []
        ...
        # validate data type: LSNSKA100ConfigurationAnyOf
        if not isinstance(v, LSNSKA100ConfigurationAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNSKA100ConfigurationAnyOf`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in LSNSKA100Configuration with anyOf schemas: LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableBoltContactPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableBoltContactPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNSKA100ConfigurationAnyOf. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_7_validator: Optional[LSNSKA100ConfigurationAnyOf] = None
        try:
            instance.actual_instance = LSNSKA100ConfigurationAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into LSNSKA100Configuration with anyOf schemas: LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableBoltContactPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableBoltContactPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNSKA100ConfigurationAnyOf. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableBoltContactPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableBoltContactPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNSKA100ConfigurationAnyOf]]:
