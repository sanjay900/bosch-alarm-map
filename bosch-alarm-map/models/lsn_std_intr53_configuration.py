...
LSNSTDINTR53CONFIGURATION_ANY_OF_SCHEMAS = ["LSNLoopBypassable24HourIntrusionPointPost", "LSNLoopBypassableIntrusionPointPost", "LSNLoopNonBypassable24HourIntrusionPointPost", "LSNLoopNonBypassableIntrusionPointPost", "LSNStdIntr53ConfigurationAnyOf"]

class LSNStdIntr53Configuration(BaseModel):
    """
    ...
    # data type: LSNStdIntr53ConfigurationAnyOf
    anyof_schema_5_validator: Optional[LSNStdIntr53ConfigurationAnyOf] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNStdIntr53ConfigurationAnyOf]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "LSNLoopBypassable24HourIntrusionPointPost", "LSNLoopBypassableIntrusionPointPost", "LSNLoopNonBypassable24HourIntrusionPointPost", "LSNLoopNonBypassableIntrusionPointPost", "LSNStdIntr53ConfigurationAnyOf" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = LSNStdIntr53Configuration.model_construct()
        error_messages = []
        ...
        # validate data type: LSNStdIntr53ConfigurationAnyOf
        if not isinstance(v, LSNStdIntr53ConfigurationAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNStdIntr53ConfigurationAnyOf`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in LSNStdIntr53Configuration with anyOf schemas: LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNStdIntr53ConfigurationAnyOf. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_5_validator: Optional[LSNStdIntr53ConfigurationAnyOf] = None
        try:
            instance.actual_instance = LSNStdIntr53ConfigurationAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into LSNStdIntr53Configuration with anyOf schemas: LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNStdIntr53ConfigurationAnyOf. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNStdIntr53ConfigurationAnyOf]]:
