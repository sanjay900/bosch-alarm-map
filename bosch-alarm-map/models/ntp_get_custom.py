...
class NtpGetCustom(BaseModel):
    """
    NtpGetCustom
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Whether custom servers are configured")
    servers: Optional[List[StrictStr]] = Field(default=None, description="Array of the custom servers that can be used for NTP, up to 2 entries")
