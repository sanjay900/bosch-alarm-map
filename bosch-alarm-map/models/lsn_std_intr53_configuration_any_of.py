...
class LSNStdIntr53ConfigurationAnyOf(BaseModel):
    """
    ...
    loop_current_index: Annotated[int, Field(le=63, strict=True, ge=0)] = Field(description="LSN device loop current index.", alias="loopCurrentIndex")
    ...
    antimask_detection: Optional[StrictBool] = Field(default=None, description="LSN antimask detection status.", alias="antimaskDetection")
    antimask_latched: Optional[StrictBool] = Field(default=False, description="Determines whether the Anti-mask alarm condition will require a reset.", alias="antimaskLatched")
    antimask_sensitivity: Optional[LSNAntimaskSensitivityProperty] = Field(default=LSNAntimaskSensitivityProperty.STANDARD, alias="antimaskSensitivity")
    pir_mode: Optional[StrictBool] = Field(default=None, description="LSN PIR mode status.", alias="pirMode")
    sensitivity: Optional[LSNDetectorSensitivityProperty] = None
    __properties: ClassVar[List[str]] = ["name", "area", "loopCurrentIndex", "reportingNumber", "antimaskDetection", "antimaskLatched", "antimaskSensitivity", "pirMode", "sensitivity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "area": obj.get("area"),
            "loopCurrentIndex": obj.get("loopCurrentIndex"),
            "reportingNumber": obj.get("reportingNumber"),
            "antimaskDetection": obj.get("antimaskDetection"),
            "antimaskLatched": obj.get("antimaskLatched") if obj.get("antimaskLatched") is not None else False,
            "antimaskSensitivity": obj.get("antimaskSensitivity") if obj.get("antimaskSensitivity") is not None else LSNAntimaskSensitivityProperty.STANDARD,
            "pirMode": obj.get("pirMode"),
