...
class PermissionModelRemoteServiceCategoryPermissions(BaseModel):
    """
    PermissionModelRemoteServiceCategoryPermissions
    """ # noqa: E501
    may_authorize_manufacturer_user: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can authorize manufacturer user access.", alias="mayAuthorizeManufacturerUser")
    may_authorize_rps_user: Optional[StrictBool] = Field(default=None, description="This Parameter determines whether the user can authorize remote programming software RPS for MAP user access.", alias="mayAuthorizeRPSUser")
    __properties: ClassVar[List[str]] = ["mayAuthorizeManufacturerUser", "mayAuthorizeRPSUser"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mayAuthorizeManufacturerUser": obj.get("mayAuthorizeManufacturerUser"),
            "mayAuthorizeRPSUser": obj.get("mayAuthorizeRPSUser")
        })
        return _obj
