...
class SynchronizationIDs(BaseModel):
    """
    SynchronizationIDs
    """ # noqa: E501
    user_model_sync_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="Synchronization ID for the user database table. Will be changed for each change in the user database table.", alias="userModelSyncID")
    day_model_sync_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="Synchronization ID for the day database table. Will be changed for each change in the day database table.", alias="dayModelSyncID")
    time_model_sync_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Synchronization ID for the time database table. Will be changed for each change in the time database table.", alias="timeModelSyncID")
    special_day_model_sync_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="Synchronization ID for the special day database table. Will be changed for each change in the special day database table.", alias="specialDayModelSyncID")
    area_and_time_model_sync_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="Synchronization ID for the area and time table. Will be changed for each change in the area and time database table.", alias="areaAndTimeModelSyncID")
    smartkey_model_sync_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="Synchronization ID for the smart key database table. Will be changed for each change in the smart key database table.", alias="smartkeyModelSyncID")
    access_model_sync_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="Synchronization ID for the access table. Will be changed for each change in the access database table.", alias="accessModelSyncID")
    ...
    mumusergroup_sync_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="Synchronization ID for MUM user group. Will be changed for each change in the MUM user group.", alias="mumusergroupSyncID")
    uptime: Annotated[int, Field(strict=True, ge=0)] = Field(description="The MAP panel uptime, seconds since the last boot. If this counter jumps backwards, the MAP panel was rebooted.")
    restart_counter: Annotated[int, Field(strict=True, ge=1)] = Field(description="The number of restarts the MAP panel performed. If this counter jumps backwards, the MAP panel was updated.", alias="restartCounter")
    master_key_checksum: StrictStr = Field(description="Checksum of the Master Key", alias="masterKeyChecksum")
    master_key_timestamp: StrictStr = Field(description="Timestamp of the Master Key", alias="masterKeyTimestamp")
    shared_key_checksum: StrictStr = Field(description="Checksum of the Shared Key", alias="sharedKeyChecksum")
    shared_key_timestamp: StrictStr = Field(description="Timestamp of the Shared Key", alias="sharedKeyTimestamp")
    allow_sending_user_dbif_armed: StrictBool = Field(description="Flags whether it is possible to do database modifications using REST-API. Configurable in RPS for MAP 'Allow sending user database if armed'.", alias="allowSendingUserDBIfArmed")
    __properties: ClassVar[List[str]] = ["userModelSyncID", "dayModelSyncID", "timeModelSyncID", "specialDayModelSyncID", "areaAndTimeModelSyncID", "smartkeyModelSyncID", "accessModelSyncID", "permissionModelSyncID", "mumusergroupSyncID", "uptime", "restartCounter", "masterKeyChecksum", "masterKeyTimestamp", "sharedKeyChecksum", "sharedKeyTimestamp", "allowSendingUserDBIfArmed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userModelSyncID": obj.get("userModelSyncID"),
            "dayModelSyncID": obj.get("dayModelSyncID"),
            "timeModelSyncID": obj.get("timeModelSyncID"),
            "specialDayModelSyncID": obj.get("specialDayModelSyncID"),
            "areaAndTimeModelSyncID": obj.get("areaAndTimeModelSyncID"),
            "smartkeyModelSyncID": obj.get("smartkeyModelSyncID"),
            "accessModelSyncID": obj.get("accessModelSyncID"),
            "permissionModelSyncID": obj.get("permissionModelSyncID"),
            "mumusergroupSyncID": obj.get("mumusergroupSyncID"),
            "uptime": obj.get("uptime"),
            "restartCounter": obj.get("restartCounter"),
            "masterKeyChecksum": obj.get("masterKeyChecksum"),
            "masterKeyTimestamp": obj.get("masterKeyTimestamp"),
            "sharedKeyChecksum": obj.get("sharedKeyChecksum"),
            "sharedKeyTimestamp": obj.get("sharedKeyTimestamp"),
            "allowSendingUserDBIfArmed": obj.get("allowSendingUserDBIfArmed")
        })
        return _obj
