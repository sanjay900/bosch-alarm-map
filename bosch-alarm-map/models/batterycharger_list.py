...
class BatterychargerList(BaseModel):
    """
    BatterychargerList
    """ # noqa: E501
    ...
    list: Optional[List[Batterycharger]] = Field(default=None, description="List of all battery chargers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@type": obj.get("@type"),
            "@self": obj.get("@self"),
            "list": [Batterycharger.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
