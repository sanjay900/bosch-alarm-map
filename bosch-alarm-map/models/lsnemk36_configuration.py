...
LSNEMK36CONFIGURATION_ANY_OF_SCHEMAS = ["LSNEMK36ConfigurationAnyOf", "LSNLoopBypassable24HourIntrusionPointPost", "LSNLoopBypassableBoltContactPointPost", "LSNLoopBypassableIntrusionPointPost", "LSNLoopLatchingBypassableTechnicalPointPost", "LSNLoopNonBypassable24HourIntrusionPointPost", "LSNLoopNonBypassableBoltContactPointPost", "LSNLoopNonBypassableIntrusionPointPost", "LSNLoopNonBypassableTechnicalPointPost", "LSNLoopNonLatchingBypassableTechnicalPointPost", "LSNLoopNonSilentHoldupPointPost", "LSNLoopRetriggerableBypassableTechnicalPointPost", "LSNLoopSilentDuressPointPost", "LSNLoopSilentHoldupPointPost"]

class LSNEMK36Configuration(BaseModel):
    """
    LSNEMK36Configuration
    """

    # data type: LSNLoopBypassableBoltContactPointPost
    anyof_schema_1_validator: Optional[LSNLoopBypassableBoltContactPointPost] = None
    # data type: LSNLoopNonBypassableBoltContactPointPost
    anyof_schema_2_validator: Optional[LSNLoopNonBypassableBoltContactPointPost] = None
    # data type: LSNLoopSilentDuressPointPost
    anyof_schema_3_validator: Optional[LSNLoopSilentDuressPointPost] = None
    # data type: LSNLoopSilentHoldupPointPost
    anyof_schema_4_validator: Optional[LSNLoopSilentHoldupPointPost] = None
    # data type: LSNLoopNonSilentHoldupPointPost
    anyof_schema_5_validator: Optional[LSNLoopNonSilentHoldupPointPost] = None
    # data type: LSNLoopBypassableIntrusionPointPost
    anyof_schema_6_validator: Optional[LSNLoopBypassableIntrusionPointPost] = None
    # data type: LSNLoopNonBypassableIntrusionPointPost
    anyof_schema_7_validator: Optional[LSNLoopNonBypassableIntrusionPointPost] = None
    # data type: LSNLoopBypassable24HourIntrusionPointPost
    anyof_schema_8_validator: Optional[LSNLoopBypassable24HourIntrusionPointPost] = None
    # data type: LSNLoopNonBypassable24HourIntrusionPointPost
    anyof_schema_9_validator: Optional[LSNLoopNonBypassable24HourIntrusionPointPost] = None
    # data type: LSNLoopRetriggerableBypassableTechnicalPointPost
    anyof_schema_10_validator: Optional[LSNLoopRetriggerableBypassableTechnicalPointPost] = None
    # data type: LSNLoopLatchingBypassableTechnicalPointPost
    anyof_schema_11_validator: Optional[LSNLoopLatchingBypassableTechnicalPointPost] = None
    # data type: LSNLoopNonLatchingBypassableTechnicalPointPost
    anyof_schema_12_validator: Optional[LSNLoopNonLatchingBypassableTechnicalPointPost] = None
    # data type: LSNLoopNonBypassableTechnicalPointPost
    anyof_schema_13_validator: Optional[LSNLoopNonBypassableTechnicalPointPost] = None
    # data type: LSNEMK36ConfigurationAnyOf
    anyof_schema_14_validator: Optional[LSNEMK36ConfigurationAnyOf] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[LSNEMK36ConfigurationAnyOf, LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableBoltContactPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopLatchingBypassableTechnicalPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableBoltContactPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNLoopNonBypassableTechnicalPointPost, LSNLoopNonLatchingBypassableTechnicalPointPost, LSNLoopNonSilentHoldupPointPost, LSNLoopRetriggerableBypassableTechnicalPointPost, LSNLoopSilentDuressPointPost, LSNLoopSilentHoldupPointPost]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "LSNEMK36ConfigurationAnyOf", "LSNLoopBypassable24HourIntrusionPointPost", "LSNLoopBypassableBoltContactPointPost", "LSNLoopBypassableIntrusionPointPost", "LSNLoopLatchingBypassableTechnicalPointPost", "LSNLoopNonBypassable24HourIntrusionPointPost", "LSNLoopNonBypassableBoltContactPointPost", "LSNLoopNonBypassableIntrusionPointPost", "LSNLoopNonBypassableTechnicalPointPost", "LSNLoopNonLatchingBypassableTechnicalPointPost", "LSNLoopNonSilentHoldupPointPost", "LSNLoopRetriggerableBypassableTechnicalPointPost", "LSNLoopSilentDuressPointPost", "LSNLoopSilentHoldupPointPost" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = LSNEMK36Configuration.model_construct()
        error_messages = []
        # validate data type: LSNLoopBypassableBoltContactPointPost
        if not isinstance(v, LSNLoopBypassableBoltContactPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopBypassableBoltContactPointPost`")
        else:
            return v

        # validate data type: LSNLoopNonBypassableBoltContactPointPost
        if not isinstance(v, LSNLoopNonBypassableBoltContactPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopNonBypassableBoltContactPointPost`")
        else:
            return v

        # validate data type: LSNLoopSilentDuressPointPost
        if not isinstance(v, LSNLoopSilentDuressPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopSilentDuressPointPost`")
        else:
            return v

        # validate data type: LSNLoopSilentHoldupPointPost
        if not isinstance(v, LSNLoopSilentHoldupPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopSilentHoldupPointPost`")
        else:
            return v

        # validate data type: LSNLoopNonSilentHoldupPointPost
        if not isinstance(v, LSNLoopNonSilentHoldupPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopNonSilentHoldupPointPost`")
        else:
            return v
        ...
        # validate data type: LSNLoopRetriggerableBypassableTechnicalPointPost
        if not isinstance(v, LSNLoopRetriggerableBypassableTechnicalPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopRetriggerableBypassableTechnicalPointPost`")
        else:
            return v

        # validate data type: LSNLoopLatchingBypassableTechnicalPointPost
        if not isinstance(v, LSNLoopLatchingBypassableTechnicalPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopLatchingBypassableTechnicalPointPost`")
        else:
            return v

        # validate data type: LSNLoopNonLatchingBypassableTechnicalPointPost
        if not isinstance(v, LSNLoopNonLatchingBypassableTechnicalPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopNonLatchingBypassableTechnicalPointPost`")
        else:
            return v

        # validate data type: LSNLoopNonBypassableTechnicalPointPost
        if not isinstance(v, LSNLoopNonBypassableTechnicalPointPost):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNLoopNonBypassableTechnicalPointPost`")
        else:
            return v

        # validate data type: LSNEMK36ConfigurationAnyOf
        if not isinstance(v, LSNEMK36ConfigurationAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LSNEMK36ConfigurationAnyOf`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in LSNEMK36Configuration with anyOf schemas: LSNEMK36ConfigurationAnyOf, LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableBoltContactPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopLatchingBypassableTechnicalPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableBoltContactPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNLoopNonBypassableTechnicalPointPost, LSNLoopNonLatchingBypassableTechnicalPointPost, LSNLoopNonSilentHoldupPointPost, LSNLoopRetriggerableBypassableTechnicalPointPost, LSNLoopSilentDuressPointPost, LSNLoopSilentHoldupPointPost. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[LSNLoopBypassableBoltContactPointPost] = None
        try:
            instance.actual_instance = LSNLoopBypassableBoltContactPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[LSNLoopNonBypassableBoltContactPointPost] = None
        try:
            instance.actual_instance = LSNLoopNonBypassableBoltContactPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[LSNLoopSilentDuressPointPost] = None
        try:
            instance.actual_instance = LSNLoopSilentDuressPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_4_validator: Optional[LSNLoopSilentHoldupPointPost] = None
        try:
            instance.actual_instance = LSNLoopSilentHoldupPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_5_validator: Optional[LSNLoopNonSilentHoldupPointPost] = None
        try:
            instance.actual_instance = LSNLoopNonSilentHoldupPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_6_validator: Optional[LSNLoopBypassableIntrusionPointPost] = None
        ...
        # anyof_schema_10_validator: Optional[LSNLoopRetriggerableBypassableTechnicalPointPost] = None
        try:
            instance.actual_instance = LSNLoopRetriggerableBypassableTechnicalPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_11_validator: Optional[LSNLoopLatchingBypassableTechnicalPointPost] = None
        try:
            instance.actual_instance = LSNLoopLatchingBypassableTechnicalPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_12_validator: Optional[LSNLoopNonLatchingBypassableTechnicalPointPost] = None
        try:
            instance.actual_instance = LSNLoopNonLatchingBypassableTechnicalPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_13_validator: Optional[LSNLoopNonBypassableTechnicalPointPost] = None
        try:
            instance.actual_instance = LSNLoopNonBypassableTechnicalPointPost.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_14_validator: Optional[LSNEMK36ConfigurationAnyOf] = None
        try:
            instance.actual_instance = LSNEMK36ConfigurationAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into LSNEMK36Configuration with anyOf schemas: LSNEMK36ConfigurationAnyOf, LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableBoltContactPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopLatchingBypassableTechnicalPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableBoltContactPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNLoopNonBypassableTechnicalPointPost, LSNLoopNonLatchingBypassableTechnicalPointPost, LSNLoopNonSilentHoldupPointPost, LSNLoopRetriggerableBypassableTechnicalPointPost, LSNLoopSilentDuressPointPost, LSNLoopSilentHoldupPointPost. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], LSNEMK36ConfigurationAnyOf, LSNLoopBypassable24HourIntrusionPointPost, LSNLoopBypassableBoltContactPointPost, LSNLoopBypassableIntrusionPointPost, LSNLoopLatchingBypassableTechnicalPointPost, LSNLoopNonBypassable24HourIntrusionPointPost, LSNLoopNonBypassableBoltContactPointPost, LSNLoopNonBypassableIntrusionPointPost, LSNLoopNonBypassableTechnicalPointPost, LSNLoopNonLatchingBypassableTechnicalPointPost, LSNLoopNonSilentHoldupPointPost, LSNLoopRetriggerableBypassableTechnicalPointPost, LSNLoopSilentDuressPointPost, LSNLoopSilentHoldupPointPost]]:
