...
class NtpPost(BaseModel):
    """
    NtpPost
    """ # noqa: E501
    public: Optional[StrictBool] = Field(default=None, description="Enables or disables usage of public servers for NTP")
    custom: Optional[List[StrictStr]] = Field(default=None, description="Array of custom NTP servers, 1 or 2 entries are supported. Set to empty array to disable. Both URL (IP) and port must be provided in format URL:port")
    __properties: ClassVar[List[str]] = ["public", "custom"]
