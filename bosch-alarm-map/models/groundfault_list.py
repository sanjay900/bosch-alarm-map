...
class GroundfaultList(BaseModel):
    """
    GroundfaultList
    """ # noqa: E501
    ...
    list: Optional[List[Groundfault]] = Field(default=None, description="List of all groundfaults")
    __properties: ClassVar[List[str]] = ["@type", "@self", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@type": obj.get("@type"),
            "@self": obj.get("@self"),
            "list": [Groundfault.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
