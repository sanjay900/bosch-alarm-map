...
class MotionDetectorTestStartStop(BaseModel):
    """
    ...
    def cmd_validate_enum(cls, value):
        ...
        if value not in set(['STARTMDTEST', 'STOPMDTEST']):
            raise ValueError("must be one of enum values ('STARTMDTEST', 'STOPMDTEST')")
        return value
