...
class LSNLoopNonBypassable24HourIntrusionPointPost(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "area", "pointType", "supportsDelayedReporting", "walktestCategory", "delayForAlarmDetection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LSNLoopNonBypassable24HourIntrusionPointPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LSNLoopNonBypassable24HourIntrusionPointPost from a dict"""
        if obj is None:
            return None
