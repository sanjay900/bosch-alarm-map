...
class PostAreaandtimemodelRequest(BaseModel):
    """
    PostAreaandtimemodelRequest
    """ # noqa: E501
    cmd: StrictStr = Field(alias="@cmd")
    area_and_time_model_id: StrictStr = Field(description="The Unique name of a AreaandTimeModel. The name is used to identify the item on the MAP system.The following characters are forbidden in identifier name: \" @ ; ", alias="areaAndTimeModelID")
    always_allowed_permission_set: Optional[StrictStr] = Field(default=None, description="The access permission level always granted to the user.", alias="alwaysAllowedPermissionSet")
    restricted_by_area_permission_set: Optional[StrictStr] = Field(default=None, description="This Parameter determines whether the user is restricted by an area permission set.", alias="restrictedByAreaPermissionSet")
    restricted_by_time_permission_set: Optional[StrictStr] = Field(default=None, description="This Parameter determines whether the user is restricted by a time permission set.", alias="restrictedByTimePermissionSet")
    restricted_by_area_and_time_permission_set: Optional[StrictStr] = Field(default=None, description="This Parameter determines whether the user is restricted by an area and time permission set.", alias="restrictedByAreaAndTimePermissionSet")
    area_list: Optional[List[StrictStr]] = Field(default=None, description="List of areas related to the scheduled action.", alias="areaList")
    time_model_id: Optional[StrictStr] = Field(default=None, description="Related time model to schedule an action.", alias="timeModelID")
    ...
    __properties: ClassVar[List[str]] = ["@cmd", "areaAndTimeModelID", "alwaysAllowedPermissionSet", "restrictedByAreaPermissionSet", "restrictedByTimePermissionSet", "restrictedByAreaAndTimePermissionSet", "areaList", "timeModelID", "areaAndTimeModelSyncID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@cmd": obj.get("@cmd"),
            "areaAndTimeModelID": obj.get("areaAndTimeModelID"),
            "alwaysAllowedPermissionSet": obj.get("alwaysAllowedPermissionSet"),
            "restrictedByAreaPermissionSet": obj.get("restrictedByAreaPermissionSet"),
            "restrictedByTimePermissionSet": obj.get("restrictedByTimePermissionSet"),
            "restrictedByAreaAndTimePermissionSet": obj.get("restrictedByAreaAndTimePermissionSet"),
            "areaList": obj.get("areaList"),
            "timeModelID": obj.get("timeModelID"),
