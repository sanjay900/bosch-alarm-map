...
class AccessModelList(BaseModel):
    """
    AccessModelList
    """ # noqa: E501
    ...
    list: Optional[List[AccessModelListAllOfListInner]] = Field(default=None, description="List of all access models")
    __properties: ClassVar[List[str]] = ["accessModelSyncID", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [AccessModelListAllOfListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
