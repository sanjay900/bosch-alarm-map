...
class InfrastructureDeviceGenericProperty(BaseModel):
    """
    ...
    value: Optional[StrictStr] = Field(default=None, description="Parameter value (required)")
    second_value: Optional[StrictStr] = Field(default=None, description="Parameter second value (optional)")
    third_value: Optional[StrictStr] = Field(default=None, description="Parameter third value (optional)")
    __properties: ClassVar[List[str]] = ["name", "value", "second_value", "third_value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "value": obj.get("value"),
            "second_value": obj.get("second_value"),
            "third_value": obj.get("third_value")
        })
        return _obj
