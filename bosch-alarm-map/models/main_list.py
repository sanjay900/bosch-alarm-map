...
class MainList(BaseModel):
    ...
    list: Optional[List[Main]] = Field(default=None, description="List of all mains")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@type": obj.get("@type"),
            "@self": obj.get("@self"),
            "list": [Main.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
