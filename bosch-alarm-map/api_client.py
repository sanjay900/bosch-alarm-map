...
from bosch-alarm-map.configuration import Configuration
from bosch-alarm-map.api_response import ApiResponse, T as ApiResponseT
import bosch-alarm-map.models
from bosch-alarm-map import rest
from bosch-alarm-map.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bosch-alarm-map.models, klass)
