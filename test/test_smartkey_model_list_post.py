...
class TestSmartkeyModelListPost(unittest.TestCase):
    """SmartkeyModelListPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmartkeyModelListPost:
        """Test SmartkeyModelListPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmartkeyModelListPost`
        """
        model = SmartkeyModelListPost()
        if include_optional:
            return SmartkeyModelListPost(
                cmd = 'GETMODIFIEDLIST',
    ...
    def testSmartkeyModelListPost(self):
        """Test SmartkeyModelListPost"""
