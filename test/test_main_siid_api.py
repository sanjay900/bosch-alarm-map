...
class TestMainSIIDApi(unittest.TestCase):
    """MainSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MainSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_main_siid(self) -> None:
        """Test case for get_main_siid

        Individual main resource
        """
        pass

    def test_post_main_siid(self) -> None:
        """Test case for post_main_siid
