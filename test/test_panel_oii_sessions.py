...
class TestPanelOIISessions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PanelOIISessions:
        """Test PanelOIISessions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PanelOIISessions`
        """
        model = PanelOIISessions()
        if include_optional:
            return PanelOIISessions(
