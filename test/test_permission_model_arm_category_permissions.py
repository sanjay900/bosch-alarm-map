...
class TestPermissionModelArmCategoryPermissions(unittest.TestCase):
    """PermissionModelArmCategoryPermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionModelArmCategoryPermissions:
        """Test PermissionModelArmCategoryPermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelArmCategoryPermissions`
        """
        model = PermissionModelArmCategoryPermissions()
        if include_optional:
            return PermissionModelArmCategoryPermissions(
                may_arm_area = True,
                ...
                may_switch_internal_program_on_off = True
            )
        else:
            return PermissionModelArmCategoryPermissions(
        )
    ...
    def testPermissionModelArmCategoryPermissions(self):
        """Test PermissionModelArmCategoryPermissions"""
