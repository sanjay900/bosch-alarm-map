...
class TestArmingInfoWhyNotReadyToArm(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ArmingInfoWhyNotReadyToArm:
        """Test ArmingInfoWhyNotReadyToArm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArmingInfoWhyNotReadyToArm`
        """
        model = ArmingInfoWhyNotReadyToArm()
        if include_optional:
            return ArmingInfoWhyNotReadyToArm(
    ...
    def testArmingInfoWhyNotReadyToArm(self):
        """Test ArmingInfoWhyNotReadyToArm"""
