...
class TestPowerSupplyList(unittest.TestCase):
    """PowerSupplyList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerSupplyList:
        """Test PowerSupplyList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerSupplyList`
        """
        model = PowerSupplyList()
        if include_optional:
