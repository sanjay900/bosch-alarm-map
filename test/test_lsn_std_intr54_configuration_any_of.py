...
class TestLSNStdIntr54ConfigurationAnyOf(unittest.TestCase):
    """LSNStdIntr54ConfigurationAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr54ConfigurationAnyOf:
        """Test LSNStdIntr54ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr54ConfigurationAnyOf`
        """
        model = LSNStdIntr54ConfigurationAnyOf()
        if include_optional:
            return LSNStdIntr54ConfigurationAnyOf(
                name = '[StdIntr54 LSN 1]',
    ...
    def testLSNStdIntr54ConfigurationAnyOf(self):
        """Test LSNStdIntr54ConfigurationAnyOf"""
