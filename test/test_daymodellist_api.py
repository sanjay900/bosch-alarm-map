...
class TestDaymodellistApi(unittest.TestCase):
    """DaymodellistApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DaymodellistApi()

    def tearDown(self) -> None:
        pass

    def test_get_daymodellist(self) -> None:
        """Test case for get_daymodellist

        Get a list of all day models
        """
        pass

    def test_postdaymodellist(self) -> None:
        """Test case for postdaymodellist
