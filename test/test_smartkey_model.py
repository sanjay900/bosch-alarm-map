...
class TestSmartkeyModel(unittest.TestCase):
    """SmartkeyModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmartkeyModel:
        """Test SmartkeyModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmartkeyModel`
        """
        model = SmartkeyModel()
        if include_optional:
            return SmartkeyModel(
                area_scope_list = [
                    'Control Panel Area'
                    ],
