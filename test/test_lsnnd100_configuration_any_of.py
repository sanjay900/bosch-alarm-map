...
class TestLSNND100ConfigurationAnyOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNND100ConfigurationAnyOf:
        """Test LSNND100ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNND100ConfigurationAnyOf`
        """
        model = LSNND100ConfigurationAnyOf()
        if include_optional:
            return LSNND100ConfigurationAnyOf(
                name = '[ND100 LSN 1]',
    ...
    def testLSNND100ConfigurationAnyOf(self):
        """Test LSNND100ConfigurationAnyOf"""
