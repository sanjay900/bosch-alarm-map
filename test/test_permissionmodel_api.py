...
class TestPermissionmodelApi(unittest.TestCase):
    """PermissionmodelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PermissionmodelApi()

    def tearDown(self) -> None:
        pass

    def test_get_permissionmodel(self) -> None:
        """Test case for get_permissionmodel

        Get a specific permission model from the MAP system
        """
        pass

    def test_post_permisionmodel(self) -> None:
        """Test case for post_permisionmodel
