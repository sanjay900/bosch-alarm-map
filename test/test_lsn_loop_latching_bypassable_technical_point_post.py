...
class TestLSNLoopLatchingBypassableTechnicalPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopLatchingBypassableTechnicalPointPost:
        """Test LSNLoopLatchingBypassableTechnicalPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopLatchingBypassableTechnicalPointPost`
        """
        model = LSNLoopLatchingBypassableTechnicalPointPost()
        if include_optional:
            return LSNLoopLatchingBypassableTechnicalPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopLatchingBypassableTechnicalPointPost(self):
        """Test LSNLoopLatchingBypassableTechnicalPointPost"""
