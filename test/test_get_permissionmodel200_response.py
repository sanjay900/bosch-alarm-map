...
class TestGetPermissionmodel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPermissionmodel200Response:
        """Test GetPermissionmodel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPermissionmodel200Response`
        """
        model = GetPermissionmodel200Response()
        if include_optional:
            return GetPermissionmodel200Response(
    ...
    def testGetPermissionmodel200Response(self):
        """Test GetPermissionmodel200Response"""
