...
class TestInternalProgramList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InternalProgramList:
        """Test InternalProgramList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalProgramList`
        """
        model = InternalProgramList()
        if include_optional:
            return InternalProgramList(
                type = [
                    'IN.internalProgramList.1
OII.list.1
'
                    ],
                var_self = '',
    ...
    def testInternalProgramList(self):
        """Test InternalProgramList"""
