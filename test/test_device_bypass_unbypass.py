...
class TestDeviceBypassUnbypass(unittest.TestCase):
    """DeviceBypassUnbypass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceBypassUnbypass:
        """Test DeviceBypassUnbypass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceBypassUnbypass`
        """
        model = DeviceBypassUnbypass()
        if include_optional:
            return DeviceBypassUnbypass(
                cmd = 'BYPASS'
            )
        else:
            return DeviceBypassUnbypass(
    ...
    def testDeviceBypassUnbypass(self):
        """Test DeviceBypassUnbypass"""
