...
class TestGetSpecialdaymodel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialdaymodel200Response:
        """Test GetSpecialdaymodel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialdaymodel200Response`
        """
        model = GetSpecialdaymodel200Response()
        if include_optional:
            return GetSpecialdaymodel200Response(
                special_day_model_id = 'New Year's Day',
                day_model_id = '24-Hour',
                priority = 1,
                next_occurrence = '2022-01-01',
                repeat_policy = 'annually',
                custom_rule = 'Second Monday',
                easter_offset = '-2',
                repeat_until = 'custom',
    ...
    def testGetSpecialdaymodel200Response(self):
        """Test GetSpecialdaymodel200Response"""
