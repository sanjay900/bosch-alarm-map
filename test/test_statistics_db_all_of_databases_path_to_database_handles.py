...
class TestStatisticsDbAllOfDatabasesPathToDatabaseHandles(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatisticsDbAllOfDatabasesPathToDatabaseHandles:
        """Test StatisticsDbAllOfDatabasesPathToDatabaseHandles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsDbAllOfDatabasesPathToDatabaseHandles`
        """
        model = StatisticsDbAllOfDatabasesPathToDatabaseHandles()
        if include_optional:
            return StatisticsDbAllOfDatabasesPathToDatabaseHandles(
                alloc = 582,
                dealloc = 12,
                usage = 570
            )
    ...
    def testStatisticsDbAllOfDatabasesPathToDatabaseHandles(self):
        """Test StatisticsDbAllOfDatabasesPathToDatabaseHandles"""
