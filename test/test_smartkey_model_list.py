...
class TestSmartkeyModelList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SmartkeyModelList:
        """Test SmartkeyModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmartkeyModelList`
        """
        model = SmartkeyModelList()
        if include_optional:
            return SmartkeyModelList(
                smartkey_model_sync_id = 789,
                list = [
                    bosch_alarm_map.models.smartkey_model_list_all_of_list_inner.SmartkeyModelList_allOf_list_inner()
                    ]
            )
        else:
            return SmartkeyModelList(
    ...
    def testSmartkeyModelList(self):
        """Test SmartkeyModelList"""
