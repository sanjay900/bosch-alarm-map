...
class TestMotionDetectorTestStartStop(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MotionDetectorTestStartStop:
        """Test MotionDetectorTestStartStop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MotionDetectorTestStartStop`
        """
        model = MotionDetectorTestStartStop()
        if include_optional:
            return MotionDetectorTestStartStop(
                cmd = 'STARTMDTEST'
            )
        else:
            return MotionDetectorTestStartStop(
    ...
    def testMotionDetectorTestStartStop(self):
        """Test MotionDetectorTestStartStop"""
