...
class TestLSNStdIntr53ConfigurationAnyOf(unittest.TestCase):
    """LSNStdIntr53ConfigurationAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr53ConfigurationAnyOf:
        """Test LSNStdIntr53ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr53ConfigurationAnyOf`
        """
        model = LSNStdIntr53ConfigurationAnyOf()
        if include_optional:
            return LSNStdIntr53ConfigurationAnyOf(
                name = '[StdIntr53 LSN 1]',
    ...
    def testLSNStdIntr53ConfigurationAnyOf(self):
        """Test LSNStdIntr53ConfigurationAnyOf"""
