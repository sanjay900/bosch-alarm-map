...
class TestUserModelListAllOfListInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserModelListAllOfListInner:
        """Test UserModelListAllOfListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserModelListAllOfListInner`
        """
        model = UserModelListAllOfListInner()
        if include_optional:
            return UserModelListAllOfListInner(
                id = '005',
    ...
    def testUserModelListAllOfListInner(self):
        """Test UserModelListAllOfListInner"""
