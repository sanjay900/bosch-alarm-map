...
class TestDescMainResourcesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DescMainResourcesInner:
        """Test DescMainResourcesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescMainResourcesInner`
        """
        model = DescMainResourcesInner()
        if include_optional:
            return DescMainResourcesInner(
                type = [
                    ''
                    ],
                ref = ''
    ...
    def testDescMainResourcesInner(self):
        """Test DescMainResourcesInner"""
