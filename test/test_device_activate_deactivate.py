...
class TestDeviceActivateDeactivate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeviceActivateDeactivate:
        """Test DeviceActivateDeactivate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceActivateDeactivate`
        """
        model = DeviceActivateDeactivate()
        if include_optional:
            return DeviceActivateDeactivate(
                cmd = 'ACTIVATE'
            )
        else:
            return DeviceActivateDeactivate(
    ...
    def testDeviceActivateDeactivate(self):
        """Test DeviceActivateDeactivate"""
