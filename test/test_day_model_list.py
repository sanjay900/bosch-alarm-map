...
class TestDayModelList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DayModelList:
        """Test DayModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayModelList`
        """
        model = DayModelList()
        if include_optional:
            return DayModelList(
                ...
                list = [
                    openapi_client.models.day_model_list_all_of_list_inner.DayModelList_allOf_list_inner()
                    ]
            )
        else:
            return DayModelList(
