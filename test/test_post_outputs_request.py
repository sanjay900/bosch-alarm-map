...
class TestPostOutputsRequest(unittest.TestCase):
    """PostOutputsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostOutputsRequest:
        """Test PostOutputsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostOutputsRequest`
        """
        model = PostOutputsRequest()
        if include_optional:
            return PostOutputsRequest(
                cmd = 'ON'
            )
        else:
            return PostOutputsRequest(
    ...
    def testPostOutputsRequest(self):
        """Test PostOutputsRequest"""
