...
class TestStatisticsGeneral(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatisticsGeneral:
        """Test StatisticsGeneral
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsGeneral`
        """
        model = StatisticsGeneral()
        if include_optional:
    ...
    def testStatisticsGeneral(self):
        """Test StatisticsGeneral"""
