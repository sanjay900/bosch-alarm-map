...
class TestSmartkeysApi(unittest.TestCase):
    """SmartkeysApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SmartkeysApi()

    def tearDown(self) -> None:
        pass

    def test_get_smartkeys(self) -> None:
        """Test case for get_smartkeys

        List of Smartkeys
        """
        pass

    def test_post_smartkeys(self) -> None:
        """Test case for post_smartkeys
