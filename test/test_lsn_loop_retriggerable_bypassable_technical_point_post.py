...
class TestLSNLoopRetriggerableBypassableTechnicalPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopRetriggerableBypassableTechnicalPointPost:
        """Test LSNLoopRetriggerableBypassableTechnicalPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopRetriggerableBypassableTechnicalPointPost`
        """
        model = LSNLoopRetriggerableBypassableTechnicalPointPost()
        if include_optional:
            return LSNLoopRetriggerableBypassableTechnicalPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopRetriggerableBypassableTechnicalPointPost(self):
        """Test LSNLoopRetriggerableBypassableTechnicalPointPost"""
