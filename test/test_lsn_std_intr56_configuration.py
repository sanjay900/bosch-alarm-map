...
class TestLSNStdIntr56Configuration(unittest.TestCase):
    """LSNStdIntr56Configuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr56Configuration:
        """Test LSNStdIntr56Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr56Configuration`
        """
        model = LSNStdIntr56Configuration()
        if include_optional:
            return LSNStdIntr56Configuration(
                type = 'EMK36S',
                name = '[StdIntr56 LSN 1]',
    ...
    def testLSNStdIntr56Configuration(self):
        """Test LSNStdIntr56Configuration"""
