...
class TestPostAccessmodelRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostAccessmodelRequest:
        """Test PostAccessmodelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAccessmodelRequest`
        """
        model = PostAccessmodelRequest()
        if include_optional:
            return PostAccessmodelRequest(
                cmd = 'CREATE',
    ...
    def testPostAccessmodelRequest(self):
        """Test PostAccessmodelRequest"""
