...
class TestLsnbusSIIDApi(unittest.TestCase):
    """LsnbusSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LsnbusSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_lsnbus_siid(self) -> None:
        """Test case for get_lsnbus_siid

        Individual LSN Bus
        """
        pass

    def test_post_lsnbus_siid(self) -> None:
        """Test case for post_lsnbus_siid
