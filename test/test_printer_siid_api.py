...
class TestPrinterSIIDApi(unittest.TestCase):
    """PrinterSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PrinterSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_printer_siid(self) -> None:
        """Test case for get_printer_siid

        Printer of the MAP
        """
        pass

    def test_post_printer_siid(self) -> None:
        """Test case for post_printer_siid
