...
class TestPostSpecialdaymodelRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostSpecialdaymodelRequest:
        """Test PostSpecialdaymodelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSpecialdaymodelRequest`
        """
        model = PostSpecialdaymodelRequest()
        if include_optional:
            return PostSpecialdaymodelRequest(
                cmd = 'CREATE',
    ...
    def testPostSpecialdaymodelRequest(self):
        """Test PostSpecialdaymodelRequest"""
