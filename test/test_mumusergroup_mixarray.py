...
class TestMumusergroupMixarray(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MumusergroupMixarray:
        """Test MumusergroupMixarray
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MumusergroupMixarray`
        """
        model = MumusergroupMixarray()
        if include_optional:
            return MumusergroupMixarray(
    ...
    def testMumusergroupMixarray(self):
        """Test MumusergroupMixarray"""
