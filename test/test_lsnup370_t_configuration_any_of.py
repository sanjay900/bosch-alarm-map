...
class TestLSNUP370TConfigurationAnyOf(unittest.TestCase):
    """LSNUP370TConfigurationAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNUP370TConfigurationAnyOf:
        """Test LSNUP370TConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNUP370TConfigurationAnyOf`
        """
        model = LSNUP370TConfigurationAnyOf()
        if include_optional:
            return LSNUP370TConfigurationAnyOf(
                name = '[UP370T LSN 1]',
    ...
    def testLSNUP370TConfigurationAnyOf(self):
        """Test LSNUP370TConfigurationAnyOf"""
