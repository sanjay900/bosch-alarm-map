...
class TestAreaAndTimeModelSyncID(unittest.TestCase):
    """AreaAndTimeModelSyncID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaAndTimeModelSyncID:
        """Test AreaAndTimeModelSyncID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaAndTimeModelSyncID`
        """
        model = AreaAndTimeModelSyncID()
        if include_optional:
            return AreaAndTimeModelSyncID(
    ...
    def testAreaAndTimeModelSyncID(self):
        """Test AreaAndTimeModelSyncID"""
