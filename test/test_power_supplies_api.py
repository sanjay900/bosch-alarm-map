...
class TestPowerSuppliesApi(unittest.TestCase):
    """PowerSuppliesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PowerSuppliesApi()

    def tearDown(self) -> None:
        pass

    def test_get_powersupplies(self) -> None:
        """Test case for get_powersupplies

        List of all MAP power supplies
        """
        pass

    def test_post_powersupplies(self) -> None:
        """Test case for post_powersupplies
