...
class TestDEModuleSIIDApi(unittest.TestCase):
    """DEModuleSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DEModuleSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_de_module_siid(self) -> None:
        """Test case for get_de_module_siid

        DE Module of the MAP system
        """
        pass

    def test_post_de_module_siid(self) -> None:
        """Test case for post_de_module_siid
