...
class TestArmingInfoWhyNotReadyToForceArm(unittest.TestCase):
    """ArmingInfoWhyNotReadyToForceArm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArmingInfoWhyNotReadyToForceArm:
        """Test ArmingInfoWhyNotReadyToForceArm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArmingInfoWhyNotReadyToForceArm`
        """
        model = ArmingInfoWhyNotReadyToForceArm()
        if include_optional:
            return ArmingInfoWhyNotReadyToForceArm(
    ...
    def testArmingInfoWhyNotReadyToForceArm(self):
        """Test ArmingInfoWhyNotReadyToForceArm"""
