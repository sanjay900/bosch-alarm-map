...
class TestSmartkeyModelListAllOfListInner(unittest.TestCase):
    """SmartkeyModelListAllOfListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmartkeyModelListAllOfListInner:
        """Test SmartkeyModelListAllOfListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmartkeyModelListAllOfListInner`
        """
        model = SmartkeyModelListAllOfListInner()
        if include_optional:
            return SmartkeyModelListAllOfListInner(
                smartkey_model_id = 'Smartkey Access Profile 1',
                area_scope_list = [
                    'Control Panel Area'
                    ],
                arm_authority = 'CanArmAnyTime',
                disarm_authority = 'CanDisarm',
                time_model_used_for_disarming = '6 Days (No Sundays)'
            )
        else:
            return SmartkeyModelListAllOfListInner(
                smartkey_model_id = 'Smartkey Access Profile 1',
    ...
    def testSmartkeyModelListAllOfListInner(self):
        """Test SmartkeyModelListAllOfListInner"""
