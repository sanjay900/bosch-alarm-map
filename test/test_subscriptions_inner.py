...
class TestSubscriptionsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SubscriptionsInner:
        """Test SubscriptionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionsInner`
        """
        model = SubscriptionsInner()
        if include_optional:
            return SubscriptionsInner(
                urls = ["*"],
                event_type = ["CHANGED"]
            )
        else:
    ...
    def testSubscriptionsInner(self):
        """Test SubscriptionsInner"""
