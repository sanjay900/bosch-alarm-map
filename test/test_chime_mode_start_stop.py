...
class TestChimeModeStartStop(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChimeModeStartStop:
        """Test ChimeModeStartStop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChimeModeStartStop`
        """
        model = ChimeModeStartStop()
        if include_optional:
            return ChimeModeStartStop(
                cmd = 'STARTCHIMEMODE'
            )
        else:
            return ChimeModeStartStop(
    ...
    def testChimeModeStartStop(self):
        """Test ChimeModeStartStop"""
