...
class TestSub(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Sub:
        """Test Sub
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Sub`
        """
        model = Sub()
        if include_optional:
            return Sub(
                type = ["OII.sub.1"],
                var_self = '/sub/538D759E63DA4E64A687F58C22793435',
                lease_time = 10,
                buffer_size = 50,
                subscriptions = [
                    [
                        openapi_client.models.subscriptions_inner.subscriptions_inner(
                            urls = ["*"], 
                            event_type = ["CHANGED"], )
                        ]
                    ]
