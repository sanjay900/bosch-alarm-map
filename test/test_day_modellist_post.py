...
class TestDayModellistPost(unittest.TestCase):
    """DayModellistPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayModellistPost:
        """Test DayModellistPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayModellistPost`
        """
        model = DayModellistPost()
        if include_optional:
            return DayModellistPost(
                cmd = 'GETMODIFIEDLIST',
