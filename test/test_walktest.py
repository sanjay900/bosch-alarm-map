...
class TestWalktest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Walktest:
        """Test Walktest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Walktest`
        """
        model = Walktest()
        if include_optional:
            return Walktest(
                ...
                interface = '',
                wt = [
                    bosch_alarm_map.models.walktest_wt_inner.walktest_wt_inner(
                        area = '/1.1.Area.2.4', 
                        wt_status = 'PENDING', )
                    ]
            )
