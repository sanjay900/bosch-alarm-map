...
class TestLSNND100Configuration(unittest.TestCase):
    """LSNND100Configuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNND100Configuration:
        """Test LSNND100Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNND100Configuration`
        """
        model = LSNND100Configuration()
        if include_optional:
            return LSNND100Configuration(
                type = 'EMK36S',
                name = '[ND100 LSN 1]',
    ...
    def testLSNND100Configuration(self):
        """Test LSNND100Configuration"""
