...
class TestDeviceSIIDApi(unittest.TestCase):
    """DeviceSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DeviceSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_device_siid(self) -> None:
        """Test case for get_device_siid

        Individual device
        """
        pass

    def test_postdevice_siid(self) -> None:
        """Test case for postdevice_siid
