...
class TestKeypadSIIDApi(unittest.TestCase):
    """KeypadSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = KeypadSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_keypad_siid(self) -> None:
        """Test case for get_keypad_siid

        Individual keypad
        """
        pass

    def test_post_keypad_siid(self) -> None:
        """Test case for post_keypad_siid
