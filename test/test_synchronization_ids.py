...
class TestSynchronizationIDs(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SynchronizationIDs:
        """Test SynchronizationIDs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SynchronizationIDs`
        """
        model = SynchronizationIDs()
        if include_optional:
            return SynchronizationIDs(
                user_model_sync_id = 3245,
                day_model_sync_id = 458,
                time_model_sync_id = 354,
                special_day_model_sync_id = 324,
                area_and_time_model_sync_id = 145,
                smartkey_model_sync_id = 789,
                access_model_sync_id = 20,
                permission_model_sync_id = 156,
                mumusergroup_sync_id = 789,
                uptime = 3530,
                restart_counter = 4,
                master_key_checksum = '895a31c6',
                master_key_timestamp = '2023-04-28T15:59:18.482+03:00',
                shared_key_checksum = '44bcad15',
                shared_key_timestamp = '2023-04-27T14:32:21.432Z',
                allow_sending_user_dbif_armed = True
            )
        else:
            return SynchronizationIDs(
                user_model_sync_id = 3245,
    ...
    def testSynchronizationIDs(self):
        """Test SynchronizationIDs"""
