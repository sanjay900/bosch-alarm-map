...
class TestInfrastructureDeviceGenericProperty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InfrastructureDeviceGenericProperty:
        """Test InfrastructureDeviceGenericProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfrastructureDeviceGenericProperty`
        """
        model = InfrastructureDeviceGenericProperty()
        if include_optional:
            return InfrastructureDeviceGenericProperty(
                name = 'Interface type',
                value = 'Command',
    ...
    def testInfrastructureDeviceGenericProperty(self):
        """Test InfrastructureDeviceGenericProperty"""
