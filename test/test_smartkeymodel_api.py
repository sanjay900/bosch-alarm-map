...
class TestSmartkeymodelApi(unittest.TestCase):
    """SmartkeymodelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SmartkeymodelApi()

    def tearDown(self) -> None:
        pass

    def test_get_smartkeymodel(self) -> None:
        """Test case for get_smartkeymodel

        Get a specific Smartkey model from the MAP system
        """
        pass

    def test_post_smartkeymodel(self) -> None:
        """Test case for post_smartkeymodel
