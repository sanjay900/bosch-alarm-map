...
class TestArmingInfoWhyNotReadyToDisarm(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ArmingInfoWhyNotReadyToDisarm:
        """Test ArmingInfoWhyNotReadyToDisarm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArmingInfoWhyNotReadyToDisarm`
        """
        model = ArmingInfoWhyNotReadyToDisarm()
        if include_optional:
            return ArmingInfoWhyNotReadyToDisarm(
    ...
    def testArmingInfoWhyNotReadyToDisarm(self):
        """Test ArmingInfoWhyNotReadyToDisarm"""
