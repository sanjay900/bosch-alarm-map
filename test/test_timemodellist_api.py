...
class TestTimemodellistApi(unittest.TestCase):
    """TimemodellistApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TimemodellistApi()

    def tearDown(self) -> None:
        pass

    def test_get_timemodellist(self) -> None:
        """Test case for get_timemodellist

        Get all time models of the MAP system
        """
        pass

    def test_posttimemodellist(self) -> None:
        """Test case for posttimemodellist
