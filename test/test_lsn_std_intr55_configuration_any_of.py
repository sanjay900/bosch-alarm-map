...
class TestLSNStdIntr55ConfigurationAnyOf(unittest.TestCase):
    """LSNStdIntr55ConfigurationAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr55ConfigurationAnyOf:
        """Test LSNStdIntr55ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr55ConfigurationAnyOf`
        """
        model = LSNStdIntr55ConfigurationAnyOf()
        if include_optional:
            return LSNStdIntr55ConfigurationAnyOf(
    ...
    def testLSNStdIntr55ConfigurationAnyOf(self):
        """Test LSNStdIntr55ConfigurationAnyOf"""
