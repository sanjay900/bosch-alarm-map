...
class TestInc(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Inc:
        """Test Inc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Inc`
        """
        model = Inc()
        if include_optional:
            return Inc(
                ...
                var_self = '/inc/1.1.ControlPanelArea.1.1/7F5877B8B732405BA3A9EB28DE7D71DE',
                inc_type = '',
                ext_inc = True,
                time = '',
                handling_state = [
