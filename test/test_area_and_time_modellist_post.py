...
class TestAreaAndTimeModellistPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AreaAndTimeModellistPost:
        """Test AreaAndTimeModellistPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaAndTimeModellistPost`
        """
        model = AreaAndTimeModellistPost()
        if include_optional:
            return AreaAndTimeModellistPost(
                cmd = 'GETMODIFIEDLIST',
    ...
    def testAreaAndTimeModellistPost(self):
        """Test AreaAndTimeModellistPost"""
