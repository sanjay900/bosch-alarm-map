...
class TestStatisticsDbAllOfDatabasesPathToDatabaseCounters(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatisticsDbAllOfDatabasesPathToDatabaseCounters:
        """Test StatisticsDbAllOfDatabasesPathToDatabaseCounters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsDbAllOfDatabasesPathToDatabaseCounters`
        """
        model = StatisticsDbAllOfDatabasesPathToDatabaseCounters()
        if include_optional:
            return StatisticsDbAllOfDatabasesPathToDatabaseCounters(
                reads = 2752,
    ...
    def testStatisticsDbAllOfDatabasesPathToDatabaseCounters(self):
        """Test StatisticsDbAllOfDatabasesPathToDatabaseCounters"""
