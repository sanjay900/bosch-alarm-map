...
class TestDevicefirmwareVersion(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DevicefirmwareVersion:
        """Test DevicefirmwareVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevicefirmwareVersion`
        """
        model = DevicefirmwareVersion()
        if include_optional:
    ...
    def testDevicefirmwareVersion(self):
        """Test DevicefirmwareVersion"""
