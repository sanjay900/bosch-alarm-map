...
class TestSharedkeyApi(unittest.TestCase):
    """SharedkeyApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SharedkeyApi()

    def tearDown(self) -> None:
        pass

    def test_getsharedkey(self) -> None:
        """Test case for getsharedkey

        Get Shared Key
        """
        pass

    def test_postsharedkey(self) -> None:
        """Test case for postsharedkey
