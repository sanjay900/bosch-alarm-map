...
class TestSpecialDayModelList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SpecialDayModelList:
        """Test SpecialDayModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialDayModelList`
        """
        model = SpecialDayModelList()
        if include_optional:
            return SpecialDayModelList(
                special_day_model_sync_id = 324,
                list = [
                    bosch-alarm-map.models.special_day_model_list_all_of_list_inner.SpecialDayModelList_allOf_list_inner()
                    ]
            )
        else:
            return SpecialDayModelList(
    ...
    def testSpecialDayModelList(self):
        """Test SpecialDayModelList"""
