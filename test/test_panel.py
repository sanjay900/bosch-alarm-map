...
class TestPanel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Panel:
        """Test Panel
        ...
        if include_optional:
            return Panel(
                ...
                cfg_status = 'latest',
                last_cfg_updt = '2021-10-12T15:21:26.000+02:00',
                last_user_db_updt = '2021-08-02T19:50:54.000+02:00',
                is_panel_loaded = False,
                restart_imminent = False,
                firmware_version = '1.4.0240',
                model_name = 'MAP5000-COM',
                udn = '12345.12345678901',
                last_restart_reason = openapi_client.models.panel_last_restart_reason.panel_lastRestartReason(
                    value = 11006, 
                    description = 'Installer requested', 
                    time = '2021-08-04T19:01:38.000+02:00', ),
                meminfo = openapi_client.models.panel_meminfo.panel_meminfo(
                    mem_total = 126168, 
                    mem_free = 78912, 
                    buffers = 0, 
                    cached = 32836, 
                    ...
                    dirty = 0, 
                    writeback = 0, ),
                cpu_usage = openapi_client.models.panel_cpu_usage.panel_cpuUsage(
                    current = 1.2, 
                    averages = openapi_client.models.panel_cpu_usage_averages.panel_cpuUsage_averages(
                        1min = 3.34, 
                        5min = 4.31, 
                        30min = 2.33, ), ),
                disk = openapi_client.models.panel_disk.panel_disk(
                    total = 63984, 
                    free = 16692, 
                    usage = 47292, 
                    badblocks = 4, ),
                panel = openapi_client.models.panel_panel.panel_Panel(
                    vm_size = 44428, 
                    vm_rss = 26136, 
                    threads = 67, ),
                oii_sessions = openapi_client.models.panel_oii_sessions.panel_OIISessions(
