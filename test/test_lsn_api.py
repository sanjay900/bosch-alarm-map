...
class TestLsnApi(unittest.TestCase):
    """LsnApi unit test stubs"""
    ...
    def test_get_lsngw_config(self) -> None:
        """Test case for get_lsngw_config

        Get current LSN configuration
        """
        pass

    def test_post_lsngw_config(self) -> None:
        """Test case for post_lsngw_config
