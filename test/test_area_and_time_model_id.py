...
class TestAreaAndTimeModelID(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AreaAndTimeModelID:
        """Test AreaAndTimeModelID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaAndTimeModelID`
        """
        model = AreaAndTimeModelID()
        if include_optional:
            return AreaAndTimeModelID(
    ...
    def testAreaAndTimeModelID(self):
        """Test AreaAndTimeModelID"""
