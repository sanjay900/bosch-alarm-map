...
class TestGetAreaandtimemodel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAreaandtimemodel200Response:
        """Test GetAreaandtimemodel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAreaandtimemodel200Response`
        """
        model = GetAreaandtimemodel200Response()
        if include_optional:
            return GetAreaandtimemodel200Response(
    ...
    def testGetAreaandtimemodel200Response(self):
        """Test GetAreaandtimemodel200Response"""
