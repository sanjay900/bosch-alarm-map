...
class TestPanelCpuUsageAverages(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PanelCpuUsageAverages:
        """Test PanelCpuUsageAverages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PanelCpuUsageAverages`
        """
        model = PanelCpuUsageAverages()
        if include_optional:
            return PanelCpuUsageAverages(
                var_1min = 3.34,
                var_5min = 4.31,
                var_30min = 2.33
            )
    ...
    def testPanelCpuUsageAverages(self):
        """Test PanelCpuUsageAverages"""
