...
class TestGetSupervisedConnsSIID200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSupervisedConnsSIID200Response:
        """Test GetSupervisedConnsSIID200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSupervisedConnsSIID200Response`
        """
        model = GetSupervisedConnsSIID200Response()
        if include_optional:
            return GetSupervisedConnsSIID200Response(
                type = [
                    'IN.supervConn.1'
                    ],
                var_self = '',
    ...
    def testGetSupervisedConnsSIID200Response(self):
        """Test GetSupervisedConnsSIID200Response"""
