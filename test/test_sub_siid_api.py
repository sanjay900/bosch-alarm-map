...
class TestSubSIIDApi(unittest.TestCase):
    """SubSIIDApi unit test stubs"""
    ...
    def test_delete_sub_siid(self) -> None:
        """Test case for delete_sub_siid

        Unsubscribe
        """
        pass

    def test_get_sub_siid(self) -> None:
        """Test case for get_sub_siid

        Individual subscription resource
        """
        pass

    def test_post_sub_siid(self) -> None:
        """Test case for post_sub_siid
