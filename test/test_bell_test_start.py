...
class TestBellTestStart(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BellTestStart:
        """Test BellTestStart
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BellTestStart`
        """
        model = BellTestStart()
        if include_optional:
            return BellTestStart(
                cmd = 'BELLTEST'
            )
        else:
            return BellTestStart(
