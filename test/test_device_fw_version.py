...
class TestDeviceFwVersion(unittest.TestCase):
    """DeviceFwVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceFwVersion:
        """Test DeviceFwVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceFwVersion`
        """
        model = DeviceFwVersion()
        if include_optional:
