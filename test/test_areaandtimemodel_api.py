...
class TestAreaandtimemodelApi(unittest.TestCase):
    """AreaandtimemodelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AreaandtimemodelApi()

    def tearDown(self) -> None:
        pass

    def test_get_areaandtimemodel(self) -> None:
        """Test case for get_areaandtimemodel

        Get a specific area and time model from the MAP system
        """
        pass

    def test_post_areaandtimemodel(self) -> None:
        """Test case for post_areaandtimemodel
