...
class TestInternalProgramsConfiguration(unittest.TestCase):
    """InternalProgramsConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalProgramsConfiguration:
        """Test InternalProgramsConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalProgramsConfiguration`
        """
        model = InternalProgramsConfiguration()
        if include_optional:
            return InternalProgramsConfiguration(
    ...
    def testInternalProgramsConfiguration(self):
        """Test InternalProgramsConfiguration"""
