...
class TestTimeModelPeriodInDaysInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TimeModelPeriodInDaysInner:
        """Test TimeModelPeriodInDaysInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeModelPeriodInDaysInner`
        """
        model = TimeModelPeriodInDaysInner()
        if include_optional:
            return TimeModelPeriodInDaysInner(
                day_model_id = '',
                priority = 56
            )
        else:
    ...
    def testTimeModelPeriodInDaysInner(self):
        """Test TimeModelPeriodInDaysInner"""
