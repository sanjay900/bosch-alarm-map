...
class TestLSNGWAUXConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNGWAUXConfiguration:
        """Test LSNGWAUXConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNGWAUXConfiguration`
        """
        model = LSNGWAUXConfiguration()
        if include_optional:
            return LSNGWAUXConfiguration(
                name = '[LSN AUX 1]',
                reporting_number = 3,
    ...
    def testLSNGWAUXConfiguration(self):
        """Test LSNGWAUXConfiguration"""
