...
class TestLSNStdIntr53Configuration(unittest.TestCase):
    """LSNStdIntr53Configuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr53Configuration:
        """Test LSNStdIntr53Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr53Configuration`
        """
        model = LSNStdIntr53Configuration()
        if include_optional:
            return LSNStdIntr53Configuration(
                type = 'EMK36S',
    ...
    def testLSNStdIntr53Configuration(self):
        """Test LSNStdIntr53Configuration"""
