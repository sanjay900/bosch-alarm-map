...
class TestPostInterprogramSIIDRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostInterprogramSIIDRequest:
        """Test PostInterprogramSIIDRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostInterprogramSIIDRequest`
        """
        model = PostInterprogramSIIDRequest()
        if include_optional:
            return PostInterprogramSIIDRequest(
                cmd = 'IPARMINGINFO'
            )
        else:
            return PostInterprogramSIIDRequest(
    ...
    def testPostInterprogramSIIDRequest(self):
        """Test PostInterprogramSIIDRequest"""
