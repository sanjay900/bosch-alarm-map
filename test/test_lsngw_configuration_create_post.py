...
class TestLSNGWConfigurationCreatePost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNGWConfigurationCreatePost:
        """Test LSNGWConfigurationCreatePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNGWConfigurationCreatePost`
        """
        model = LSNGWConfigurationCreatePost()
        if include_optional:
            return LSNGWConfigurationCreatePost(
                connection = 'external',
                name = '[LSN GW 1]',
                area = '',
                ...
                consider_device_missing_as_alarm = True,
                consider_loop_failure_as_tamper_in_armed_condition = True,
    ...
    def testLSNGWConfigurationCreatePost(self):
        """Test LSNGWConfigurationCreatePost"""
