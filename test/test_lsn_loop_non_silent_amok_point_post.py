...
class TestLSNLoopNonSilentAmokPointPost(unittest.TestCase):
    """LSNLoopNonSilentAmokPointPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNLoopNonSilentAmokPointPost:
        """Test LSNLoopNonSilentAmokPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopNonSilentAmokPointPost`
        """
        model = LSNLoopNonSilentAmokPointPost()
        if include_optional:
            return LSNLoopNonSilentAmokPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopNonSilentAmokPointPost(self):
        """Test LSNLoopNonSilentAmokPointPost"""
