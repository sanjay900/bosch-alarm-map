...
class TestPermissionModelList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionModelList:
        """Test PermissionModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelList`
        """
        model = PermissionModelList()
        if include_optional:
            return PermissionModelList(
                permission_model_sync_id = 156,
                list = [
                    bosch_alarm_map.models.permission_model_list_all_of_list_inner.PermissionModelList_allOf_list_inner()
                    ]
            )
        else:
            return PermissionModelList(
    ...
    def testPermissionModelList(self):
        """Test PermissionModelList"""
