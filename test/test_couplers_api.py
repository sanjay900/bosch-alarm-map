...
class TestCouplersApi(unittest.TestCase):
    """CouplersApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CouplersApi()

    def tearDown(self) -> None:
        pass

    def test_get_couplers(self) -> None:
        """Test case for get_couplers

        List of couplers in the MAP system
        """
        pass

    def test_post_couplers(self) -> None:
        """Test case for post_couplers
