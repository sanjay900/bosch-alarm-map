...
class TestUserModelSyncID(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserModelSyncID:
        """Test UserModelSyncID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserModelSyncID`
        """
        model = UserModelSyncID()
        if include_optional:
            return UserModelSyncID(
