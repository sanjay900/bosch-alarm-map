...
class TestAreaAndTimeModelListAllOfListInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AreaAndTimeModelListAllOfListInner:
        """Test AreaAndTimeModelListAllOfListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaAndTimeModelListAllOfListInner`
        """
        model = AreaAndTimeModelListAllOfListInner()
        if include_optional:
            return AreaAndTimeModelListAllOfListInner(
    ...
    def testAreaAndTimeModelListAllOfListInner(self):
        """Test AreaAndTimeModelListAllOfListInner"""
