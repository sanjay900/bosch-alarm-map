...
class TestStatisticsDbAllOfDatabases(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatisticsDbAllOfDatabases:
        """Test StatisticsDbAllOfDatabases
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsDbAllOfDatabases`
        """
        model = StatisticsDbAllOfDatabases()
        if include_optional:
            return StatisticsDbAllOfDatabases(
                path_to_database = bosch_alarm_map.models.statistics_db_all_of_databases_path_to_database.statistics_db_allOf_databases_path_to_database(
                    size_kb = 512, 
    ...
    def testStatisticsDbAllOfDatabases(self):
        """Test StatisticsDbAllOfDatabases"""
