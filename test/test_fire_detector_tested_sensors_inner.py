...
class TestFireDetectorTestedSensorsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FireDetectorTestedSensorsInner:
        """Test FireDetectorTestedSensorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FireDetectorTestedSensorsInner`
        """
        model = FireDetectorTestedSensorsInner()
        if include_optional:
            return FireDetectorTestedSensorsInner(
                type = 'o',
                tested = True
            )
        else:
    ...
    def testFireDetectorTestedSensorsInner(self):
        """Test FireDetectorTestedSensorsInner"""
