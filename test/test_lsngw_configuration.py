...
class TestLSNGWConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNGWConfiguration:
        """Test LSNGWConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNGWConfiguration`
        """
        model = LSNGWConfiguration()
        if include_optional:
            return LSNGWConfiguration(
                connection = 'external',
                name = '[LSN GW 1]',
                area = '',
    ...
    def testLSNGWConfiguration(self):
        """Test LSNGWConfiguration"""
