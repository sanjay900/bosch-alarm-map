...
class TestPermissionModelEventCategoryPermissions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionModelEventCategoryPermissions:
        """Test PermissionModelEventCategoryPermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelEventCategoryPermissions`
        """
        model = PermissionModelEventCategoryPermissions()
        if include_optional:
            return PermissionModelEventCategoryPermissions(
    ...
    def testPermissionModelEventCategoryPermissions(self):
        """Test PermissionModelEventCategoryPermissions"""
