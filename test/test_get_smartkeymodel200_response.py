...
class TestGetSmartkeymodel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSmartkeymodel200Response:
        """Test GetSmartkeymodel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSmartkeymodel200Response`
        """
        model = GetSmartkeymodel200Response()
        if include_optional:
            return GetSmartkeymodel200Response(
    ...
    def testGetSmartkeymodel200Response(self):
        """Test GetSmartkeymodel200Response"""
