...
class TestPostDayModelRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostDayModelRequest:
        """Test PostDayModelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostDayModelRequest`
        """
        model = PostDayModelRequest()
        if include_optional:
            return PostDayModelRequest(
                cmd = 'CREATE',
    ...
    def testPostDayModelRequest(self):
        """Test PostDayModelRequest"""
