...
class TestLSNGWLoopConfiguration(unittest.TestCase):
    """LSNGWLoopConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNGWLoopConfiguration:
        """Test LSNGWLoopConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNGWLoopConfiguration`
        """
        model = LSNGWLoopConfiguration()
        if include_optional:
            return LSNGWLoopConfiguration(
                name = '[LSN Loop 1]',
                devices = [
                    null
                    ]
    ...
    def testLSNGWLoopConfiguration(self):
        """Test LSNGWLoopConfiguration"""
