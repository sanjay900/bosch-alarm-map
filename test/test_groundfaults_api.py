...
class TestGroundfaultsApi(unittest.TestCase):
    """GroundfaultsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GroundfaultsApi()

    def tearDown(self) -> None:
        pass

    def test_get_groundfaults(self) -> None:
        """Test case for get_groundfaults

        List of resources representing the ground faults of a power supply in the MAP system
        """
        pass

    def test_post_groundfaults(self) -> None:
        """Test case for post_groundfaults
