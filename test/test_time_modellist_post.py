...
class TestTimeModellistPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TimeModellistPost:
        """Test TimeModellistPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeModellistPost`
        """
        model = TimeModellistPost()
        if include_optional:
            return TimeModellistPost(
                cmd = 'GETMODIFIEDLIST',
    ...
    def testTimeModellistPost(self):
        """Test TimeModellistPost"""
