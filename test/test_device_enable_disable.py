...
class TestDeviceEnableDisable(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeviceEnableDisable:
        """Test DeviceEnableDisable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceEnableDisable`
        """
        model = DeviceEnableDisable()
        if include_optional:
    ...
    def testDeviceEnableDisable(self):
        """Test DeviceEnableDisable"""
