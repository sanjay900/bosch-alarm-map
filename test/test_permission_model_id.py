...
class TestPermissionModelID(unittest.TestCase):
    """PermissionModelID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionModelID:
        """Test PermissionModelID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelID`
        """
    ...
    def testPermissionModelID(self):
        """Test PermissionModelID"""
