...
class TestDevicesList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DevicesList:
        """Test DevicesList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevicesList`
        """
        model = DevicesList()
        if include_optional:
            return DevicesList(
                ...
                var_self = '',
                list = [
                    bosch_alarm_map.models.device.device(
                        @type = [
                            'IN.dev.1'
                            ], 
                        @self = '', 
