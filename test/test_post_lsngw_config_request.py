...
class TestPostLSNGWConfigRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostLSNGWConfigRequest:
        """Test PostLSNGWConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostLSNGWConfigRequest`
        """
        model = PostLSNGWConfigRequest()
        if include_optional:
            return PostLSNGWConfigRequest(
                cmd = 'DELETE',
                connection = 'external',
                name = '[LSN GW 1]',
                area = '',
    ...
    def testPostLSNGWConfigRequest(self):
        """Test PostLSNGWConfigRequest"""
