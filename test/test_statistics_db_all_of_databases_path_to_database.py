...
class TestStatisticsDbAllOfDatabasesPathToDatabase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatisticsDbAllOfDatabasesPathToDatabase:
        """Test StatisticsDbAllOfDatabasesPathToDatabase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsDbAllOfDatabasesPathToDatabase`
        """
        model = StatisticsDbAllOfDatabasesPathToDatabase()
        if include_optional:
    ...
    def testStatisticsDbAllOfDatabasesPathToDatabase(self):
        """Test StatisticsDbAllOfDatabasesPathToDatabase"""
