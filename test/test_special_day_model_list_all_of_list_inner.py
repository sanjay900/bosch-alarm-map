...
class TestSpecialDayModelListAllOfListInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SpecialDayModelListAllOfListInner:
        """Test SpecialDayModelListAllOfListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialDayModelListAllOfListInner`
        """
        model = SpecialDayModelListAllOfListInner()
        if include_optional:
            return SpecialDayModelListAllOfListInner(
    ...
    def testSpecialDayModelListAllOfListInner(self):
        """Test SpecialDayModelListAllOfListInner"""
