...
class TestDayModelSyncID(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DayModelSyncID:
        """Test DayModelSyncID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayModelSyncID`
        """
        model = DayModelSyncID()
        if include_optional:
            return DayModelSyncID(
