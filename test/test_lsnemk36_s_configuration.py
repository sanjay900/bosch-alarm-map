...
class TestLSNEMK36SConfiguration(unittest.TestCase):
    """LSNEMK36SConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNEMK36SConfiguration:
        """Test LSNEMK36SConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNEMK36SConfiguration`
        """
        model = LSNEMK36SConfiguration()
        if include_optional:
            return LSNEMK36SConfiguration(
                type = 'EMK36S',
                name = '[EMK36 LSN 1]',
    ...
    def testLSNEMK36SConfiguration(self):
        """Test LSNEMK36SConfiguration"""
