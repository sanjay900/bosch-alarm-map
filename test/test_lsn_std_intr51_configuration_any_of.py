...
class TestLSNStdIntr51ConfigurationAnyOf(unittest.TestCase):
    """LSNStdIntr51ConfigurationAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr51ConfigurationAnyOf:
        """Test LSNStdIntr51ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr51ConfigurationAnyOf`
        """
        model = LSNStdIntr51ConfigurationAnyOf()
        if include_optional:
            return LSNStdIntr51ConfigurationAnyOf(
                name = '[StdIntr51 LSN 1]',
    ...
    def testLSNStdIntr51ConfigurationAnyOf(self):
        """Test LSNStdIntr51ConfigurationAnyOf"""
