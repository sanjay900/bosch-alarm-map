...
class TestBlocklockSIIDApi(unittest.TestCase):
    """BlocklockSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BlocklockSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_blocklock_siid(self) -> None:
        """Test case for get_blocklock_siid

        Individual blocklock device
        """
        pass

    def test_post_blocklock_siid(self) -> None:
        """Test case for post_blocklock_siid
