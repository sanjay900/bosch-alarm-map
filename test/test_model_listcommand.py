...
class TestModelListcommand(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModelListcommand:
        """Test ModelListcommand
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelListcommand`
        """
        model = ModelListcommand()
        if include_optional:
