...
class TestPermissionModelMaintenanceCategoryPermissions(unittest.TestCase):
    """PermissionModelMaintenanceCategoryPermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionModelMaintenanceCategoryPermissions:
        """Test PermissionModelMaintenanceCategoryPermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelMaintenanceCategoryPermissions`
        """
        model = PermissionModelMaintenanceCategoryPermissions()
        if include_optional:
            return PermissionModelMaintenanceCategoryPermissions(
                may_adjust_control_center_volume_backlight = True,
    ...
    def testPermissionModelMaintenanceCategoryPermissions(self):
        """Test PermissionModelMaintenanceCategoryPermissions"""
