...
class TestWalktestsApi(unittest.TestCase):
    """WalktestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = WalktestsApi()

    def tearDown(self) -> None:
        pass

    def test_delete_walktests(self) -> None:
        """Test case for delete_walktests

        Stop all Walktests
        """
        pass

    def test_get_walktests(self) -> None:
        """Test case for get_walktests
