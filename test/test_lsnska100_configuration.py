...
class TestLSNSKA100Configuration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNSKA100Configuration:
        """Test LSNSKA100Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNSKA100Configuration`
        """
        model = LSNSKA100Configuration()
        if include_optional:
            return LSNSKA100Configuration(
                type = 'EMK36S',
                name = '[SKA100 LSN 1]',
    ...
    def testLSNSKA100Configuration(self):
        """Test LSNSKA100Configuration"""
