...
class TestSyncstatusKeysData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SyncstatusKeysData:
        """Test SyncstatusKeysData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncstatusKeysData`
        """
        model = SyncstatusKeysData()
        if include_optional:
            return SyncstatusKeysData(
    ...
    def testSyncstatusKeysData(self):
        """Test SyncstatusKeysData"""
