...
class TestPermissionModelSyncID(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionModelSyncID:
        """Test PermissionModelSyncID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelSyncID`
        """
        model = PermissionModelSyncID()
        if include_optional:
            return PermissionModelSyncID(
    ...
    def testPermissionModelSyncID(self):
        """Test PermissionModelSyncID"""
