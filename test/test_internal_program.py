...
class TestInternalProgram(unittest.TestCase):
    """InternalProgram unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalProgram:
        """Test InternalProgram
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalProgram`
        """
        model = InternalProgram()
        if include_optional:
            return InternalProgram(
                type = [
                    'IN.internalProgram.1'
                    ],
                var_self = '/internalprogram/1',
                active = True
            )
        else:
            return InternalProgram(
