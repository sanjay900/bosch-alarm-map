...
class TestSupervisedConnsSIIDApi(unittest.TestCase):
    """SupervisedConnsSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SupervisedConnsSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_supervised_conns_siid(self) -> None:
        """Test case for get_supervised_conns_siid

        Individual supervised connection
        """
        pass

    def test_post_supervised_conns(self) -> None:
        """Test case for post_supervised_conns
