...
class TestUsermodellistApi(unittest.TestCase):
    """UsermodellistApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UsermodellistApi()

    def tearDown(self) -> None:
        pass

    def test_get_usermodellist(self) -> None:
        """Test case for get_usermodellist

        Get a list of all users
        """
        pass

    def test_post_usermodellist(self) -> None:
        """Test case for post_usermodellist
