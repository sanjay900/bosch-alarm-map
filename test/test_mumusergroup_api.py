...
class TestMumusergroupApi(unittest.TestCase):
    """MumusergroupApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MumusergroupApi()

    def tearDown(self) -> None:
        pass

    def test_getmumusergroup(self) -> None:
        """Test case for getmumusergroup

        Get MUM property for all User IDs
        """
        pass

    def test_postmumusergroup(self) -> None:
        """Test case for postmumusergroup
