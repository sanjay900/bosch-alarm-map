...
class TestNtpPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NtpPost:
        """Test NtpPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NtpPost`
        """
        model = NtpPost()
        if include_optional:
            return NtpPost(
                public = False,
                custom = ["time1.myorganization.com:123","time2.myorganization.com:123"]
            )
        else:
            return NtpPost(
        )
