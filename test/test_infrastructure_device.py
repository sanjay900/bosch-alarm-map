...
class TestInfrastructureDevice(unittest.TestCase):
    """InfrastructureDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InfrastructureDevice:
        """Test InfrastructureDevice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfrastructureDevice`
        """
        ...
        if include_optional:
            return InfrastructureDevice(
                ...
                properties = bosch_alarm_map.models.infrastructure_device_properties.InfrastructureDevice_properties(
                    generic = [
                ...
                devices = [
                    bosch_alarm_map.models.infrastructure_device.InfrastructureDevice(
                        name = '[Control Center 1]', 
                        type = 'System Keypad', 
                        siid = '1.1.SystemKeypad.12001.001', 
                        properties = bosch_alarm_map.models.infrastructure_device_properties.InfrastructureDevice_properties(
    ...
    def testInfrastructureDevice(self):
        """Test InfrastructureDevice"""
