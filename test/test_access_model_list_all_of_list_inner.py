...
class TestAccessModelListAllOfListInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccessModelListAllOfListInner:
        """Test AccessModelListAllOfListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessModelListAllOfListInner`
        """
        model = AccessModelListAllOfListInner()
        if include_optional:
            return AccessModelListAllOfListInner(
                access_model_id = 'Installer Profile',
                access_profile_level = 4,
                area_and_time_model_list = [Installer Model, Owner/Facility Manager Model]
            )
        else:
            return AccessModelListAllOfListInner(
                access_model_id = 'Installer Profile',
    ...
    def testAccessModelListAllOfListInner(self):
        """Test AccessModelListAllOfListInner"""
