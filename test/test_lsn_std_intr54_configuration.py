...
class TestLSNStdIntr54Configuration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNStdIntr54Configuration:
        """Test LSNStdIntr54Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr54Configuration`
        """
        model = LSNStdIntr54Configuration()
        if include_optional:
            return LSNStdIntr54Configuration(
                type = 'EMK36S',
    ...
    def testLSNStdIntr54Configuration(self):
        """Test LSNStdIntr54Configuration"""
