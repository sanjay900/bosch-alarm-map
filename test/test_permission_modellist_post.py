...
class TestPermissionModellistPost(unittest.TestCase):
    """PermissionModellistPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionModellistPost:
        """Test PermissionModellistPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModellistPost`
        """
        model = PermissionModellistPost()
        if include_optional:
            return PermissionModellistPost(
                cmd = 'GETMODIFIEDLIST',
    ...
    def testPermissionModellistPost(self):
        """Test PermissionModellistPost"""
