...
class TestLSNGWLoopConfigurationDevicesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNGWLoopConfigurationDevicesInner:
        """Test LSNGWLoopConfigurationDevicesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNGWLoopConfigurationDevicesInner`
        """
        model = LSNGWLoopConfigurationDevicesInner()
        if include_optional:
            return LSNGWLoopConfigurationDevicesInner(
                type = 'EMK36S',
                name = '[UP370T LSN 1]',
                ...
                reporting_number = 3,
                ignore_magnetic_supervision = False,
                loop_current_index = 1,
                sensitivity = 'Level 4',
                antimask_detection = True,
                antimask_latched = True,
                antimask_sensitivity = 'Standard',
                pir_mode = True,
                sensitivity_detection_range = 'Medium - 10 Meter'
            )
        else:
            return LSNGWLoopConfigurationDevicesInner(
                type = 'EMK36S',
    ...
    def testLSNGWLoopConfigurationDevicesInner(self):
        """Test LSNGWLoopConfigurationDevicesInner"""
