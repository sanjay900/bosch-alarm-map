...
class TestLSNGWConfigurationDeletePost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNGWConfigurationDeletePost:
        """Test LSNGWConfigurationDeletePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNGWConfigurationDeletePost`
        """
        model = LSNGWConfigurationDeletePost()
        if include_optional:
            return LSNGWConfigurationDeletePost(
                cmd = 'DELETE',
    ...
    def testLSNGWConfigurationDeletePost(self):
        """Test LSNGWConfigurationDeletePost"""
