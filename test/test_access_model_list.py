...
class TestAccessModelList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccessModelList:
        """Test AccessModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessModelList`
        """
        model = AccessModelList()
        if include_optional:
            return AccessModelList(
                access_model_sync_id = 20,
                list = [
                    openapi_client.models.access_model_list_all_of_list_inner.AccessModelList_allOf_list_inner()
                    ]
            )
        else:
            return AccessModelList(
