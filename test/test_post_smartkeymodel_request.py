...
class TestPostSmartkeymodelRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostSmartkeymodelRequest:
        """Test PostSmartkeymodelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSmartkeymodelRequest`
        """
        model = PostSmartkeymodelRequest()
        if include_optional:
            return PostSmartkeymodelRequest(
                cmd = 'CREATE',
    ...
    def testPostSmartkeymodelRequest(self):
        """Test PostSmartkeymodelRequest"""
