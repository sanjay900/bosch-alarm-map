...
class TestLSNEMK36ConfigurationAnyOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNEMK36ConfigurationAnyOf:
        """Test LSNEMK36ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNEMK36ConfigurationAnyOf`
        """
        model = LSNEMK36ConfigurationAnyOf()
        if include_optional:
            return LSNEMK36ConfigurationAnyOf(
                name = '[EMK36 LSN 1]',
    ...
    def testLSNEMK36ConfigurationAnyOf(self):
        """Test LSNEMK36ConfigurationAnyOf"""
