...
class TestStatisticsOiiAllOfClientsInner(unittest.TestCase):
    """StatisticsOiiAllOfClientsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatisticsOiiAllOfClientsInner:
        """Test StatisticsOiiAllOfClientsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsOiiAllOfClientsInner`
        """
        model = StatisticsOiiAllOfClientsInner()
        if include_optional:
            return StatisticsOiiAllOfClientsInner(
                start = '2023-07-07T14:00:00+02:00',
                last = '2023-08-14T11:00:00+02:00',
                duration = '07:05:56',
                interval = '00:31:56.033',
                delay = 'min=00:00:00.001, avg=00:00:00.004, max=00:00:01.108',
                requests = 330,
                responses = 329,
                positive = 234,
                negative = 95
    ...
    def testStatisticsOiiAllOfClientsInner(self):
        """Test StatisticsOiiAllOfClientsInner"""
