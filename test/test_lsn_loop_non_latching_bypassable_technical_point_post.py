...
class TestLSNLoopNonLatchingBypassableTechnicalPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopNonLatchingBypassableTechnicalPointPost:
        """Test LSNLoopNonLatchingBypassableTechnicalPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopNonLatchingBypassableTechnicalPointPost`
        """
        model = LSNLoopNonLatchingBypassableTechnicalPointPost()
        if include_optional:
            return LSNLoopNonLatchingBypassableTechnicalPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopNonLatchingBypassableTechnicalPointPost(self):
        """Test LSNLoopNonLatchingBypassableTechnicalPointPost"""
