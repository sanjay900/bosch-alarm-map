...
class TestLsnGatewayList(unittest.TestCase):
    """LsnGatewayList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LsnGatewayList:
        """Test LsnGatewayList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LsnGatewayList`
        """
        model = LsnGatewayList()
        if include_optional:
            return LsnGatewayList(
                type = [
                    'IN.lsnGwList.1'
                    ],
                var_self = '',
