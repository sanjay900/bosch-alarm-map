...
class TestAreaPostResponses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AreaPostResponses:
        """Test AreaPostResponses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaPostResponses`
        """
        model = AreaPostResponses()
        if include_optional:
            return AreaPostResponses(
                type = [
                    ''
                    ],
                var_self = '',
                ...
                number_of_bypassed_devices = 0,
                walktest = '/walktest/1',
                motion_detector_test_active = True,
                chime_mode_active = True,
                incs = [
                    ''
                    ],
                ...
                why_not_ready_to_force_arm = openapi_client.models.arming_info_why_not_ready_to_force_arm.armingInfo_whyNotReadyToForceArm(
                    ...
                    too_many_faulted_devices = [
                        ''
                        ], 
                    too_many_bypassed_devices = True, 
                    devices_bypassed_too_many_times = [
                        ''
                        ], 
                    system_wide_devices_faulted = [
                        ''
                        ], 
                    related_areas_not_ready_to_arm = [
                        ''
                        ], 
                    related_areas_must_be_armed_first = [
                        ''
                        ], 
                ...
                why_not_ready_to_disarm = openapi_client.models.arming_info_why_not_ready_to_disarm.armingInfo_whyNotReadyToDisarm(
                    ...
                    related_areas_must_be_disarmed_first = [
                        ''
                        ], 
                    virtual_outputs_off_prevents_disarming = [
                        ''
                        ], 
                    active_blocking_time_prevents_disarming = True, )
            )
        else:
            return AreaPostResponses(
        )
    ...
    def testAreaPostResponses(self):
        """Test AreaPostResponses"""
