...
class TestSupervisedConnsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupervisedConnsList:
        """Test SupervisedConnsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupervisedConnsList`
        """
        model = SupervisedConnsList()
        if include_optional:
            return SupervisedConnsList(
                type = [
                    'IN.supervConnList.1'
                    ],
                var_self = '',
    ...
    def testSupervisedConnsList(self):
        """Test SupervisedConnsList"""
