...
class TestSmartkeymodellistApi(unittest.TestCase):
    """SmartkeymodellistApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SmartkeymodellistApi()

    def tearDown(self) -> None:
        pass

    def test_get_smartkeymodellist(self) -> None:
        """Test case for get_smartkeymodellist

        Get all Smartkey models of the MAP system
        """
        pass

    def test_post_smartkeymodellist(self) -> None:
        """Test case for post_smartkeymodellist
