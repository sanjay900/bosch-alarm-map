...
class TestLSNStdIntr52ConfigurationAnyOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNStdIntr52ConfigurationAnyOf:
        """Test LSNStdIntr52ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr52ConfigurationAnyOf`
        """
        model = LSNStdIntr52ConfigurationAnyOf()
        if include_optional:
            return LSNStdIntr52ConfigurationAnyOf(
    ...
    def testLSNStdIntr52ConfigurationAnyOf(self):
        """Test LSNStdIntr52ConfigurationAnyOf"""
