...
class TestLsnGatewaySIIDApi(unittest.TestCase):
    """LsnGatewaySIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LsnGatewaySIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_lsn_gateway_siid(self) -> None:
        """Test case for get_lsn_gateway_siid

        Individual LSN gateway
        """
        pass

    def test_postlsn_gateway_siid(self) -> None:
        """Test case for postlsn_gateway_siid
