...
class TestTimeModelListAllOfListInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TimeModelListAllOfListInner:
        """Test TimeModelListAllOfListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeModelListAllOfListInner`
        """
        model = TimeModelListAllOfListInner()
        if include_optional:
            return TimeModelListAllOfListInner(
                time_model_id = '6 Days (No Sundays)',
                reference_date = '2011-10-11',
                ignore_special_days = True,
                period_in_days = [{dayModelID=Normal Work Day, priority=1}, {dayModelID=Normal Work Day, priority=1}, {dayModelID=Normal Work Day, priority=1}, {dayModelID=Normal Work Day, priority=1}, {dayModelID=Friday Work Day, priority=1}, {dayModelID=Saturday Work Day, priority=1}, {dayModelID=No Access, priority=1}],
                special_days = [New Year's Day, Labour Day]
            )
        else:
            return TimeModelListAllOfListInner(
                time_model_id = '6 Days (No Sundays)',
    ...
    def testTimeModelListAllOfListInner(self):
        """Test TimeModelListAllOfListInner"""
