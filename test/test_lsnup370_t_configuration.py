...
class TestLSNUP370TConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNUP370TConfiguration:
        """Test LSNUP370TConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNUP370TConfiguration`
        """
        model = LSNUP370TConfiguration()
        if include_optional:
            return LSNUP370TConfiguration(
                type = 'EMK36S',
                name = '[UP370T LSN 1]',
    ...
    def testLSNUP370TConfiguration(self):
        """Test LSNUP370TConfiguration"""
