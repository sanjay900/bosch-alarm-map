...
class TestPostKeypadsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostKeypadsRequest:
        """Test PostKeypadsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostKeypadsRequest`
        """
        model = PostKeypadsRequest()
        if include_optional:
            return PostKeypadsRequest(
                cmd = 'ACTIVATE'
            )
        else:
            return PostKeypadsRequest(
    ...
    def testPostKeypadsRequest(self):
        """Test PostKeypadsRequest"""
