...
class TestMumusergroupSyncID(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MumusergroupSyncID:
        """Test MumusergroupSyncID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MumusergroupSyncID`
        """
        model = MumusergroupSyncID()
        if include_optional:
            return MumusergroupSyncID(
    ...
    def testMumusergroupSyncID(self):
        """Test MumusergroupSyncID"""
