...
class TestNtpGet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NtpGet:
        """Test NtpGet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NtpGet`
        """
        model = NtpGet()
        if include_optional:
            return NtpGet(
                ...
                resync = 30240,
                public = bosch_alarm_map.models.ntp_get_public.ntp_get_public(
                    enabled = False, 
                    servers = ["time1.example.com:123","time2.example.com:123","time3.example.com:123","time4.example.com:123","time5.example.com:123"], ),
                custom = bosch_alarm_map.models.ntp_get_custom.ntp_get_custom(
                    enabled = True, 
