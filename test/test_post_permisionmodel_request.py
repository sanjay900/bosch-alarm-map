...
class TestPostPermisionmodelRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostPermisionmodelRequest:
        """Test PostPermisionmodelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPermisionmodelRequest`
        """
        model = PostPermisionmodelRequest()
        if include_optional:
    ...
    def testPostPermisionmodelRequest(self):
        """Test PostPermisionmodelRequest"""
