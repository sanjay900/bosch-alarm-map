...
class TestFireDetectorsApi(unittest.TestCase):
    """FireDetectorsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = FireDetectorsApi()

    def tearDown(self) -> None:
        pass

    def test_getfire_detectors(self) -> None:
        """Test case for getfire_detectors

        List of fire detectors in the MAP system
        """
        pass

    def test_postfire_detectors(self) -> None:
        """Test case for postfire_detectors
