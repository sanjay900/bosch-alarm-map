...
class TestPermissionModelOperationsCategoryPermissions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionModelOperationsCategoryPermissions:
        """Test PermissionModelOperationsCategoryPermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelOperationsCategoryPermissions`
        """
        model = PermissionModelOperationsCategoryPermissions()
        if include_optional:
            return PermissionModelOperationsCategoryPermissions(
                may_disable_device = True,
                may_enable_device = True,
                may_turn_chime_on_off = True,
    ...
    def testPermissionModelOperationsCategoryPermissions(self):
        """Test PermissionModelOperationsCategoryPermissions"""
