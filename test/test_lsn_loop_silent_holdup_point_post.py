...
class TestLSNLoopSilentHoldupPointPost(unittest.TestCase):
    """LSNLoopSilentHoldupPointPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNLoopSilentHoldupPointPost:
        """Test LSNLoopSilentHoldupPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopSilentHoldupPointPost`
        """
        model = LSNLoopSilentHoldupPointPost()
        if include_optional:
            return LSNLoopSilentHoldupPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopSilentHoldupPointPost(self):
        """Test LSNLoopSilentHoldupPointPost"""
