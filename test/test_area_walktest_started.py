...
class TestAreaWalktestStarted(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AreaWalktestStarted:
        """Test AreaWalktestStarted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaWalktestStarted`
        """
        model = AreaWalktestStarted()
        if include_optional:
            return AreaWalktestStarted(
                walktest = '/walktest/1'
            )
        else:
            return AreaWalktestStarted(
    ...
    def testAreaWalktestStarted(self):
        """Test AreaWalktestStarted"""
