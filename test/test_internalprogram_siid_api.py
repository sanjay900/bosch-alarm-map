...
class TestInternalprogramSIIDApi(unittest.TestCase):
    """InternalprogramSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InternalprogramSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_internalprogram_siid(self) -> None:
        """Test case for get_internalprogram_siid

        Individual internal program (1 to 14).
        """
        pass

    def test_post_interprogram_siid(self) -> None:
        """Test case for post_interprogram_siid
