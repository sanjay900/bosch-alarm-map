...
class TestPowerSupplySIIDApi(unittest.TestCase):
    """PowerSupplySIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PowerSupplySIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_posersupply_siid(self) -> None:
        """Test case for get_posersupply_siid

        Individual powersupply
        """
        pass

    def test_post_powersupply_siid(self) -> None:
        """Test case for post_powersupply_siid
