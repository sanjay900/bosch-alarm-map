...
class TestAccessmodellistApi(unittest.TestCase):
    """AccessmodellistApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AccessmodellistApi()

    def tearDown(self) -> None:
        pass

    def test_get_accessmodellist(self) -> None:
        """Test case for get_accessmodellist

        Get all access models of the MAP system
        """
        pass

    def test_postaccessmodellist(self) -> None:
        """Test case for postaccessmodellist
