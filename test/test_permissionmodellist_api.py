...
class TestPermissionmodellistApi(unittest.TestCase):
    """PermissionmodellistApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PermissionmodellistApi()

    def tearDown(self) -> None:
        pass

    def test_get_permissionmodellist(self) -> None:
        """Test case for get_permissionmodellist

        Get all permission models of the MAP system
        """
        pass

    def test_postpermissionmodellist(self) -> None:
        """Test case for postpermissionmodellist
