...
class TestBatterychargerList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatterychargerList:
        """Test BatterychargerList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatterychargerList`
        """
        model = BatterychargerList()
        if include_optional:
            return BatterychargerList(
                type = [
                    'IN.batChgList.1'
                    ],
                var_self = '',
    ...
    def testBatterychargerList(self):
        """Test BatterychargerList"""
