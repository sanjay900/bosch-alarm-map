...
class TestInfrastructureDeviceRPSProperty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InfrastructureDeviceRPSProperty:
        """Test InfrastructureDeviceRPSProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfrastructureDeviceRPSProperty`
        """
        model = InfrastructureDeviceRPSProperty()
        if include_optional:
            return InfrastructureDeviceRPSProperty(
    ...
    def testInfrastructureDeviceRPSProperty(self):
        """Test InfrastructureDeviceRPSProperty"""
