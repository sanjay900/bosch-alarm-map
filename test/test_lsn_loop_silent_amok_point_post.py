...
class TestLSNLoopSilentAmokPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopSilentAmokPointPost:
        """Test LSNLoopSilentAmokPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopSilentAmokPointPost`
        """
        model = LSNLoopSilentAmokPointPost()
        if include_optional:
            return LSNLoopSilentAmokPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopSilentAmokPointPost(self):
        """Test LSNLoopSilentAmokPointPost"""
