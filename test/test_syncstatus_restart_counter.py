...
class TestSyncstatusRestartCounter(unittest.TestCase):
    """SyncstatusRestartCounter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncstatusRestartCounter:
        """Test SyncstatusRestartCounter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncstatusRestartCounter`
        """
        model = SyncstatusRestartCounter()
        if include_optional:
            return SyncstatusRestartCounter(
                restart_counter = 4
            )
        else:
            return SyncstatusRestartCounter(
    ...
    def testSyncstatusRestartCounter(self):
        """Test SyncstatusRestartCounter"""
