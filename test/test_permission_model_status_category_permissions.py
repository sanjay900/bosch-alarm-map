...
class TestPermissionModelStatusCategoryPermissions(unittest.TestCase):
    """PermissionModelStatusCategoryPermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionModelStatusCategoryPermissions:
        """Test PermissionModelStatusCategoryPermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelStatusCategoryPermissions`
        """
        model = PermissionModelStatusCategoryPermissions()
        if include_optional:
            return PermissionModelStatusCategoryPermissions(
    ...
    def testPermissionModelStatusCategoryPermissions(self):
        """Test PermissionModelStatusCategoryPermissions"""
