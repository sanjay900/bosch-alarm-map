...
class TestOutputSIIDApi(unittest.TestCase):
    """OutputSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OutputSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_output_siid(self) -> None:
        """Test case for get_output_siid

        Individual output
        """
        pass

    def test_post_output_siid(self) -> None:
        """Test case for post_output_siid
