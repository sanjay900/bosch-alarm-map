...
class TestPermissionModelUserCategoryPermissions(unittest.TestCase):
    """PermissionModelUserCategoryPermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionModelUserCategoryPermissions:
        """Test PermissionModelUserCategoryPermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelUserCategoryPermissions`
        """
        model = PermissionModelUserCategoryPermissions()
        if include_optional:
            return PermissionModelUserCategoryPermissions(
                may_add_user = True,
    ...
    def testPermissionModelUserCategoryPermissions(self):
        """Test PermissionModelUserCategoryPermissions"""
