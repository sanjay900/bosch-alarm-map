...
class TestStatisticsCommon(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatisticsCommon:
        """Test StatisticsCommon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsCommon`
        """
        model = StatisticsCommon()
        if include_optional:
            return StatisticsCommon(
