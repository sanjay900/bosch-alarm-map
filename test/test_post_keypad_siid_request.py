...
class TestPostKeypadSIIDRequest(unittest.TestCase):
    """PostKeypadSIIDRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostKeypadSIIDRequest:
        """Test PostKeypadSIIDRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostKeypadSIIDRequest`
        """
        model = PostKeypadSIIDRequest()
        if include_optional:
            return PostKeypadSIIDRequest(
                cmd = 'FWVERSION'
            )
        else:
            return PostKeypadSIIDRequest(
    ...
    def testPostKeypadSIIDRequest(self):
        """Test PostKeypadSIIDRequest"""
