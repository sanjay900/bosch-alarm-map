...
class TestSmartkeySIIDApi(unittest.TestCase):
    """SmartkeySIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SmartkeySIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_smartkey_siid(self) -> None:
        """Test case for get_smartkey_siid

        Get individual information of one Smartkey device.
        """
        pass

    def test_post_smartkey_siid(self) -> None:
        """Test case for post_smartkey_siid
