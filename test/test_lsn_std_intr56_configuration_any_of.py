...
class TestLSNStdIntr56ConfigurationAnyOf(unittest.TestCase):
    """LSNStdIntr56ConfigurationAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr56ConfigurationAnyOf:
        """Test LSNStdIntr56ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr56ConfigurationAnyOf`
        """
        model = LSNStdIntr56ConfigurationAnyOf()
        if include_optional:
            return LSNStdIntr56ConfigurationAnyOf(
    ...
    def testLSNStdIntr56ConfigurationAnyOf(self):
        """Test LSNStdIntr56ConfigurationAnyOf"""
