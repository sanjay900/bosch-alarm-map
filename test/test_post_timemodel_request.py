...
class TestPostTimemodelRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostTimemodelRequest:
        """Test PostTimemodelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostTimemodelRequest`
        """
        model = PostTimemodelRequest()
        if include_optional:
            return PostTimemodelRequest(
                cmd = 'CREATE',
    ...
    def testPostTimemodelRequest(self):
        """Test PostTimemodelRequest"""
