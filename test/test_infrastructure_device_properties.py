...
class TestInfrastructureDeviceProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InfrastructureDeviceProperties:
        """Test InfrastructureDeviceProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfrastructureDeviceProperties`
        """
        model = InfrastructureDeviceProperties()
        if include_optional:
    ...
    def testInfrastructureDeviceProperties(self):
        """Test InfrastructureDeviceProperties"""
