...
class TestSmartkeyModelSyncID(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SmartkeyModelSyncID:
        """Test SmartkeyModelSyncID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmartkeyModelSyncID`
        """
        model = SmartkeyModelSyncID()
        if include_optional:
            return SmartkeyModelSyncID(
    ...
    def testSmartkeyModelSyncID(self):
        """Test SmartkeyModelSyncID"""
