...
class TestAreaandtimemodellistApi(unittest.TestCase):
    """AreaandtimemodellistApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AreaandtimemodellistApi()

    def tearDown(self) -> None:
        pass

    def test_get_areaandtimemodellist(self) -> None:
        """Test case for get_areaandtimemodellist

        Get all area and time models of the MAP system
        """
        pass

    def test_postareaandtimemodellist(self) -> None:
        """Test case for postareaandtimemodellist
