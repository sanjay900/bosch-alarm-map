...
class TestLSNLoopBypassableIntrusionPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopBypassableIntrusionPointPost:
        """Test LSNLoopBypassableIntrusionPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopBypassableIntrusionPointPost`
        """
        model = LSNLoopBypassableIntrusionPointPost()
        if include_optional:
            return LSNLoopBypassableIntrusionPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopBypassableIntrusionPointPost(self):
        """Test LSNLoopBypassableIntrusionPointPost"""
