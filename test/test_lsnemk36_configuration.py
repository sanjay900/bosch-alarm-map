...
class TestLSNEMK36Configuration(unittest.TestCase):
    """LSNEMK36Configuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNEMK36Configuration:
        """Test LSNEMK36Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNEMK36Configuration`
        """
        model = LSNEMK36Configuration()
        if include_optional:
            return LSNEMK36Configuration(
                type = 'EMK36S',
                name = '[EMK36 LSN 1]',
    ...
    def testLSNEMK36Configuration(self):
        """Test LSNEMK36Configuration"""
