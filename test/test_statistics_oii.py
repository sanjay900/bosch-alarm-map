...
class TestStatisticsOii(unittest.TestCase):
    """StatisticsOii unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatisticsOii:
        """Test StatisticsOii
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsOii`
        """
        model = StatisticsOii()
        if include_optional:
            return StatisticsOii(
                start = '2023-07-07T14:00:00+02:00',
                last = '2023-08-14T11:00:00+02:00',
                duration = '07:05:56',
                ...
                negative = 95,
                negative = 29,
                positive_responses = ["/mumusergroup POST count=6, min=1 ms, avg=2 ms, max=2 ms","/usermodel POST:CREATE count=37, min=1 ms, avg=3 ms, max=4 ms","/users GET count=3, min=0 ms, avg=0 ms, max=0 ms","/statistics GET count=1, min=0 ms, avg=0 ms, max=0 ms","/syncstatus GET count=10, min=0 ms, avg=0 ms, max=0 ms"],
                negative_responses = ["/sharedkey POST:400: 1","/usermodel POST:400: 70","/usermodel POST:409: 10","/usermodel/* GET:404: 5","/usermodellist GET:400: 8"],
                clients = {"005@127.0.0.1":{"start":"2023-07-07T14:00:00+02:00","last":"2023-07-12T16:12:00+02:00","duration":"5 Days, 02:12:00","interval":"00:22:04.000","delay":"min=00:00:00.001, avg=00:00:00.004, max=00:00:01.108","requests":330,"responses":329,"positive":234,"negative":95},"902@127.0.0.1":{"start":"2023-07-07T14:00:00+02:00","last":"2023-07-07T14:12:00+02:00","duration":"00:06:00","interval":"00:00:04.000","delay":"min=00:00:00.016, avg=00:00:00.016, max=00:00:00.016","requests":3,"responses":2,"positive":2,"negative":0}}
            )
        else:
            return StatisticsOii(
        )
