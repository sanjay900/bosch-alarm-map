...
class TestLSNSKA100ConfigurationAnyOf(unittest.TestCase):
    """LSNSKA100ConfigurationAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNSKA100ConfigurationAnyOf:
        """Test LSNSKA100ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNSKA100ConfigurationAnyOf`
        """
        model = LSNSKA100ConfigurationAnyOf()
        if include_optional:
            return LSNSKA100ConfigurationAnyOf(
                name = '[SKA100 LSN 1]',
    ...
    def testLSNSKA100ConfigurationAnyOf(self):
        """Test LSNSKA100ConfigurationAnyOf"""
