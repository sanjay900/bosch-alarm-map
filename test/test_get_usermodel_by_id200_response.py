...
class TestGetUsermodelById200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUsermodelById200Response:
        """Test GetUsermodelById200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUsermodelById200Response`
        """
        model = GetUsermodelById200Response()
        if include_optional:
            return GetUsermodelById200Response(
                id = '005',
                user_type = 'Installer:Standard',
                access_model = 'Installer Profile',
                active = True,
                active_from = '2023-01-01',
                active_until = '2030-01-01',
                smartkey_model_name = 'Smartkey Profile',
                is_oii_user = False,
                is_oii_user_kp_user = False,
                language = 'en-US',
                passcode_chng_rqd = False,
                first_name = 'Max',
                last_name = 'Muster',
                passcode = '666666',
                smartkey_access_type = 'Token Only',
                smartkey_token = 'B92073DE',
                oii_username = 'username',
                oii_password = '123456789Aa!',
                use_extended_delay = False,
    ...
    def testGetUsermodelById200Response(self):
        """Test GetUsermodelById200Response"""
