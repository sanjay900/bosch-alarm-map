...
class TestInternalprogramsApi(unittest.TestCase):
    """InternalprogramsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InternalprogramsApi()

    def tearDown(self) -> None:
        pass

    def test_get_internalprograms(self) -> None:
        """Test case for get_internalprograms

        List all internal programs configured. 
        """
        pass

    def test_post_internalprograms(self) -> None:
        """Test case for post_internalprograms
