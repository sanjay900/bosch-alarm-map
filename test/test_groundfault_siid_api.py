...
class TestGroundfaultSIIDApi(unittest.TestCase):
    """GroundfaultSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GroundfaultSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_groundfault_siid(self) -> None:
        """Test case for get_groundfault_siid

        Individual ground fault resource
        """
        pass

    def test_post_groundfault_siid(self) -> None:
        """Test case for post_groundfault_siid
