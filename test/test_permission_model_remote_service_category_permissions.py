...
class TestPermissionModelRemoteServiceCategoryPermissions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionModelRemoteServiceCategoryPermissions:
        """Test PermissionModelRemoteServiceCategoryPermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionModelRemoteServiceCategoryPermissions`
        """
        model = PermissionModelRemoteServiceCategoryPermissions()
        if include_optional:
            return PermissionModelRemoteServiceCategoryPermissions(
    ...
    def testPermissionModelRemoteServiceCategoryPermissions(self):
        """Test PermissionModelRemoteServiceCategoryPermissions"""
