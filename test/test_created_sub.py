...
class TestCreatedSub(unittest.TestCase):
    """CreatedSub unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatedSub:
        """Test CreatedSub
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatedSub`
        """
        model = CreatedSub()
        if include_optional:
            return CreatedSub(
                subscription_url = '/sub/F549A0A9939C41D0B45DF8E9EB45DB0E',
                lease_time = 56,
                buffer_size = 56
            )
        else:
