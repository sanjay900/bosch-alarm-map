...
class TestLSNPLoopPointDevicePost(unittest.TestCase):
    """LSNPLoopPointDevicePost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNPLoopPointDevicePost:
        """Test LSNPLoopPointDevicePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNPLoopPointDevicePost`
        """
        model = LSNPLoopPointDevicePost()
        if include_optional:
            return LSNPLoopPointDevicePost(
                type = 'EMK36S',
    ...
    def testLSNPLoopPointDevicePost(self):
        """Test LSNPLoopPointDevicePost"""
