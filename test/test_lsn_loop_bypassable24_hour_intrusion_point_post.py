...
class TestLSNLoopBypassable24HourIntrusionPointPost(unittest.TestCase):
    """LSNLoopBypassable24HourIntrusionPointPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNLoopBypassable24HourIntrusionPointPost:
        """Test LSNLoopBypassable24HourIntrusionPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopBypassable24HourIntrusionPointPost`
        """
        model = LSNLoopBypassable24HourIntrusionPointPost()
        if include_optional:
            return LSNLoopBypassable24HourIntrusionPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopBypassable24HourIntrusionPointPost(self):
        """Test LSNLoopBypassable24HourIntrusionPointPost"""
