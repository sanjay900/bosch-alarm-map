...
class TestSyncstatusAllowSendingUserDBIfArmed(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SyncstatusAllowSendingUserDBIfArmed:
        """Test SyncstatusAllowSendingUserDBIfArmed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncstatusAllowSendingUserDBIfArmed`
        """
        model = SyncstatusAllowSendingUserDBIfArmed()
        if include_optional:
            return SyncstatusAllowSendingUserDBIfArmed(
    ...
    def testSyncstatusAllowSendingUserDBIfArmed(self):
        """Test SyncstatusAllowSendingUserDBIfArmed"""
