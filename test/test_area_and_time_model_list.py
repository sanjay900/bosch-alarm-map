...
class TestAreaAndTimeModelList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AreaAndTimeModelList:
        """Test AreaAndTimeModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaAndTimeModelList`
        """
        model = AreaAndTimeModelList()
        if include_optional:
            return AreaAndTimeModelList(
                area_and_time_model_sync_id = 145,
                list = [
                    openapi_client.models.area_and_time_model_list_all_of_list_inner.AreaAndTimeModelList_allOf_list_inner()
                    ]
            )
        else:
            return AreaAndTimeModelList(
    ...
    def testAreaAndTimeModelList(self):
        """Test AreaAndTimeModelList"""
