...
class TestLSNStdIntr50Configuration(unittest.TestCase):
    """LSNStdIntr50Configuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr50Configuration:
        """Test LSNStdIntr50Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr50Configuration`
        """
        model = LSNStdIntr50Configuration()
        if include_optional:
            return LSNStdIntr50Configuration(
                type = 'EMK36S',
                name = '[StdIntr50 LSN 1]',
    ...
    def testLSNStdIntr50Configuration(self):
        """Test LSNStdIntr50Configuration"""
