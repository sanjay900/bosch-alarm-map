...
class TestUsermodelApi(unittest.TestCase):
    """UsermodelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UsermodelApi()

    def tearDown(self) -> None:
        pass

    def test_get_usermodel_by_id(self) -> None:
        """Test case for get_usermodel_by_id

        Get all parameters of specific user from MAP system
        """
        pass

    def test_post_usermodel(self) -> None:
        """Test case for post_usermodel
