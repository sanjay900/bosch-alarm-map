...
class TestSpecialDayModelSyncID(unittest.TestCase):
    """SpecialDayModelSyncID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialDayModelSyncID:
        """Test SpecialDayModelSyncID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialDayModelSyncID`
        """
        model = SpecialDayModelSyncID()
        if include_optional:
            return SpecialDayModelSyncID(
    ...
    def testSpecialDayModelSyncID(self):
        """Test SpecialDayModelSyncID"""
