...
class TestDaymodelApi(unittest.TestCase):
    """DaymodelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DaymodelApi()

    def tearDown(self) -> None:
        pass

    def test_get_daymodel(self) -> None:
        """Test case for get_daymodel

        Get a specific daymodel item from the MAP system
        """
        pass

    def test_post_day_model(self) -> None:
        """Test case for post_day_model
