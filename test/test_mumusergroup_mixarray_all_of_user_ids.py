...
class TestMumusergroupMixarrayAllOfUserIds(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MumusergroupMixarrayAllOfUserIds:
        """Test MumusergroupMixarrayAllOfUserIds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MumusergroupMixarrayAllOfUserIds`
        """
        model = MumusergroupMixarrayAllOfUserIds()
        if include_optional:
            return MumusergroupMixarrayAllOfUserIds(
            )
        else:
            return MumusergroupMixarrayAllOfUserIds(
        )
    ...
    def testMumusergroupMixarrayAllOfUserIds(self):
        """Test MumusergroupMixarrayAllOfUserIds"""
