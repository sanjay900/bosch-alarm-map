...
class TestLSNLoopNonBypassableBoltContactPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopNonBypassableBoltContactPointPost:
        """Test LSNLoopNonBypassableBoltContactPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopNonBypassableBoltContactPointPost`
        """
        model = LSNLoopNonBypassableBoltContactPointPost()
        if include_optional:
            return LSNLoopNonBypassableBoltContactPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopNonBypassableBoltContactPointPost(self):
        """Test LSNLoopNonBypassableBoltContactPointPost"""
