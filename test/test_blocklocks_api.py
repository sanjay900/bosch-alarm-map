...
class TestBlocklocksApi(unittest.TestCase):
    """BlocklocksApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BlocklocksApi()

    def tearDown(self) -> None:
        pass

    def test_get_blocklocks(self) -> None:
        """Test case for get_blocklocks

        List of blocklocks
        """
        pass

    def test_post_blocklocks(self) -> None:
        """Test case for post_blocklocks
