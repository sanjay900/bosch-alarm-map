...
class TestStatisticsDb(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatisticsDb:
        """Test StatisticsDb
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticsDb`
        """
        model = StatisticsDb()
        if include_optional:
            return StatisticsDb(
                ...
                counter = 513,
                databases = bosch_alarm_map.models.statistics_db_all_of_databases.statistics_db_allOf_databases(
                    path/to/database = bosch_alarm_map.models.statistics_db_all_of_databases_path_to_database.statistics_db_allOf_databases_path_to_database(
                        size_kb = 512, 
                        handles = bosch_alarm_map.models.statistics_db_all_of_databases_path_to_database_handles.statistics_db_allOf_databases_path_to_database_handles(
                            alloc = 582, 
                            dealloc = 12, 
                            usage = 570, ), 
                        counters = bosch_alarm_map.models.statistics_db_all_of_databases_path_to_database_counters.statistics_db_allOf_databases_path_to_database_counters(
                            reads = 2752, 
                            read_interval = '00:00:01.433', 
                            writes = 1371, 
                            write_interval = '00:00:03.266', ), ), )
            )
        else:
            return StatisticsDb(
        )
