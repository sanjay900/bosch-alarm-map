...
class TestPostBatteriesRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostBatteriesRequest:
        """Test PostBatteriesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostBatteriesRequest`
        """
        model = PostBatteriesRequest()
        if include_optional:
            return PostBatteriesRequest(
                cmd = 'BYPASS'
            )
        else:
            return PostBatteriesRequest(
    ...
    def testPostBatteriesRequest(self):
        """Test PostBatteriesRequest"""
