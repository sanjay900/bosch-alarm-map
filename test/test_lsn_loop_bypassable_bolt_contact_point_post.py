...
class TestLSNLoopBypassableBoltContactPointPost(unittest.TestCase):
    """LSNLoopBypassableBoltContactPointPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNLoopBypassableBoltContactPointPost:
        """Test LSNLoopBypassableBoltContactPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopBypassableBoltContactPointPost`
        """
        model = LSNLoopBypassableBoltContactPointPost()
        if include_optional:
            return LSNLoopBypassableBoltContactPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopBypassableBoltContactPointPost(self):
        """Test LSNLoopBypassableBoltContactPointPost"""
