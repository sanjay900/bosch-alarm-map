    ...
    def make_instance(self, include_optional) -> Config:
        ...
        if include_optional:
            return Config(
                ...
                var_self = '',
                area_configuration = bosch_alarm_map.models.area_configuration.areaConfiguration(
                    name = '[Control Panel Area]', 
                    siid = '1.1.ControlPanelArea.1.1', 
                    disarm_if_all_disarmed = 'NOCONSTRAINT', 
                    auto_disarmed = True, 
                    parent_area_type = 'NOTAPARENT', 
                    child_area_options = 'NONE', 
                    contained_area_list = [
                        ''
                        ], 
                    device_list = [
                ...
                internal_programs_configuration = bosch_alarm_map.models.internal_programs_configuration.internalProgramsConfiguration(
                    name = '[Control Panel Area]', 
                    siid = 'internalprogram/1', 
                    device_list = [
                        '1.1.Point.21001.9'
                        ], ),
                device_configuration = bosch_alarm_map.models.device_configuration.deviceConfiguration(
                    name = 'Onboard I/O', 
                    siid = '1.1.Module.21001.001', 
                    type = 'POINT.ONBOARD', 
                    part_of_walktest = True, 
                    bypassable = True, 
                    parent_siid = '', )
            )
        else:
