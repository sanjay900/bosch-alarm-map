...
class TestDayModelListAllOfListInner(unittest.TestCase):
    """DayModelListAllOfListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayModelListAllOfListInner:
        """Test DayModelListAllOfListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayModelListAllOfListInner`
        """
        model = DayModelListAllOfListInner()
        if include_optional:
            return DayModelListAllOfListInner(
                day_model_id = 'Cleaning/ Service Time',
                interval = [00:00:00-00:00:00, 00:00:00-00:00:00, 00:00:00-00:00:00]
            )
        else:
            return DayModelListAllOfListInner(
                day_model_id = 'Cleaning/ Service Time',
    ...
    def testDayModelListAllOfListInner(self):
        """Test DayModelListAllOfListInner"""
