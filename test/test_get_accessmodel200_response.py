...
class TestGetAccessmodel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccessmodel200Response:
        """Test GetAccessmodel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessmodel200Response`
        """
        model = GetAccessmodel200Response()
        if include_optional:
            return GetAccessmodel200Response(
    ...
    def testGetAccessmodel200Response(self):
        """Test GetAccessmodel200Response"""
