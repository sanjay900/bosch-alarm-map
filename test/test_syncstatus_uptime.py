...
class TestSyncstatusUptime(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SyncstatusUptime:
        """Test SyncstatusUptime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncstatusUptime`
        """
        model = SyncstatusUptime()
        if include_optional:
            return SyncstatusUptime(
                uptime = 3530
            )
        else:
            return SyncstatusUptime(
