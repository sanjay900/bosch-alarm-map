...
class TestPostAreaandtimemodelRequest(unittest.TestCase):
    """PostAreaandtimemodelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAreaandtimemodelRequest:
        """Test PostAreaandtimemodelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAreaandtimemodelRequest`
        """
        model = PostAreaandtimemodelRequest()
        if include_optional:
            return PostAreaandtimemodelRequest(
                cmd = 'CREATE',
                area_and_time_model_id = 'Installer Model, All Areas, Anytime',
                always_allowed_permission_set = 'Super User Permission',
                restricted_by_area_permission_set = 'null',
                restricted_by_time_permission_set = '',
                restricted_by_area_and_time_permission_set = 'null',
                area_list = [Control Panel Area, Area 1],
                time_model_id = '6 Days (No Sundays)',
    ...
    def testPostAreaandtimemodelRequest(self):
        """Test PostAreaandtimemodelRequest"""
