...
class TestLSNLoopDevicePost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopDevicePost:
        """Test LSNLoopDevicePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopDevicePost`
        """
        model = LSNLoopDevicePost()
        if include_optional:
            return LSNLoopDevicePost(
                type = 'EMK36S',
    ...
    def testLSNLoopDevicePost(self):
        """Test LSNLoopDevicePost"""
