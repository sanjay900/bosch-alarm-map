...
class TestTimeModelList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TimeModelList:
        """Test TimeModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeModelList`
        """
        model = TimeModelList()
        if include_optional:
            return TimeModelList(
                ...
                list = [
                    openapi_client.models.time_model_list_all_of_list_inner.TimeModelList_allOf_list_inner()
                    ]
            )
        else:
            return TimeModelList(
