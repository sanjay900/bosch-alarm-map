...
class TestInternalProgramIpArmingInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InternalProgramIpArmingInfo:
        """Test InternalProgramIpArmingInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalProgramIpArmingInfo`
        """
        model = InternalProgramIpArmingInfo()
        if include_optional:
            return InternalProgramIpArmingInfo(
                cmd = 'IPARMINGINFO'
            )
        else:
            return InternalProgramIpArmingInfo(
    ...
    def testInternalProgramIpArmingInfo(self):
        """Test InternalProgramIpArmingInfo"""
