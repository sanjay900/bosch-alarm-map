...
class TestLSNLoopNonBypassable24HourIntrusionPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopNonBypassable24HourIntrusionPointPost:
        """Test LSNLoopNonBypassable24HourIntrusionPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopNonBypassable24HourIntrusionPointPost`
        """
        model = LSNLoopNonBypassable24HourIntrusionPointPost()
        if include_optional:
            return LSNLoopNonBypassable24HourIntrusionPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopNonBypassable24HourIntrusionPointPost(self):
        """Test LSNLoopNonBypassable24HourIntrusionPointPost"""
