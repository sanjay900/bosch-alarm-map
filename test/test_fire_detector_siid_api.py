...
class TestFireDetectorSIIDApi(unittest.TestCase):
    """FireDetectorSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = FireDetectorSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_firedetector_siid(self) -> None:
        """Test case for firedetector_siid

        Enable/Disable a fireDetector
        """
        pass

    def test_get_firedetector(self) -> None:
        """Test case for get_firedetector
