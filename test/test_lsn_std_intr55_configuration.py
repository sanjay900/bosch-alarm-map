...
class TestLSNStdIntr55Configuration(unittest.TestCase):
    """LSNStdIntr55Configuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr55Configuration:
        """Test LSNStdIntr55Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr55Configuration`
        """
        model = LSNStdIntr55Configuration()
        if include_optional:
            return LSNStdIntr55Configuration(
                type = 'EMK36S',
                name = '[StdIntr55 LSN 1]',
                ...
                loop_current_index = 1,
                reporting_number = 3,
                antimask_sensitivity = 'Standard',
                sensitivity = 'Level 4'
            )
        else:
            return LSNStdIntr55Configuration(
    ...
    def testLSNStdIntr55Configuration(self):
        """Test LSNStdIntr55Configuration"""
