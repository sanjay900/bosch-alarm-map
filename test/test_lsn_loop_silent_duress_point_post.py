...
class TestLSNLoopSilentDuressPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopSilentDuressPointPost:
        """Test LSNLoopSilentDuressPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopSilentDuressPointPost`
        """
        model = LSNLoopSilentDuressPointPost()
        if include_optional:
            return LSNLoopSilentDuressPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopSilentDuressPointPost(self):
        """Test LSNLoopSilentDuressPointPost"""
