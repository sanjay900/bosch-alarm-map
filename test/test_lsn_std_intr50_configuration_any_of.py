...
class TestLSNStdIntr50ConfigurationAnyOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNStdIntr50ConfigurationAnyOf:
        """Test LSNStdIntr50ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr50ConfigurationAnyOf`
        """
        model = LSNStdIntr50ConfigurationAnyOf()
        if include_optional:
            return LSNStdIntr50ConfigurationAnyOf(
    ...
    def testLSNStdIntr50ConfigurationAnyOf(self):
        """Test LSNStdIntr50ConfigurationAnyOf"""
