...
class TestLSNLoopNonBypassableTechnicalPointPost(unittest.TestCase):
    """LSNLoopNonBypassableTechnicalPointPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNLoopNonBypassableTechnicalPointPost:
        """Test LSNLoopNonBypassableTechnicalPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopNonBypassableTechnicalPointPost`
        """
        model = LSNLoopNonBypassableTechnicalPointPost()
        if include_optional:
            return LSNLoopNonBypassableTechnicalPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopNonBypassableTechnicalPointPost(self):
        """Test LSNLoopNonBypassableTechnicalPointPost"""
