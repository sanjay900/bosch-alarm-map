...
class TestPanelLastRestartReason(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PanelLastRestartReason:
        """Test PanelLastRestartReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PanelLastRestartReason`
        """
        model = PanelLastRestartReason()
        if include_optional:
            return PanelLastRestartReason(
                value = 11006,
    ...
    def testPanelLastRestartReason(self):
        """Test PanelLastRestartReason"""
