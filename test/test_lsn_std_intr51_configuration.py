...
class TestLSNStdIntr51Configuration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNStdIntr51Configuration:
        """Test LSNStdIntr51Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr51Configuration`
        """
        model = LSNStdIntr51Configuration()
        if include_optional:
            return LSNStdIntr51Configuration(
                type = 'EMK36S',
    ...
    def testLSNStdIntr51Configuration(self):
        """Test LSNStdIntr51Configuration"""
