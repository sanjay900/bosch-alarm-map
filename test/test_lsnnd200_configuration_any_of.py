...
class TestLSNND200ConfigurationAnyOf(unittest.TestCase):
    """LSNND200ConfigurationAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNND200ConfigurationAnyOf:
        """Test LSNND200ConfigurationAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNND200ConfigurationAnyOf`
        """
        model = LSNND200ConfigurationAnyOf()
        if include_optional:
            return LSNND200ConfigurationAnyOf(
                name = '[ND200 LSN 1]',
    ...
    def testLSNND200ConfigurationAnyOf(self):
        """Test LSNND200ConfigurationAnyOf"""
