...
class TestLsnGatewaysApi(unittest.TestCase):
    """LsnGatewaysApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LsnGatewaysApi()

    def tearDown(self) -> None:
        pass

    def test_getlsn_gateways(self) -> None:
        """Test case for getlsn_gateways

        List of LSN gateways in the MAP system
        """
        pass

    def test_postlsn_gateways(self) -> None:
        """Test case for postlsn_gateways
