...
class TestSmartkeyModelID(unittest.TestCase):
    """SmartkeyModelID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmartkeyModelID:
        """Test SmartkeyModelID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmartkeyModelID`
        """
        model = SmartkeyModelID()
        if include_optional:
            return SmartkeyModelID(
