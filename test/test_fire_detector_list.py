...
class TestFireDetectorList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FireDetectorList:
        """Test FireDetectorList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FireDetectorList`
        """
        model = FireDetectorList()
        if include_optional:
