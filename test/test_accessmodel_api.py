...
class TestAccessmodelApi(unittest.TestCase):
    """AccessmodelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AccessmodelApi()

    def tearDown(self) -> None:
        pass

    def test_get_accessmodel(self) -> None:
        """Test case for get_accessmodel

        Get a specific accessmodel from the MAP system
        """
        pass

    def test_post_accessmodel(self) -> None:
        """Test case for post_accessmodel
