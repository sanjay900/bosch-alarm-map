...
class TestLSNLoopNonBypassableIntrusionPointPost(unittest.TestCase):
    """LSNLoopNonBypassableIntrusionPointPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNLoopNonBypassableIntrusionPointPost:
        """Test LSNLoopNonBypassableIntrusionPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopNonBypassableIntrusionPointPost`
        """
        model = LSNLoopNonBypassableIntrusionPointPost()
        if include_optional:
            return LSNLoopNonBypassableIntrusionPointPost(
                type = 'EMK36S',
                name = '[LSN EMK36/MCx2 Device]',
                area = '[Control Panel Area]',
                point_type = 'Intrusion (Bypassable)',
                supports_delayed_reporting = True,
                walktest_category = 'Standard',
                chime_mode_capable = True,
                delay_for_alarm_detection = 5,
                entry_point = 'None',
                exit_point = 'Follower',
                walktest_trigger_frequency = 'Rarely'
            )
        else:
            return LSNLoopNonBypassableIntrusionPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopNonBypassableIntrusionPointPost(self):
        """Test LSNLoopNonBypassableIntrusionPointPost"""
