...
class TestUserModellistPost(unittest.TestCase):
    """UserModellistPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserModellistPost:
        """Test UserModellistPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserModellistPost`
        """
        model = UserModellistPost()
        if include_optional:
            return UserModellistPost(
                cmd = 'GETMODIFIEDLIST',
    ...
    def testUserModellistPost(self):
        """Test UserModellistPost"""
