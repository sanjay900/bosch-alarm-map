...
class TestPostAreaSIIDRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostAreaSIIDRequest:
        """Test PostAreaSIIDRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAreaSIIDRequest`
        """
        model = PostAreaSIIDRequest()
        if include_optional:
            return PostAreaSIIDRequest(
                cmd = 'ARMINGINFO',
                bypass_off_normal_devices = True,
                exit_delay = 'ZERO',
                included_points = 'ALL'
            )
        else:
    ...
    def testPostAreaSIIDRequest(self):
        """Test PostAreaSIIDRequest"""
