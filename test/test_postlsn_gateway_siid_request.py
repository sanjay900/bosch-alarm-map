...
class TestPostlsnGatewaySIIDRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostlsnGatewaySIIDRequest:
        """Test PostlsnGatewaySIIDRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostlsnGatewaySIIDRequest`
        """
        model = PostlsnGatewaySIIDRequest()
        if include_optional:
            return PostlsnGatewaySIIDRequest(
                cmd = 'FWVERSION'
            )
        else:
            return PostlsnGatewaySIIDRequest(
    ...
    def testPostlsnGatewaySIIDRequest(self):
        """Test PostlsnGatewaySIIDRequest"""
