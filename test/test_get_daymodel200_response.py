...
class TestGetDaymodel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDaymodel200Response:
        """Test GetDaymodel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDaymodel200Response`
        """
        model = GetDaymodel200Response()
        if include_optional:
            return GetDaymodel200Response(
    ...
    def testGetDaymodel200Response(self):
        """Test GetDaymodel200Response"""
