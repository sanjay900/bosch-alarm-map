...
class TestPointSIIDApi(unittest.TestCase):
    """PointSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PointSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_point_siid(self) -> None:
        """Test case for get_point_siid

        Individual point
        """
        pass

    def test_post_point_siid(self) -> None:
        """Test case for post_point_siid
