...
class TestGetTimemodel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTimemodel200Response:
        """Test GetTimemodel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTimemodel200Response`
        """
        model = GetTimemodel200Response()
        if include_optional:
            return GetTimemodel200Response(
    ...
    def testGetTimemodel200Response(self):
        """Test GetTimemodel200Response"""
