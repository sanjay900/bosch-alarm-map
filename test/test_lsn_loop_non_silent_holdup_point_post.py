...
class TestLSNLoopNonSilentHoldupPointPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNLoopNonSilentHoldupPointPost:
        """Test LSNLoopNonSilentHoldupPointPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNLoopNonSilentHoldupPointPost`
        """
        model = LSNLoopNonSilentHoldupPointPost()
        if include_optional:
            return LSNLoopNonSilentHoldupPointPost(
                type = 'EMK36S',
    ...
    def testLSNLoopNonSilentHoldupPointPost(self):
        """Test LSNLoopNonSilentHoldupPointPost"""
