...
class TestFireDetector(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FireDetector:
        """Test FireDetector
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FireDetector`
        """
        model = FireDetector()
        if include_optional:
            return FireDetector(
                ...
                tested_sensors = [
                    bosch_alarm_map.models.fire_detector_tested_sensors_inner.fireDetector_testedSensors_inner(
                        type = 'o', 
                        tested = True, )
                    ]
            )
