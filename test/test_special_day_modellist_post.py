...
class TestSpecialDayModellistPost(unittest.TestCase):
    """SpecialDayModellistPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialDayModellistPost:
        """Test SpecialDayModellistPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialDayModellistPost`
        """
        model = SpecialDayModellistPost()
        if include_optional:
            return SpecialDayModellistPost(
                cmd = 'GETMODIFIEDLIST',
    ...
    def testSpecialDayModellistPost(self):
        """Test SpecialDayModellistPost"""
