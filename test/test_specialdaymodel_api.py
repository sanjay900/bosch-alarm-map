...
class TestSpecialdaymodelApi(unittest.TestCase):
    """SpecialdaymodelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SpecialdaymodelApi()

    def tearDown(self) -> None:
        pass

    def test_get_specialdaymodel(self) -> None:
        """Test case for get_specialdaymodel

        Get a special day model from the MAP system
        """
        pass

    def test_post_specialdaymodel(self) -> None:
        """Test case for post_specialdaymodel
