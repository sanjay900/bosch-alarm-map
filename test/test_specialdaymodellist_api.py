...
class TestSpecialdaymodellistApi(unittest.TestCase):
    """SpecialdaymodellistApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SpecialdaymodellistApi()

    def tearDown(self) -> None:
        pass

    def test_get_specialdaymodellist(self) -> None:
        """Test case for get_specialdaymodellist

        Get all special day models of the MAP system
        """
        pass

    def test_postspecialdaymodellist(self) -> None:
        """Test case for postspecialdaymodellist
