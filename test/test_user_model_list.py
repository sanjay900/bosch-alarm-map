...
class TestUserModelList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserModelList:
        """Test UserModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserModelList`
        """
        model = UserModelList()
        if include_optional:
            return UserModelList(
                ...
                list = [
                    bosch_alarm_map.models.user_model_list_all_of_list_inner.UserModelList_allOf_list_inner()
                    ]
            )
        else:
            return UserModelList(
