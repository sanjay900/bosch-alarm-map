...
class TestLSNND200Configuration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LSNND200Configuration:
        """Test LSNND200Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNND200Configuration`
        """
        model = LSNND200Configuration()
        if include_optional:
            return LSNND200Configuration(
                type = 'EMK36S',
                name = '[ND200 LSN 1]',
    ...
    def testLSNND200Configuration(self):
        """Test LSNND200Configuration"""
