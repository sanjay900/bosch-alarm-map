...
class TestAccessModelistPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccessModelistPost:
        """Test AccessModelistPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessModelistPost`
        """
        model = AccessModelistPost()
        if include_optional:
            return AccessModelistPost(
                cmd = 'GETMODIFIEDLIST',
    ...
    def testAccessModelistPost(self):
        """Test AccessModelistPost"""
