...
class TestLSNStdIntr52Configuration(unittest.TestCase):
    """LSNStdIntr52Configuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LSNStdIntr52Configuration:
        """Test LSNStdIntr52Configuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LSNStdIntr52Configuration`
        """
        model = LSNStdIntr52Configuration()
        if include_optional:
            return LSNStdIntr52Configuration(
                type = 'EMK36S',
                name = '[StdIntr52 LSN 1]',
    ...
    def testLSNStdIntr52Configuration(self):
        """Test LSNStdIntr52Configuration"""
