...
class TestTimeModelSyncID(unittest.TestCase):
    """TimeModelSyncID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeModelSyncID:
        """Test TimeModelSyncID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeModelSyncID`
        """
        model = TimeModelSyncID()
        if include_optional:
            return TimeModelSyncID(
