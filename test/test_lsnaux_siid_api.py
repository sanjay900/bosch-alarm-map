...
class TestLsnauxSIIDApi(unittest.TestCase):
    """LsnauxSIIDApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LsnauxSIIDApi()

    def tearDown(self) -> None:
        pass

    def test_get_lsnaux_siid(self) -> None:
        """Test case for get_lsnaux_siid

        Individual LSN aux
        """
        pass

    def test_post_lsnaus_siid(self) -> None:
        """Test case for post_lsnaus_siid
