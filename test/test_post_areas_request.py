...
class TestPostAreasRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostAreasRequest:
        """Test PostAreasRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAreasRequest`
        """
        model = PostAreasRequest()
        if include_optional:
            return PostAreasRequest(
                cmd = 'BELLTEST',
