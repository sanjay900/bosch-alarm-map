...
class TestAreaAndTimeModel(unittest.TestCase):
    """AreaAndTimeModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaAndTimeModel:
        """Test AreaAndTimeModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaAndTimeModel`
        """
        model = AreaAndTimeModel()
        if include_optional:
            return AreaAndTimeModel(
