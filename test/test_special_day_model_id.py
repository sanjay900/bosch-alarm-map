...
class TestSpecialDayModelID(unittest.TestCase):
    """SpecialDayModelID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialDayModelID:
        """Test SpecialDayModelID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialDayModelID`
        """
        model = SpecialDayModelID()
        if include_optional:
            return SpecialDayModelID(
    ...
    def testSpecialDayModelID(self):
        """Test SpecialDayModelID"""
