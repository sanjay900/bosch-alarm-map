...
class TestLsnbusesApi(unittest.TestCase):
    """LsnbusesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LsnbusesApi()

    def tearDown(self) -> None:
        pass

    def test_get_lsnbuses(self) -> None:
        """Test case for get_lsnbuses

        List of LSN Buses (loops and stubs) in the MAP system
        """
        pass

    def test_post_lsnbuses(self) -> None:
        """Test case for post_lsnbuses
